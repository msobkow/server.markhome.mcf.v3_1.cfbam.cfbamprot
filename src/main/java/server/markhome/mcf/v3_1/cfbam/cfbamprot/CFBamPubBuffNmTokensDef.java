// Description: Java 17 implJustPubementation of a NmTokensDef buffer
...
public class CFBamPubBuffNmTokensDef
	...
	implements ICFBamNmTokensDef
{
	...
	public CFBamPubBuffNmTokensDef() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubNmTokensDef.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokensDef ) {
			setJustPubNmTokensDef( (CFBamPubBuffNmTokensDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNmTokensDef ) {
			setJustPubNmTokensDef( (CFBamPubPubBuffNmTokensDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNmTokensDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
