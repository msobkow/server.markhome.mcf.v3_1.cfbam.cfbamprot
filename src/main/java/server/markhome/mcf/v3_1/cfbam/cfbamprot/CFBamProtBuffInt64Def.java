...
public class CFBamProtBuffInt64Def
	...
	implements ICFBamInt64Def
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtInt64Def rhs ) {
		...
		else if( obj instanceof ICFBamProtInt64DefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFBamProtBuffInt64Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
