// Description: Java 25 protected interface for a DoubleType record implementation
...
/**
 *	ICFBamProtDoubleType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDoubleType extends ICFBamProtDoubleDef
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubDoubleType.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubDoubleType.SCHEMADEFID_INIT_VALUE;
