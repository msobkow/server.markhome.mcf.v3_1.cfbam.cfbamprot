	...
	implements ICFBamTZDateType
{
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTZDateTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	@Override
	public void setJustProtTZDateType( ICFBamTZDateType src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtTZDateTypeH ) {
			setTZDateType( (ICFBamProtTZDateTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTZDateType( ICFBamTZDateTypeH src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTZDateType( ICFBamProtTZDateType src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTZDateType( ICFBamProtTZDateTypeH src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTZDateType( ICFBamPubTZDateType src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTZDateType( ICFBamPubTZDateTypeH src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
