...
// Description: Java 25 protected DbIO interface for EnumType.
...
/*
 *	CFBamProtEnumTypeTable protected database interface for EnumType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtEnumTypeTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamEnumType protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
