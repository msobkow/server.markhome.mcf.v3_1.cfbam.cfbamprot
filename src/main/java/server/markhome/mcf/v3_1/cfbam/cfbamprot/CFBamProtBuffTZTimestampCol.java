// Description: Java 25 implJustProtementation of a TZTimestampCol buffer
...
public class CFBamProtBuffTZTimestampCol
	extends CFBamProtBuffTZTimestampDef
	implements ICFBamTZTimestampCol
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamProtBuffTZTimestampCol() {
		super();
	...
	public int getClassCode() {
		return( ICFBamTZTimestampCol.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtTZTimestampCol rhs ) {
		...
		else if( obj instanceof ICFBamProtTZTimestampColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTZTimestampColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTZTimestampCol rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTZTimestampColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimestampColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTZTimestampColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffTZTimestampCol ) {
			setJustProtTZTimestampCol( (CFBamProtBuffTZTimestampCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffTZTimestampCol" );
		}
	}

	@Override
	public void setJustProtTZTimestampCol( ICFBamTZTimestampCol src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtTZTimestampColH ) {
			setTZTimestampCol( (ICFBamProtTZTimestampColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
					"src",
					src,
					"ICFBamTZTimestampColH" );
		}
	}

	@Override
	public void setJustProtTZTimestampCol( ICFBamTZTimestampColH src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtTZTimestampCol( ICFBamProtTZTimestampCol src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtTZTimestampCol( ICFBamProtTZTimestampColH src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffTZTimestampCol ) {
			setJustProtTZTimestampCol( (CFBamPubProtBuffTZTimestampCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffTZTimestampCol" );
		}
	}

	@Override
	public void setJustProtTZTimestampCol( ICFBamPubTZTimestampCol src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubTZTimestampColH ) {
			setTZTimestampCol( (ICFBamPubTZTimestampColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTZTimestampCol( ICFBamPubTZTimestampColH src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffTZTimestampCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
