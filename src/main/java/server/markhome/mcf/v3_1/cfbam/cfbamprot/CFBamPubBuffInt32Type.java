// Description: Java 17 implJustPubementation of a Int32Type buffer
...
public class CFBamPubBuffInt32Type
	extends CFBamPubBuffInt32Def
	implements ICFBamInt32Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffInt32Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubInt32Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt32Type ) {
			setJustPubInt32Type( (CFBamPubBuffInt32Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt32Type ) {
			setJustPubInt32Type( (CFBamPubPubBuffInt32Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt32Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
