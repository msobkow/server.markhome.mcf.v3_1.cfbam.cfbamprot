// Description: Java 17 implJustPubementation of a NumberCol buffer
...
public class CFBamPubBuffNumberCol
	extends CFBamPubBuffNumberDef
	implements ICFBamNumberCol
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamPubBuffNumberCol() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubNumberCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNumberCol ) {
			setJustPubNumberCol( (CFBamPubBuffNumberCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNumberCol ) {
			setJustPubNumberCol( (CFBamPubPubBuffNumberCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNumberCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
