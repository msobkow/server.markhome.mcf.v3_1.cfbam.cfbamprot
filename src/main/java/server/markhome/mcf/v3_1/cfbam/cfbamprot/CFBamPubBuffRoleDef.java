// Description: Java 17 implJustPubementation of a RoleDef buffer
...
public class CFBamPubBuffRoleDef
	implements ICFBamPubRoleDef, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFBamPubRoleDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubRoleDefHPKey ) {
			ICFBamPubRoleDefHPKey rhs = (ICFBamPubRoleDefHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setRoleDef( ICFBamPubRoleDef src ) {
		...
		setJustPubRequiredEnables(src.getRequiredEnables());
		setJustPubRequiredIncludes(src.getRequiredIncludes());
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffRoleDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
