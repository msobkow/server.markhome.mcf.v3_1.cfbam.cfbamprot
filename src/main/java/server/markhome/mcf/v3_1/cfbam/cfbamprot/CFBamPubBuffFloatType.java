// Description: Java 17 implJustPubementation of a FloatType buffer
...
public class CFBamPubBuffFloatType
	extends CFBamPubBuffFloatDef
	implements ICFBamFloatType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffFloatType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubFloatType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffFloatType ) {
			setJustPubFloatType( (CFBamPubBuffFloatType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffFloatType ) {
			setJustPubFloatType( (CFBamPubPubBuffFloatType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffFloatType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
