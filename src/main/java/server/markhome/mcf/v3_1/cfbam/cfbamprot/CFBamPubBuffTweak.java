// Description: Java 17 implJustPubementation of a Tweak buffer
...
public class CFBamPubBuffTweak
	implements ICFBamPubTweak, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFBamPubTweak.CLASS_CODE );
	}

	@Override
	public ICFBamPubScope getRequiredContainerScopeDef(ICFLibKeyHash256 argScopeId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerScopeDef", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubScopeTable targetTable = targetBackingCFBam.getTableScope();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerScopeDef", 0, "ICFBamPubSchema.getBackingCFBam().getTableScope()");
		}
	...
	public void setRequiredContainerScopeDef(ICFLibKeyHash256 argScopeId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerScopeDef-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubScopeTable targetTable = targetBackingCFBam.getTableScope();
		if (targetTable == null) {
		...
		requiredScopeId = argScopeId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerScopeDef-args", "found", found, "ICFBamPubScopeICFBamPubScope");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubTweakHPKey ) {
			ICFBamPubTweakHPKey rhs = (ICFBamPubTweakHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setTweak( ICFBamPubTweak src ) {
		...
		setJustPubRequiredContainerScopeDef(src.getRequiredContainerScopeDef());
		...
		setJustPubOptionalDefSchemaTenantId(src.getOptionalDefSchemaTenantId());
		setJustPubOptionalDefSchemaId(src.getOptionalDefSchemaId());
		setJustPubRequiredName(src.getRequiredName());
		setJustPubRequiredReplacesInherited(src.getRequiredReplacesInherited());
		setJustPubRequiredTweakGelText(src.getRequiredTweakGelText());
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffTweak" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
