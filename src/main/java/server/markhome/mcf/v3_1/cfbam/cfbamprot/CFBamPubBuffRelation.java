// Description: Java 17 implJustPubementation of a Relation buffer
...
public class CFBamPubBuffRelation
	...
	implements ICFBamRelation
{
	...
	public int getClassCode() {
		return( ICFBamPubRelation.CLASS_CODE );
	}
	...
	@Override
	public ICFBamPubTable getRequiredContainerFromTable(ICFLibKeyHash256 argTableId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerFromTable", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubTableTable targetTable = targetBackingCFBam.getTableTable();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerFromTable", 0, "ICFBamPubSchema.getBackingCFBam().getTableTable()");
		}
	...
	public void setRequiredContainerFromTable(ICFLibKeyHash256 argTableId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerFromTable-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubTableTable targetTable = targetBackingCFBam.getTableTable();
		if (targetTable == null) {
		...
		requiredTableId = argTableId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerFromTable-args", "found", found, "ICFBamPubTableICFBamPubTable");
		}
	}
	...
	@Override
	public ICFBamPubIndex getRequiredLookupFromIndex(ICFLibKeyHash256 argFromIndexId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupFromIndex", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubIndexTable targetTable = targetBackingCFBam.getTableIndex();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupFromIndex", 0, "ICFBamPubSchema.getBackingCFBam().getTableIndex()");
		}
	...
	public void setRequiredLookupFromIndex(ICFLibKeyHash256 argFromIndexId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupFromIndex-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubIndexTable targetTable = targetBackingCFBam.getTableIndex();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupFromIndex", 0, "ICFBamSchema.getBackingCFBam().getTableIndex()");
		}
		ICFBamPubIndex found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argFromIndexId);
		if (found == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupFromIndex-args", 0, "found");
		}
		else if (found instanceof ICFBamPubIndex) || (found instanceof ICFBamPubIndex)) {
			super.setRequiredLookupFromIndex(argFromIndexId);
		requiredFromIndexId = argFromIndexId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredLookupFromIndex-args", "found", found, "ICFBamPubIndexICFBamPubIndex");
		}
	}
	...
	public void setRequiredLookupFromIndex(ICFBamPubIndex argObj) {
		...
		if(argObj == null) {
			...
			setRequiredFromIndexId(argObj.getRequiredId());
		}
	}

	@Override
	public ICFBamPubTable getRequiredLookupToTable(ICFLibKeyHash256 argToTableId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupToTable", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubTableTable targetTable = targetBackingCFBam.getTableTable();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupToTable", 0, "ICFBamPubSchema.getBackingCFBam().getTableTable()");
		}
	...
	public void setRequiredLookupToTable(ICFLibKeyHash256 argToTableId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupToTable-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubTableTable targetTable = targetBackingCFBam.getTableTable();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupToTable", 0, "ICFBamSchema.getBackingCFBam().getTableTable()");
		}
		ICFBamPubTable found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argToTableId);
		if (found == null) {
		...
		requiredToTableId = argToTableId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredLookupToTable-args", "found", found, "ICFBamPubTableICFBamPubTable");
		}
	}
	...
	public void setRequiredLookupToTable(ICFBamPubTable argObj) {
		...
		if(argObj == null) {
			...
			setRequiredToTableId(argObj.getRequiredId());
		}
	}

	@Override
	public ICFBamPubIndex getRequiredLookupToIndex(ICFLibKeyHash256 argToIndexId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupToIndex", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubIndexTable targetTable = targetBackingCFBam.getTableIndex();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupToIndex", 0, "ICFBamPubSchema.getBackingCFBam().getTableIndex()");
		}
	...
	public void setRequiredLookupToIndex(ICFLibKeyHash256 argToIndexId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupToIndex-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubIndexTable targetTable = targetBackingCFBam.getTableIndex();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupToIndex", 0, "ICFBamSchema.getBackingCFBam().getTableIndex()");
		}
		ICFBamPubIndex found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argToIndexId);
		if (found == null) {
		...
		requiredToIndexId = argToIndexId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredLookupToIndex-args", "found", found, "ICFBamPubIndexICFBamPubIndex");
		}
	}
	...
	public void setRequiredLookupToIndex(ICFBamPubIndex argObj) {
		...
		if(argObj == null) {
			...
			setRequiredToIndexId(argObj.getRequiredId());
		}
	}

	@Override
	public ICFBamPubRelation getOptionalLookupNarrowed(ICFLibKeyHash256 argNarrowedId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNarrowed", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubRelationTable targetTable = targetBackingCFBam.getTableRelation();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNarrowed", 0, "ICFBamPubSchema.getBackingCFBam().getTableRelation()");
		}
	...
	public void setOptionalLookupNarrowed(ICFLibKeyHash256 argNarrowedId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalLookupNarrowed-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubRelationTable targetTable = targetBackingCFBam.getTableRelation();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalLookupNarrowed", 0, "ICFBamSchema.getBackingCFBam().getTableRelation()");
		}
		ICFBamPubRelation found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNarrowedId);
		if (found == null || (found != null && ((found instanceof ICFBamPubRelation) || (found instanceof ICFBamPubRelation)))) {
			super.setOptionalLookupNarrowed(argNarrowedId);
		optionalNarrowedId = argNarrowedId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupNarrowed-args", "found", found, "ICFBamPubRelationICFBamPubRelation");
		}
	}
	...
	public void setOptionalLookupNarrowed(ICFBamPubRelation argObj) {
		...
		if(argObj == null) {
			setJustPubOptionalNarrowedId(null);
		}
		else {
			setOptionalNarrowedId(argObj.getRequiredId());
		}
	}

	@Override
	public List<ICFBamPubRelationCol> getOptionalComponentsColumns(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsColumns", 0, "ICFBamPubSchema.getBackingCFBam().getTableRelationCol()");
		}
		ICFBamPubRelationCol[] targetArr = targetTable.readDerivedByRelationIdx(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredId());
		if( targetArr != null ) {
			List<ICFBamPubRelationCol> results = new ArrayList<>(targetArr.length);
			...
			List<ICFBamPubRelationCol> results = new ArrayList<>();
			return(results);
		}
	}

	@Override
	public List<ICFBamPubPopTopDep> getOptionalComponentsPopDep(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsPopDep", 0, "ICFBamPubSchema.getBackingCFBam().getTablePopTopDep()");
		}
		ICFBamPubPopTopDep[] targetArr = targetTable.readDerivedByContRelIdx(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredId());
		if( targetArr != null ) {
			List<ICFBamPubPopTopDep> results = new ArrayList<>(targetArr.length);
			for (int idx = 0; idx < targetArr.length; idx++) {
				results.add(targetArr[idx]);
			}
			return(results);
			...
			List<ICFBamPubPopTopDep> results = new ArrayList<>();
			return(results);
		}
	}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffRelation ) {
			setJustPubRelation( (CFBamPubBuffRelation)src );
		}
		else {
	...
	public void setRelation( ICFBamPubRelation src ) {
		...
		setJustPubRequiredContainerFromTable(src.getRequiredContainerFromTable());
		setJustPubRequiredLookupFromIndex(src.getRequiredLookupFromIndex());
		setJustPubRequiredLookupToTable(src.getRequiredLookupToTable());
		setJustPubRequiredLookupToIndex(src.getRequiredLookupToIndex());
		setJustPubOptionalLookupNarrowed(src.getOptionalLookupNarrowed());
		...
		setJustPubRequiredRelationType(src.getRequiredRelationType());
		setJustPubOptionalDbName(src.getOptionalDbName());
		setJustPubOptionalSuffix(src.getOptionalSuffix());
		setJustPubRequiredFromIndexId(src.getRequiredFromIndexId());
		setJustPubRequiredToTableId(src.getRequiredToTableId());
		setJustPubRequiredToIndexId(src.getRequiredToIndexId());
		setJustPubRequiredIsRequired(src.getRequiredIsRequired());
		setJustPubRequiredIsXsdContainer(src.getRequiredIsXsdContainer());
		setJustPubRequiredIsLateResolver(src.getRequiredIsLateResolver());
		setJustPubRequiredAllowAddendum(src.getRequiredAllowAddendum());
		setJustPubOptionalNarrowedId(src.getOptionalNarrowedId());
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffRelation ) {
			setJustPubRelation( (CFBamPubPubBuffRelation)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffRelation" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
