// Description: Java 17 implJustPubementation of a BoolType buffer
...
public class CFBamPubBuffBoolType
	extends CFBamPubBuffBoolDef
	implements ICFBamBoolType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffBoolType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubBoolType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBoolType ) {
			setJustPubBoolType( (CFBamPubBuffBoolType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffBoolType ) {
			setJustPubBoolType( (CFBamPubPubBuffBoolType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffBoolType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
