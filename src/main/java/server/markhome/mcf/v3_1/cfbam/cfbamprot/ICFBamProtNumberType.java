// Description: Java 25 protected interface for a NumberType record implementation
...
/**
 *	ICFBamProtNumberType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtNumberType extends ICFBamProtNumberDef
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubNumberType.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubNumberType.SCHEMADEFID_INIT_VALUE;
