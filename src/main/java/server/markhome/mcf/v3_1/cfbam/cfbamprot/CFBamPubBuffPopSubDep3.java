// Description: Java 17 implJustPubementation of a PopSubDep3 buffer
...
public class CFBamPubBuffPopSubDep3
	...
	implements ICFBamPopSubDep3
{
	...
	public int getClassCode() {
		return( ICFBamPubPopSubDep3.CLASS_CODE );
	}

	@Override
	public ICFBamPubPopSubDep2 getRequiredContainerPopSubDep2(ICFLibKeyHash256 argPopSubDep2Id) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerPopSubDep2", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubPopSubDep2Table targetTable = targetBackingCFBam.getTablePopSubDep2();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerPopSubDep2", 0, "ICFBamPubSchema.getBackingCFBam().getTablePopSubDep2()");
		}
	...
	public void setRequiredContainerPopSubDep2(ICFLibKeyHash256 argPopSubDep2Id) {
		...
		ICFBamPubPopSubDep2 found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPopSubDep2Id);
		if (found == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerPopSubDep2-args", 0, "found");
		}
		else if (found instanceof ICFBamPubPopSubDep2) || (found instanceof ICFBamPubPopSubDep2)) {
			super.setRequiredContainerPopSubDep2(argPopSubDep2Id);
		requiredPopSubDep2Id = argPopSubDep2Id;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerPopSubDep2-args", "found", found, "ICFBamPubPopSubDep2ICFBamPubPopSubDep2");
		}
	}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffPopSubDep3 ) {
			setJustPubPopSubDep3( (CFBamPubBuffPopSubDep3)src );
		}
		else {
	...
	public void setPopSubDep3( ICFBamPubPopSubDep3 src ) {
		super.setPopDep( src );
		setJustPubRequiredContainerPopSubDep2(src.getRequiredContainerPopSubDep2());
		setJustPubRequiredPopSubDep2Id(src.getRequiredPopSubDep2Id());
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffPopSubDep3 ) {
			setJustPubPopSubDep3( (CFBamPubPubBuffPopSubDep3)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffPopSubDep3" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
