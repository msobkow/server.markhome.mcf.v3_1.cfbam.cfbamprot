// Description: Java 17 implJustPubementation of a NmTokensCol buffer
	...
	implements ICFBamNmTokensCol
{
	...
	public int getClassCode() {
		return( ICFBamPubNmTokensCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokensCol ) {
			setJustPubNmTokensCol( (CFBamPubBuffNmTokensCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNmTokensCol ) {
			setJustPubNmTokensCol( (CFBamPubPubBuffNmTokensCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNmTokensCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
