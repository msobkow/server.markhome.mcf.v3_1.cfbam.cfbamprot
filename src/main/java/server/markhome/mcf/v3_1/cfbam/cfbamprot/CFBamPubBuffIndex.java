// Description: Java 17 implJustPubementation of a Index buffer
...
public class CFBamPubBuffIndex
	...
	implements ICFBamIndex
{
	...
	public int getClassCode() {
		return( ICFBamPubIndex.CLASS_CODE );
	}
	...
	@Override
	public List<ICFBamPubIndexCol> getOptionalComponentsColumns(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsColumns", 0, "ICFBamPubSchema.getBackingCFBam().getTableIndexCol()");
		}
	...
	@Override
	public List<ICFBamPubIndexTweak> getOptionalComponentsTweaks(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTweaks", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubIndexTweakTable targetTable = targetBackingCFBam.getTableIndexTweak();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsTweaks", 0, "ICFBamPubSchema.getBackingCFBam().getTableIndexTweak()");
		}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffIndex ) {
			setJustPubIndex( (CFBamPubBuffIndex)src );
		}
		else {
	...
	public void setIndex( ICFBamPubIndex src ) {
		...
		setJustPubRequiredIsUnique(src.getRequiredIsUnique());
		setJustPubRequiredIsDbMapped(src.getRequiredIsDbMapped());
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffIndex ) {
			setJustPubIndex( (CFBamPubPubBuffIndex)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffIndex" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
