// Description: Java 17 implJustPubementation of a UInt16Col buffer
	...
	implements ICFBamUInt16Col
{
	...
	public int getClassCode() {
		return( ICFBamPubUInt16Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt16Col ) {
			setJustPubUInt16Col( (CFBamPubBuffUInt16Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt16Col ) {
			setJustPubUInt16Col( (CFBamPubPubBuffUInt16Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt16Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
