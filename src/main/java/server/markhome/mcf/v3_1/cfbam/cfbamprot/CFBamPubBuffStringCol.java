// Description: Java 17 implJustPubementation of a StringCol buffer
	...
	implements ICFBamStringCol
{
	...
	public int getClassCode() {
		return( ICFBamPubStringCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffStringCol ) {
			setJustPubStringCol( (CFBamPubBuffStringCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffStringCol ) {
			setJustPubStringCol( (CFBamPubPubBuffStringCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffStringCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
