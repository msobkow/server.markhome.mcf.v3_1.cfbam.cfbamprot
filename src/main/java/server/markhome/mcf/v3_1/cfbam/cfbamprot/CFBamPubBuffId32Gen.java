// Description: Java 17 implJustPubementation of a Id32Gen buffer
...
public class CFBamPubBuffId32Gen
	extends CFBamPubBuffInt32Type
	implements ICFBamId32Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffId32Gen() {
		super();
		requiredSlice = ICFBamPubId32Gen.SLICE_INIT_VALUE;
		requiredBlockSize = ICFBamPubId32Gen.BLOCKSIZE_INIT_VALUE;
	}

	@Override
	public int getClassCode() {
		return( ICFBamPubId32Gen.CLASS_CODE );
	}
	...
	public void setRequiredSlice( short value ) {
		if( value < ICFBamPubId32Gen.SLICE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				ICFBamPubId32Gen.SLICE_MIN_VALUE );
		}
		if( value > ICFBamPubId32Gen.SLICE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				ICFBamPubId32Gen.SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( value < ICFBamPubId32Gen.BLOCKSIZE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				ICFBamPubId32Gen.BLOCKSIZE_MIN_VALUE );
		}
		if( value > ICFBamPubId32Gen.BLOCKSIZE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				ICFBamPubId32Gen.BLOCKSIZE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubId32GenH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffId32Gen ) {
			setJustPubId32Gen( (CFBamPubBuffId32Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffId32Gen ) {
			setJustPubId32Gen( (CFBamPubPubBuffId32Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffId32Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
