// Description: Java 17 implJustPubementation of a DbKeyHash384Gen buffer
...
public class CFBamPubBuffDbKeyHash384Gen
	extends CFBamPubBuffDbKeyHash384Type
	implements ICFBamDbKeyHash384Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffDbKeyHash384Gen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash384Gen.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash384Gen ) {
			setJustPubDbKeyHash384Gen( (CFBamPubBuffDbKeyHash384Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash384Gen ) {
			setJustPubDbKeyHash384Gen( (CFBamPubPubBuffDbKeyHash384Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash384Gen" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash384Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
