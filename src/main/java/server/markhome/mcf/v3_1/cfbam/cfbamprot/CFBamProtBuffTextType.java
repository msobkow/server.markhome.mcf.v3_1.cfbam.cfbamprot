	...
	implements ICFBamTextType
{
	...
	public int getClassCode() {
		return( ICFBamTextType.CLASS_CODE );
	}
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTextTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	@Override
	public void setJustProtTextType( ICFBamTextType src ) {
	...
	@Override
	public void setJustProtTextType( ICFBamTextTypeH src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTextType( ICFBamProtTextType src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTextType( ICFBamProtTextTypeH src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTextType( ICFBamPubTextType src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTextType( ICFBamPubTextTypeH src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
