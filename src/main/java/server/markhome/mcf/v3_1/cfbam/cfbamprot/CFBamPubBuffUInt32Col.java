// Description: Java 17 implJustPubementation of a UInt32Col buffer
	...
	implements ICFBamUInt32Col
{
	...
	public int getClassCode() {
		return( ICFBamPubUInt32Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt32Col ) {
			setJustPubUInt32Col( (CFBamPubBuffUInt32Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt32Col ) {
			setJustPubUInt32Col( (CFBamPubPubBuffUInt32Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt32Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
