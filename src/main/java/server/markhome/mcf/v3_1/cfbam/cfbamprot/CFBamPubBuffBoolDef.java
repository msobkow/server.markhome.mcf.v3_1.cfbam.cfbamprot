// Description: Java 17 implJustPubementation of a BoolDef buffer
...
public class CFBamPubBuffBoolDef
	...
	implements ICFBamBoolDef
{
	...
	public int getClassCode() {
		return( ICFBamPubBoolDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubBoolDef rhs ) {
		...
		else if( obj instanceof ICFBamPubBoolDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBoolDef ) {
			setJustPubBoolDef( (CFBamPubBuffBoolDef)src );
		}
		else {
	...
	public void setBoolDef( ICFBamPubBoolDef src ) {
		...
		setJustPubOptionalFalseString(src.getOptionalFalseString());
		setJustPubOptionalTrueString(src.getOptionalTrueString());
		setJustPubOptionalNullString(src.getOptionalNullString());
	}
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffBoolDef ) {
			setJustPubBoolDef( (CFBamPubPubBuffBoolDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffBoolDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
