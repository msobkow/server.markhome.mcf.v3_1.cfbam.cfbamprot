...
// Description: Java 25 protected DbIO interface for Id64Gen.
...
/*
 *	CFBamProtId64GenTable protected database interface for Id64Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtId64GenTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamId64Gen protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
