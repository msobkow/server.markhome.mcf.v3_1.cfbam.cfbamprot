// Description: Java 17 implJustPubementation of a Atom buffer
	...
	implements ICFBamAtom
{
	...
	public int getClassCode() {
		return( ICFBamPubAtom.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffAtom ) {
			setJustPubAtom( (CFBamPubBuffAtom)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffAtom ) {
			setJustPubAtom( (CFBamPubPubBuffAtom)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffAtom" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
