// Description: Java 17 implJustPubementation of a DbKeyHash128Gen buffer
...
public class CFBamPubBuffDbKeyHash128Gen
	extends CFBamPubBuffDbKeyHash128Type
	implements ICFBamDbKeyHash128Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffDbKeyHash128Gen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash128Gen.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash128Gen ) {
			setJustPubDbKeyHash128Gen( (CFBamPubBuffDbKeyHash128Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash128Gen ) {
			setJustPubDbKeyHash128Gen( (CFBamPubPubBuffDbKeyHash128Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash128Gen" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash128Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
