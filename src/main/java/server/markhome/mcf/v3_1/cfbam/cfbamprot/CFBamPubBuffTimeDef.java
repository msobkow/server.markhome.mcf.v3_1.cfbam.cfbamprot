// Description: Java 17 implJustPubementation of a TimeDef buffer
	...
	implements ICFBamTimeDef
{
	...
	public int getClassCode() {
		return( ICFBamPubTimeDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubTimeDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimeDef ) {
			setJustPubTimeDef( (CFBamPubBuffTimeDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTimeDef ) {
			setJustPubTimeDef( (CFBamPubPubBuffTimeDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTimeDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
