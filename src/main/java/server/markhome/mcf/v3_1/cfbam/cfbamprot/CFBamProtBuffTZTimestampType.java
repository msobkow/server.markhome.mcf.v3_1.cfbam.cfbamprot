// Description: Java 25 implJustProtementation of a TZTimestampType buffer
...
public class CFBamProtBuffTZTimestampType
	extends CFBamProtBuffTZTimestampDef
	implements ICFBamTZTimestampType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamProtBuffTZTimestampType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamTZTimestampType.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtTZTimestampType rhs ) {
		...
		else if( obj instanceof ICFBamProtTZTimestampTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTZTimestampTypeBySchemaIdxKey rhs ) {
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTZTimestampType rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTZTimestampTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimestampTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTZTimestampTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffTZTimestampType ) {
			setJustProtTZTimestampType( (CFBamProtBuffTZTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffTZTimestampType" );
		}
	}

	@Override
	public void setJustProtTZTimestampType( ICFBamTZTimestampType src ) {
		super.setJustProtTZTimestampDef( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtTZTimestampTypeH ) {
			setTZTimestampType( (ICFBamProtTZTimestampTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
					"src",
					src,
					"ICFBamTZTimestampTypeH" );
		}
	}

	@Override
	public void setJustProtTZTimestampType( ICFBamTZTimestampTypeH src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTZTimestampType( ICFBamProtTZTimestampType src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTZTimestampType( ICFBamProtTZTimestampTypeH src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffTZTimestampType ) {
			setJustProtTZTimestampType( (CFBamPubProtBuffTZTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffTZTimestampType" );
		}
	}

	@Override
	public void setJustProtTZTimestampType( ICFBamPubTZTimestampType src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubTZTimestampTypeH ) {
			setTZTimestampType( (ICFBamPubTZTimestampTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTZTimestampType( ICFBamPubTZTimestampTypeH src ) {
		super.setJustProtTZTimestampDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffTZTimestampType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
