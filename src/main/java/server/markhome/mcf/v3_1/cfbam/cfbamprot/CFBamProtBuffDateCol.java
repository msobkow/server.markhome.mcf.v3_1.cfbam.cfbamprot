// Description: Java 17 implJustProtementation of a DateCol buffer
...
$reimplJustProtSchemaProtBuffTableNarrowedPubRelationSetter$
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDateCol rhs ) {
		...
		else if( obj instanceof ICFBamProtDateColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFBamProtBuffDateCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
