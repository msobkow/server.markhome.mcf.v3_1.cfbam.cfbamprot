...
public interface ICFBamProtNumberDefTableObj
{
	 ...
	 *	@param	ScopeId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtNumberDefObj> readNumberDefByScopeIdx( CFLibDbKeyHash256 ScopeId );

	/**
	 *	Get the map of CFBamProtNumberDefObj instances sorted by their primary keys for the duplicate ScopeIdx key.
	 *
	 *	@param	ScopeId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtNumberDefObj> readNumberDefByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	/**
	 *	Get the map of CFBamProtNumberDefObj instances sorted by their primary keys for the duplicate DefSchemaIdx key.
	 *
	 *	@param	DefSchemaId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtNumberDefObj> readNumberDefByPrevIdx( CFLibDbKeyHash256 PrevId );

	/**
	 *	Get the map of CFBamProtNumberDefObj instances sorted by their primary keys for the duplicate PrevIdx key.
	 *
	 *	@param	PrevId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtNumberDefObj> readNumberDefByNextIdx( CFLibDbKeyHash256 NextId );

	/**
	 *	Get the map of CFBamProtNumberDefObj instances sorted by their primary keys for the duplicate NextIdx key.
	 *
	 *	@param	NextId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 ...
	 *	@param	PrevId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate ContPrevIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtNumberDefObj instances sorted by their primary keys for the duplicate ContPrevIdx key.
	 *
	 *	@param	ScopeId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@param	PrevId	The NumberDef key attribute of the instance generating the id.
	 ...
	 *	@param	NextId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtNumberDefObj cached instances sorted by their primary keys for the duplicate ContNextIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtNumberDefObj instances sorted by their primary keys for the duplicate ContNextIdx key.
	 *
	 *	@param	ScopeId	The NumberDef key attribute of the instance generating the id.
	 *
	 *	@param	NextId	The NumberDef key attribute of the instance generating the id.
	...
	ICFBamProtNumberDefObj readCachedNumberDefByIdIdx( CFLibDbKeyHash256 Id );

	ICFBamProtNumberDefObj readCachedNumberDefByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );

	List<ICFBamProtNumberDefObj> readCachedNumberDefByScopeIdx( CFLibDbKeyHash256 ScopeId );

	List<ICFBamProtNumberDefObj> readCachedNumberDefByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamProtNumberDefObj> readCachedNumberDefByPrevIdx( CFLibDbKeyHash256 PrevId );

	List<ICFBamProtNumberDefObj> readCachedNumberDefByNextIdx( CFLibDbKeyHash256 NextId );

	List<ICFBamProtNumberDefObj> readCachedNumberDefByContPrevIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );

	List<ICFBamProtNumberDefObj> readCachedNumberDefByContNextIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );
	...
	/**
	 *	Move the CFBamProtNumberDefObj instance up in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtNumberDefObj refreshed cache instance.
	 */
	ICFBamProtNumberDefObj moveUpNumberDef( ICFBamProtNumberDefObj Obj );

	/**
	 *	Move the CFBamProtNumberDefObj instance down in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtNumberDefObj refreshed cache instance.
	 */
