...
public class CFBamProtBuffBoolDef
	...
	implements ICFBamBoolDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtBoolDef rhs ) {
		...
		else if( obj instanceof ICFBamProtBoolDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setBoolDef( ICFBamProtBoolDef src ) {
		...
		setJustProtOptionalNullString(src.getOptionalNullString());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffBoolDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
