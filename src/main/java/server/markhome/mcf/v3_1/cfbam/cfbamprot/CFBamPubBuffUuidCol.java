// Description: Java 17 implJustPubementation of a UuidCol buffer
	...
	implements ICFBamUuidCol
{
	...
	public int getClassCode() {
		return( ICFBamPubUuidCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuidCol ) {
			setJustPubUuidCol( (CFBamPubBuffUuidCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuidCol ) {
			setJustPubUuidCol( (CFBamPubPubBuffUuidCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuidCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
