// Description: Java 17 implJustPubementation of a TZTimestampType buffer
...
public class CFBamPubBuffTZTimestampType
	extends CFBamPubBuffTZTimestampDef
	implements ICFBamTZTimestampType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffTZTimestampType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubTZTimestampType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimestampType ) {
			setJustPubTZTimestampType( (CFBamPubBuffTZTimestampType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZTimestampType ) {
			setJustPubTZTimestampType( (CFBamPubPubBuffTZTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffTZTimestampType" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZTimestampType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
