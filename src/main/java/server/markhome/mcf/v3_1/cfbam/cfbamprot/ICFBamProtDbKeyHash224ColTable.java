...
// Description: Java 25 protected DbIO interface for DbKeyHash224Col.
...
/*
 *	CFBamProtDbKeyHash224ColTable protected database interface for DbKeyHash224Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash224ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDbKeyHash224Col protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
