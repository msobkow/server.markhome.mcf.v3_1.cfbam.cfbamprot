// Description: Java 17 implJustPubementation of a StringType buffer
...
public class CFBamPubBuffStringType
	extends CFBamPubBuffStringDef
	implements ICFBamStringType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffStringType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubStringType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffStringType ) {
			setJustPubStringType( (CFBamPubBuffStringType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffStringType ) {
			setJustPubStringType( (CFBamPubPubBuffStringType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffStringType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
