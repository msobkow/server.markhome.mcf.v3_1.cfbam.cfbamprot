// Description: Java 25 Object interface for CFBamProt EnumTag.
...
public interface ICFBamProtEnumTagObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamProtEnumTag.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamProtEnumTagObj instance which should be subsequently referenced.
	 */
	ICFBamProtEnumTagObj realise();
	 ...
	 *
	 *	@return	ICFBamProtEnumTagObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtEnumTagObj read();
	 ...
	 *	@return	ICFBamProtEnumTagObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtEnumTagObj read( boolean forceRead );

	/**
	 *	Move this object up in the chain and refresh the cache.
	 *
	 *	@return	ICFBamProtEnumTagObj the reference to the moved and refreshed instance.
	 */
	ICFBamProtEnumTagObj moveUp();
	 ...
	 *	@return	ICFBamProtEnumTagObj the reference to the moved and refreshed instance.
	 */
	ICFBamProtEnumTagObj moveDown();

	/**
	 *	Initialize and return a locked edition of this EnumTag instance.
	 *
	 *	@return	The newly locked ICFBamProtEnumTagEditObj edition of this instance.
	 */
	ICFBamProtEnumTagEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamProtEnumTagEditObj edition of this instance.
	 */
	ICFBamProtEnumTagEditObj getEdit();

	/**
	 *	Get the current edition of this EnumTag instance as a ICFBamProtEnumTagEditObj.
	 *
	 *	@return	The ICFBamProtEnumTagEditObj edition of this instance.
	 */
	ICFBamProtEnumTagEditObj getEditAsEnumTag();

	/**
	 *	Get the ICFBamProtEnumTagTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtEnumTagTableObj table cache which manages this instance.
	 */
	ICFBamProtEnumTagTableObj getEnumTagTable();
	...
	/**
	 *	Get the ICFBamProtEnumTag instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtEnumTag instance which currently backs this object.
	 */
	ICFBamProtEnumTag getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamProtEnumTag value );
	 ...
	 *	@return	ICFBamProtEnumTag instance which currently backs this object.
	 */
	ICFBamProtEnumTag getEnumTagRec();
