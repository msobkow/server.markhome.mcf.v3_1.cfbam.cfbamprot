// Description: Java 17 implJustPubementation of a NumberType buffer
	...
	implements ICFBamNumberType
{
	...
	public int getClassCode() {
		return( ICFBamPubNumberType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNumberType ) {
			setJustPubNumberType( (CFBamPubBuffNumberType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNumberType ) {
			setJustPubNumberType( (CFBamPubPubBuffNumberType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNumberType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
