// Description: Java 17 implJustPubementation of a DateCol buffer
	...
	implements ICFBamDateCol
{
	...
	public int getClassCode() {
		return( ICFBamPubDateCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubDateCol rhs ) {
		...
		else if( obj instanceof ICFBamPubDateColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDateColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDateCol ) {
			setJustPubDateCol( (CFBamPubBuffDateCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDateCol ) {
			setJustPubDateCol( (CFBamPubPubBuffDateCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffDateCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
