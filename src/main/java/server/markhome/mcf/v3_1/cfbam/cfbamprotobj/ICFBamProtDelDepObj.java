// Description: Java 25 Object interface for CFBamProt DelDep.
...
public interface ICFBamProtDelDepObj
	extends ICFBamProtScopeObj
{
	/**
	 *	Get the current edition of this DelDep instance as a ICFBamProtDelDepEditObj.
	 *
	 *	@return	The ICFBamProtDelDepEditObj edition of this instance.
	 */
	ICFBamProtDelDepEditObj getEditAsDelDep();

	/**
	 *	Get the ICFBamProtDelDepTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtDelDepTableObj table cache which manages this instance.
	 */
	ICFBamProtDelDepTableObj getDelDepTable();

	/**
	 *	Get the ICFBamProtDelDep instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtDelDep instance which currently backs this object.
	 */
