...
public interface ICFBamProtScopeTableObj
{
	 ...
	 */
	ICFBamProtScopeObj newInstance();
	 ...
	 */
	ICFBamProtScopeEditObj newEditInstance( ICFBamProtScopeObj orig );
	 ...
	 *
	 *	@return	ICFBamProtScopeObj instance, which may be a subclass of a Scope instance.
	 */
	ICFBamProtScopeObj constructByClassCode( int backingClassCode );

	/**
	 *	Internal use only.
	 */
	ICFBamProtScopeObj realiseScope( ICFBamProtScopeObj Obj );

	/**
	 *	Internal use only.
	 */
	ICFBamProtScopeObj createScope( ICFBamProtScopeObj Obj );
	 ...
	 */
	ICFBamProtScopeObj readScope( CFLibDbKeyHash256 pkey );
	...
	ICFBamProtScopeObj readCachedScope( CFLibDbKeyHash256 pkey );

	public void reallyDeepDisposeScope( ICFBamProtScopeObj obj );
	 ...
	 *	Internal use only.
	 */
	ICFBamProtScopeObj lockScope( CFLibDbKeyHash256 pkey );

	/**
	 *	Return a sorted list of all the Scope-derived instances in the database.
	 *
	 *	@return	List of ICFBamProtScopeObj instance, sorted by their primary keys, which
	 *		may include an empty set.
	 */
	List<ICFBamProtScopeObj> readAllScope();
	 ...
	 *		may include an empty set.
	 */
	List<ICFBamProtScopeObj> readAllScope( boolean forceRead );

	List<ICFBamProtScopeObj> readCachedAllScope();
	 ...
	 *
	 *	@return	List of CFBamProtScopeObj cached instances sorted by their primary keys for the duplicate TenantIdx key,
	...
	List<ICFBamProtScopeObj> readCachedScopeByTenantIdx( CFLibDbKeyHash256 TenantId );
	 ...
	 *	Internal use only.
	 */
	ICFBamProtScopeObj updateScope( ICFBamProtScopeObj Obj );

	/**
	 *	Internal use only.
	 */
	void deleteScope( ICFBamProtScopeObj Obj );
