// Description: Java 25 implJustProtementation of a DbKeyHash224Col buffer
	...
	implements ICFBamDbKeyHash224Col
{
	...
	public int getClassCode() {
		return( ICFBamDbKeyHash224Col.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash224Col rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash224ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash224ColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash224ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash224Col ) {
			setJustProtDbKeyHash224Col( (CFBamProtBuffDbKeyHash224Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash224Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash224Col( ICFBamDbKeyHash224Col src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash224ColH ) {
			setDbKeyHash224Col( (ICFBamProtDbKeyHash224ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
					"src",
					src,
					"ICFBamDbKeyHash224ColH" );
		}
	}

	@Override
	public void setJustProtDbKeyHash224Col( ICFBamDbKeyHash224ColH src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash224Col( ICFBamProtDbKeyHash224Col src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash224Col( ICFBamProtDbKeyHash224ColH src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash224Col ) {
			setJustProtDbKeyHash224Col( (CFBamPubProtBuffDbKeyHash224Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash224Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash224Col( ICFBamPubDbKeyHash224Col src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash224Col( ICFBamPubDbKeyHash224ColH src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash224Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
