// Description: Java 17 implJustPubementation of a Uuid6Def buffer
	...
	implements ICFBamUuid6Def
{
	...
	public int getClassCode() {
		return( ICFBamPubUuid6Def.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubUuid6Def rhs ) {
		...
		else if( obj instanceof ICFBamPubUuid6DefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Def ) {
			setJustPubUuid6Def( (CFBamPubBuffUuid6Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuid6Def ) {
			setJustPubUuid6Def( (CFBamPubPubBuffUuid6Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuid6Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
