// Description: Java 17 implJustPubementation of a NmTokenDef buffer
...
public class CFBamPubBuffNmTokenDef
	...
	implements ICFBamNmTokenDef
{
	...
	public CFBamPubBuffNmTokenDef() {
		super();
		requiredMaxLen = ICFBamPubNmTokenDef.MAXLEN_INIT_VALUE;
		optionalInitValue = null;
	}

	@Override
	public int getClassCode() {
		return( ICFBamPubNmTokenDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubNmTokenDef rhs ) {
		...
		else if( obj instanceof ICFBamPubNmTokenDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokenDef ) {
			setJustPubNmTokenDef( (CFBamPubBuffNmTokenDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNmTokenDef ) {
			setJustPubNmTokenDef( (CFBamPubPubBuffNmTokenDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNmTokenDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
