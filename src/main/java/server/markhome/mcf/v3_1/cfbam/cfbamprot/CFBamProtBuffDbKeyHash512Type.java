// Description: Java 25 implJustProtementation of a DbKeyHash512Type buffer
...
public class CFBamProtBuffDbKeyHash512Type
	extends CFBamProtBuffDbKeyHash512Def
	implements ICFBamDbKeyHash512Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamProtBuffDbKeyHash512Type() {
		super();
		requiredSchemaDefId = CFLibDbKeyHash256.fromHex( ICFBamPubDbKeyHash512Type.SCHEMADEFID_INIT_VALUE.toString() );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash512Type rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash512TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash512TypeBySchemaIdxKey rhs ) {
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash512Type rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash512TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash512TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash512TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash512Type ) {
			setJustProtDbKeyHash512Type( (CFBamProtBuffDbKeyHash512Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash512Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash512Type( ICFBamDbKeyHash512Type src ) {
		super.setJustProtDbKeyHash512Def( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash512TypeH ) {
			setDbKeyHash512Type( (ICFBamProtDbKeyHash512TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash512Type( ICFBamDbKeyHash512TypeH src ) {
		super.setJustProtDbKeyHash512Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash512Type( ICFBamProtDbKeyHash512Type src ) {
		super.setJustProtDbKeyHash512Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash512Type( ICFBamProtDbKeyHash512TypeH src ) {
		super.setJustProtDbKeyHash512Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash512Type ) {
			setJustProtDbKeyHash512Type( (CFBamPubProtBuffDbKeyHash512Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash512Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash512Type( ICFBamPubDbKeyHash512Type src ) {
		super.setJustProtDbKeyHash512Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash512TypeH ) {
			setDbKeyHash512Type( (ICFBamPubDbKeyHash512TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash512Type( ICFBamPubDbKeyHash512TypeH src ) {
		super.setJustProtDbKeyHash512Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash512Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
