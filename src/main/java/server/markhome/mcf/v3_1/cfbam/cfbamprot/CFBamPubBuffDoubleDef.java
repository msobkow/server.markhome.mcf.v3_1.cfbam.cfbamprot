// Description: Java 17 implJustPubementation of a DoubleDef buffer
	...
	implements ICFBamDoubleDef
{
	...
	public int getClassCode() {
		return( ICFBamPubDoubleDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubDoubleDef rhs ) {
		...
		else if( obj instanceof ICFBamPubDoubleDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDoubleDef ) {
			setJustPubDoubleDef( (CFBamPubBuffDoubleDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDoubleDef ) {
			setJustPubDoubleDef( (CFBamPubPubBuffDoubleDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffDoubleDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
