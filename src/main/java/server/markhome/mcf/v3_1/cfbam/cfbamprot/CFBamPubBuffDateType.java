// Description: Java 17 implJustPubementation of a DateType buffer
...
public class CFBamPubBuffDateType
	extends CFBamPubBuffDateDef
	implements ICFBamDateType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffDateType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDateType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDateType ) {
			setJustPubDateType( (CFBamPubBuffDateType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDateType ) {
			setJustPubDateType( (CFBamPubPubBuffDateType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffDateType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
