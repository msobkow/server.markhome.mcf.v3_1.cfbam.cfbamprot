// Description: Java 17 implJustPubementation of a DbKeyHash160Gen buffer
...
public class CFBamPubBuffDbKeyHash160Gen
	extends CFBamPubBuffDbKeyHash160Type
	implements ICFBamDbKeyHash160Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffDbKeyHash160Gen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash160Gen.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash160Gen ) {
			setJustPubDbKeyHash160Gen( (CFBamPubBuffDbKeyHash160Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash160Gen ) {
			setJustPubDbKeyHash160Gen( (CFBamPubPubBuffDbKeyHash160Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash160Gen" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash160Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
