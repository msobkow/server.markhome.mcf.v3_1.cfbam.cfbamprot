// Description: Java 25 implJustProtementation of a TZDateCol buffer
	...
	implements ICFBamTZDateCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtTZDateCol rhs ) {
		...
		else if( obj instanceof ICFBamProtTZDateColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTZDateColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTZDateCol rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTZDateColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamPubTZDateColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffTZDateCol ) {
			setJustProtTZDateCol( (CFBamProtBuffTZDateCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffTZDateCol" );
		}
	}

	@Override
	public void setJustProtTZDateCol( ICFBamTZDateCol src ) {
		super.setJustProtTZDateDef( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtTZDateColH ) {
			setTZDateCol( (ICFBamProtTZDateColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTZDateCol( ICFBamTZDateColH src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtTZDateCol( ICFBamProtTZDateCol src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtTZDateCol( ICFBamProtTZDateColH src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffTZDateCol ) {
			setJustProtTZDateCol( (CFBamPubProtBuffTZDateCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffTZDateCol" );
		}
	}

	@Override
	public void setJustProtTZDateCol( ICFBamPubTZDateCol src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubTZDateColH ) {
			setTZDateCol( (ICFBamPubTZDateColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTZDateCol( ICFBamPubTZDateColH src ) {
		super.setJustProtTZDateDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffTZDateCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
