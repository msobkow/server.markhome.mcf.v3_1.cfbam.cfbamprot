	...
	implements ICFBamClearTopDep
{
	...
	public void setJustProtOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		...
		optionalPrevId = argPrevId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setJustProtOptionalLookupPrev-args", "found", found, "ICFBamClearTopDepICFBamProtClearTopDepICFBamPubClearTopDep");
		}
	}

	@Override
	public void setJustProtOptionalLookupPrev(ICFBamClearTopDep argObj) {
		if(argObj == null) {
	...
	public void setJustProtOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		...
		optionalNextId = argNextId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setJustProtOptionalLookupNext-args", "found", found, "ICFBamClearTopDepICFBamProtClearTopDepICFBamPubClearTopDep");
		}
	}

	@Override
	public void setJustProtOptionalLookupNext(ICFBamClearTopDep argObj) {
		if(argObj == null) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamClearTopDepByClrTopDepTblIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamClearTopDepByUNameIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamClearTopDepByPrevIdxKey rhs ) {
			if( getOptionalPrevId() != null ) {
				if( rhs.getOptionalPrevId() != null ) {
					cmp = getOptionalPrevId().compareTo( rhs.getOptionalPrevId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamClearTopDepByNextIdxKey rhs ) {
			if( getOptionalNextId() != null ) {
				if( rhs.getOptionalNextId() != null ) {
					cmp = getOptionalNextId().compareTo( rhs.getOptionalNextId() );
					if( cmp != 0 ) {
	...
	@Override
	public void setJustProtClearTopDep( ICFBamClearTopDep src ) {
	...
	public void setJustProt( ICFBamScopeH src ) {
		if( src instanceof ICFBamProtClearTopDepH ) {
			setClearTopDep( (ICFBamProtClearTopDepH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtClearTopDep( ICFBamClearTopDepH src ) {
		super.setJustProtClearDep( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtOptionalLookupPrev(src.getOptionalLookupPrev());
		setJustProtOptionalLookupNext(src.getOptionalLookupNext());
	...
	@Override
	public void setJustProtClearTopDep( ICFBamProtClearTopDep src ) {
		super.setJustProtClearDep( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtOptionalLookupPrev(src.getOptionalLookupPrev());
		setJustProtOptionalLookupNext(src.getOptionalLookupNext());
	...
	@Override
	public void setJustProtClearTopDep( ICFBamProtClearTopDepH src ) {
		super.setJustProtClearDep( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtOptionalLookupPrev(src.getOptionalLookupPrev());
		setJustProtOptionalLookupNext(src.getOptionalLookupNext());
	...
	@Override
	public void setJustProtClearTopDep( ICFBamPubClearTopDep src ) {
		super.setJustProtClearDep( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtOptionalLookupPrev(src.getOptionalLookupPrev());
		setJustProtOptionalLookupNext(src.getOptionalLookupNext());
	...
	@Override
	public void setJustProtClearTopDep( ICFBamPubClearTopDepH src ) {
		super.setJustProtClearDep( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtOptionalLookupPrev(src.getOptionalLookupPrev());
		setJustProtOptionalLookupNext(src.getOptionalLookupNext());
