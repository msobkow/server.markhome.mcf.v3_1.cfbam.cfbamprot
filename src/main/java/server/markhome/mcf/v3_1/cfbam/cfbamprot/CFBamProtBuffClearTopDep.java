	...
	implements ICFBamClearTopDep
{
	...
	public void setRequiredContainerTable(ICFLibKeyHash256 argTableId) {
		...
		requiredTableId = argTableId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerTable-args", "found", found, "ICFBamProtTableICFBamPubTable");
		}
	}
	...
	@Override
	public ICFBamProtClearTopDep getOptionalLookupPrev() {
		ICFBamSchema targetBackingCFBam = ICFBamSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		ICFBamProtClearTopDep targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getOptionalPrevId());
		return(targetRec);
	}
	...
	public ICFBamProtClearTopDep getOptionalLookupNext() {
		...
		ICFBamProtClearTopDep targetRec = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getOptionalNextId());
		return(targetRec);
	}
	...
	@Override
	public List<ICFBamProtClearSubDep1> getOptionalComponentsClearDep() {
		ICFBamSchema targetBackingCFBam = ICFBamSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
