...
public class CFBamProtBuffNmTokenDef
	...
	implements ICFBamNmTokenDef
{
	...
	public CFBamProtBuffNmTokenDef() {
		super();
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtNmTokenDef rhs ) {
		...
		else if( obj instanceof ICFBamProtNmTokenDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFBamProtBuffNmTokenDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
