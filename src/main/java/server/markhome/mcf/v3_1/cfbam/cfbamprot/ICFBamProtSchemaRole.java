// Description: Java 25 protected interface for a SchemaRole record implementation
...
public interface ICFBamProtSchemaRole extends ICFBamProtRoleDef
{
	...
	public static final ICFBamProtSchema.RoleScopeEnum ROLESCOPE_INIT_VALUE = ICFBamProtSchema.ordinalToRoleScopeEnum( 0 );
	...
	public void setProtSchemaRole( ICFBamProtSchemaRole src );
	public void set( ICFBamProtRoleDefH src );
	public void setProtSchemaRole( ICFBamProtSchemaRoleH src );
}
