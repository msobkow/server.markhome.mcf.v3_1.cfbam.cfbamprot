// Description: Java 17 implJustPubementation of a Int32Col buffer
	...
	implements ICFBamInt32Col
{
	...
	public int getClassCode() {
		return( ICFBamPubInt32Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt32Col ) {
			setJustPubInt32Col( (CFBamPubBuffInt32Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt32Col ) {
			setJustPubInt32Col( (CFBamPubPubBuffInt32Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt32Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
