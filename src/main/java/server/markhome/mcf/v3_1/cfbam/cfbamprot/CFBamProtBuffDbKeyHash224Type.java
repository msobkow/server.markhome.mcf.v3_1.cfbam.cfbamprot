// Description: Java 25 implJustProtementation of a DbKeyHash224Type buffer
...
public class CFBamProtBuffDbKeyHash224Type
	extends CFBamProtBuffDbKeyHash224Def
	implements ICFBamDbKeyHash224Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamProtBuffDbKeyHash224Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamDbKeyHash224Type.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash224Type rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash224TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash224TypeBySchemaIdxKey rhs ) {
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash224Type rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash224TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash224TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash224TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash224Type ) {
			setJustProtDbKeyHash224Type( (CFBamProtBuffDbKeyHash224Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash224Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash224Type( ICFBamDbKeyHash224Type src ) {
		super.setJustProtDbKeyHash224Def( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash224TypeH ) {
			setDbKeyHash224Type( (ICFBamProtDbKeyHash224TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
					"src",
					src,
					"ICFBamDbKeyHash224TypeH" );
		}
	}

	@Override
	public void setJustProtDbKeyHash224Type( ICFBamDbKeyHash224TypeH src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash224Type( ICFBamProtDbKeyHash224Type src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash224Type( ICFBamProtDbKeyHash224TypeH src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash224Type ) {
			setJustProtDbKeyHash224Type( (CFBamPubProtBuffDbKeyHash224Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash224Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash224Type( ICFBamPubDbKeyHash224Type src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash224TypeH ) {
			setDbKeyHash224Type( (ICFBamPubDbKeyHash224TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash224Type( ICFBamPubDbKeyHash224TypeH src ) {
		super.setJustProtDbKeyHash224Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash224Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
