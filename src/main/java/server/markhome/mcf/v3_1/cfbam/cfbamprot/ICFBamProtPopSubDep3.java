// Description: Java 25 protected interface for a PopSubDep3 record implementation
...
public interface ICFBamProtPopSubDep3 extends ICFBamProtPopDep
{
	...
	public default void setRequiredContainerPopSubDep2(ICFBamPubPopSubDep2 argObj) {
		if (argObj == null) {
			setRequiredContainerPopSubDep2((ICFBamProtPopSubDep2)null);
		}
		else {
