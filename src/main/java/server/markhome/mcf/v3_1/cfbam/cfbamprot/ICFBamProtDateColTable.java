...
// Description: Java 25 protected DbIO interface for DateCol.
...
/*
 *	CFBamProtDateColTable protected database interface for DateCol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
