// Description: Java 17 implJustPubementation of a Int64Def buffer
...
public class CFBamPubBuffInt64Def
	...
	implements ICFBamInt64Def
{
	...
	public int getClassCode() {
		return( ICFBamPubInt64Def.CLASS_CODE );
	}
	...
	public void setOptionalInitValue( Long value ) {
		if( value < ICFBamPubInt64Def.INITVALUE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalInitValue",
				1,
				"value",
				value,
				ICFBamPubInt64Def.INITVALUE_MIN_VALUE );
		}
		if( value > ICFBamPubInt64Def.INITVALUE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setOptionalInitValue",
				1,
				"value",
				value,
				ICFBamPubInt64Def.INITVALUE_MAX_VALUE );
		}
	...
	public void setOptionalMinValue( Long value ) {
		if( value < ICFBamPubInt64Def.MINVALUE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalMinValue",
				1,
				"value",
				value,
				ICFBamPubInt64Def.MINVALUE_MIN_VALUE );
		}
		if( value > ICFBamPubInt64Def.MINVALUE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setOptionalMinValue",
				1,
				"value",
				value,
				ICFBamPubInt64Def.MINVALUE_MAX_VALUE );
		}
	...
	public void setOptionalMaxValue( Long value ) {
		if( value < ICFBamPubInt64Def.MAXVALUE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalMaxValue",
				1,
				"value",
				value,
				ICFBamPubInt64Def.MAXVALUE_MIN_VALUE );
		}
		if( value > ICFBamPubInt64Def.MAXVALUE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setOptionalMaxValue",
				1,
				"value",
				value,
				ICFBamPubInt64Def.MAXVALUE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubInt64Def rhs ) {
		...
		else if( obj instanceof ICFBamPubInt64DefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt64Def ) {
			setJustPubInt64Def( (CFBamPubBuffInt64Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt64Def ) {
			setJustPubInt64Def( (CFBamPubPubBuffInt64Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt64Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
