...
public interface ICFBamProtId32GenTableObj
{
	 ...
	 */
	ICFBamProtId32GenObj newInstance();
	 ...
	 */
	ICFBamProtId32GenEditObj newEditInstance( ICFBamProtId32GenObj orig );

	/**
	 *	Internal use only.
	 */
	ICFBamProtId32GenObj realiseId32Gen( ICFBamProtId32GenObj Obj );

	/**
	 *	Internal use only.
	 */
	ICFBamProtId32GenObj createId32Gen( ICFBamProtId32GenObj Obj );
	 ...
	 */
	ICFBamProtId32GenObj readId32Gen( CFLibDbKeyHash256 pkey );
	...
	ICFBamProtId32GenObj readCachedId32Gen( CFLibDbKeyHash256 pkey );

	public void reallyDeepDisposeId32Gen( ICFBamProtId32GenObj obj );
	 ...
	 *	Internal use only.
	 */
	ICFBamProtId32GenObj lockId32Gen( CFLibDbKeyHash256 pkey );

	/**
	 *	Return a sorted list of all the Id32Gen-derived instances in the database.
	 *
	 *	@return	List of ICFBamProtId32GenObj instance, sorted by their primary keys, which
	 *		may include an empty set.
	 */
	List<ICFBamProtId32GenObj> readAllId32Gen();
	 ...
	 *		may include an empty set.
	 */
	List<ICFBamProtId32GenObj> readAllId32Gen( boolean forceRead );

	List<ICFBamProtId32GenObj> readCachedAllId32Gen();
	 ...
	 *	@param	ScopeId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtId32GenObj> readId32GenByScopeIdx( CFLibDbKeyHash256 ScopeId );

	/**
	 *	Get the map of CFBamProtId32GenObj instances sorted by their primary keys for the duplicate ScopeIdx key.
	 *
	 *	@param	ScopeId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtId32GenObj> readId32GenByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	/**
	 *	Get the map of CFBamProtId32GenObj instances sorted by their primary keys for the duplicate DefSchemaIdx key.
	 *
	 *	@param	DefSchemaId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtId32GenObj> readId32GenByPrevIdx( CFLibDbKeyHash256 PrevId );

	/**
	 *	Get the map of CFBamProtId32GenObj instances sorted by their primary keys for the duplicate PrevIdx key.
	 *
	 *	@param	PrevId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtId32GenObj> readId32GenByNextIdx( CFLibDbKeyHash256 NextId );

	/**
	 *	Get the map of CFBamProtId32GenObj instances sorted by their primary keys for the duplicate NextIdx key.
	 *
	 *	@param	NextId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 ...
	 *	@param	PrevId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate ContPrevIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtId32GenObj instances sorted by their primary keys for the duplicate ContPrevIdx key.
	 *
	 *	@param	ScopeId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@param	PrevId	The Id32Gen key attribute of the instance generating the id.
	 ...
	 *	@param	NextId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate ContNextIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtId32GenObj instances sorted by their primary keys for the duplicate ContNextIdx key.
	 *
	 *	@param	ScopeId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@param	NextId	The Id32Gen key attribute of the instance generating the id.
	 ...
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate SchemaIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtId32GenObj> readId32GenBySchemaIdx( CFLibDbKeyHash256 SchemaDefId );

	/**
	 *	Get the map of CFBamProtId32GenObj instances sorted by their primary keys for the duplicate SchemaIdx key.
	 *
	 *	@param	SchemaDefId	The Id32Gen key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtId32GenObj cached instances sorted by their primary keys for the duplicate SchemaIdx key,
	...
	ICFBamProtId32GenObj readCachedId32GenByIdIdx( CFLibDbKeyHash256 Id );

	ICFBamProtId32GenObj readCachedId32GenByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );

	List<ICFBamProtId32GenObj> readCachedId32GenByScopeIdx( CFLibDbKeyHash256 ScopeId );

	List<ICFBamProtId32GenObj> readCachedId32GenByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamProtId32GenObj> readCachedId32GenByPrevIdx( CFLibDbKeyHash256 PrevId );

	List<ICFBamProtId32GenObj> readCachedId32GenByNextIdx( CFLibDbKeyHash256 NextId );

	List<ICFBamProtId32GenObj> readCachedId32GenByContPrevIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );

	List<ICFBamProtId32GenObj> readCachedId32GenByContNextIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );

	List<ICFBamProtId32GenObj> readCachedId32GenBySchemaIdx( CFLibDbKeyHash256 SchemaDefId );
	 ...
	 *	Internal use only.
	 */
	ICFBamProtId32GenObj updateId32Gen( ICFBamProtId32GenObj Obj );

	/**
	 *	Internal use only.
	 */
	void deleteId32Gen( ICFBamProtId32GenObj Obj );
	...
	/**
	 *	Move the CFBamProtId32GenObj instance up in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtId32GenObj refreshed cache instance.
	 */
	ICFBamProtId32GenObj moveUpId32Gen( ICFBamProtId32GenObj Obj );

	/**
	 *	Move the CFBamProtId32GenObj instance down in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtId32GenObj refreshed cache instance.
	 */
	ICFBamProtId32GenObj moveDownId32Gen( ICFBamProtId32GenObj Obj );
}
