// Description: Java 17 implJustPubementation of a TokenCol buffer
	...
	implements ICFBamTokenCol
{
	...
	public int getClassCode() {
		return( ICFBamPubTokenCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTokenCol ) {
			setJustPubTokenCol( (CFBamPubBuffTokenCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTokenCol ) {
			setJustPubTokenCol( (CFBamPubPubBuffTokenCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTokenCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
