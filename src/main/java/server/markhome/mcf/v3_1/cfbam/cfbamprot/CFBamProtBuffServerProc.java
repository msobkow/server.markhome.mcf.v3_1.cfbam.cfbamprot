// Description: Java 25 implJustProtementation of a ServerProc buffer
	...
	implements ICFBamServerProc
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtServerProc rhs ) {
		...
		else if( obj instanceof ICFBamProtServerProcH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFBamProtBuffServerProc" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
