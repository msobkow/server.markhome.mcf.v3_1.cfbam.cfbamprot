...
// Description: Java 25 protected DbIO interface for PopTopDep.
...
/*
 *	CFBamProtPopTopDepTable protected database interface for PopTopDep has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
