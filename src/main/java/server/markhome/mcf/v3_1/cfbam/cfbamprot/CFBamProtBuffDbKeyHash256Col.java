// Description: Java 25 implJustProtementation of a DbKeyHash256Col buffer
...
public class CFBamProtBuffDbKeyHash256Col
	extends CFBamProtBuffDbKeyHash256Def
	implements ICFBamDbKeyHash256Col
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamProtBuffDbKeyHash256Col() {
		super();
		requiredTableId = CFLibDbKeyHash256.fromHex( ICFBamPubDbKeyHash256Col.TABLEID_INIT_VALUE.toString() );
	}

	@Override
	public int getClassCode() {
		return( ICFBamDbKeyHash256Col.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash256Col rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash256ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash256ColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash256Col rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash256ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash256ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash256ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash256Col ) {
			setJustProtDbKeyHash256Col( (CFBamProtBuffDbKeyHash256Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash256Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash256Col( ICFBamDbKeyHash256Col src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash256ColH ) {
			setDbKeyHash256Col( (ICFBamProtDbKeyHash256ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
					"src",
					src,
					"ICFBamDbKeyHash256ColH" );
		}
	}

	@Override
	public void setJustProtDbKeyHash256Col( ICFBamDbKeyHash256ColH src ) {
		super.setJustProtDbKeyHash256Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash256Col( ICFBamProtDbKeyHash256Col src ) {
		super.setJustProtDbKeyHash256Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash256Col( ICFBamProtDbKeyHash256ColH src ) {
		super.setJustProtDbKeyHash256Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash256Col ) {
			setJustProtDbKeyHash256Col( (CFBamPubProtBuffDbKeyHash256Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash256Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash256Col( ICFBamPubDbKeyHash256Col src ) {
		super.setJustProtDbKeyHash256Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash256ColH ) {
			setDbKeyHash256Col( (ICFBamPubDbKeyHash256ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash256Col( ICFBamPubDbKeyHash256ColH src ) {
		super.setJustProtDbKeyHash256Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash256Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
