	...
	implements ICFBamNmTokensType
{
	...
	public int getClassCode() {
		return( ICFBamProtNmTokensType.CLASS_CODE );
	}
	...
	@Override
	public void setNmTokensType( ICFBamProtNmTokensType src ) {
		super.setNmTokensDef( src );
	...
	public void set( ICFBamProtValueH src ) {
		if( src instanceof ICFBamProtNmTokensTypeH ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
					...
					"src",
					src,
					"ICFBamProtNmTokensTypeH" );
		}
	}

	@Override
	public void setNmTokensType( ICFBamProtNmTokensTypeH src ) {
		super.setNmTokensDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setNmTokensType( ICFBamPubNmTokensType src ) {
		super.setNmTokensDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setNmTokensType( ICFBamPubNmTokensTypeH src ) {
		super.setNmTokensDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
