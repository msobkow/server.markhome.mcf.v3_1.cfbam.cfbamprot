// Description: Java 17 implJustPubementation of a DoubleType buffer
...
public class CFBamPubBuffDoubleType
	extends CFBamPubBuffDoubleDef
	implements ICFBamDoubleType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffDoubleType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDoubleType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDoubleType ) {
			setJustPubDoubleType( (CFBamPubBuffDoubleType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDoubleType ) {
			setJustPubDoubleType( (CFBamPubPubBuffDoubleType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffDoubleType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
