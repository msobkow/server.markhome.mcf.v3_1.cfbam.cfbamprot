// Description: Java 25 protected interface for a DateType record implementation
...
/**
 *	ICFBamProtDateType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDateType extends ICFBamProtDateDef
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubDateType.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubDateType.SCHEMADEFID_INIT_VALUE;
