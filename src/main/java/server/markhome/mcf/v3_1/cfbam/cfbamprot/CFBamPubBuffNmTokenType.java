// Description: Java 17 implJustPubementation of a NmTokenType buffer
...
public class CFBamPubBuffNmTokenType
	extends CFBamPubBuffNmTokenDef
	implements ICFBamNmTokenType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffNmTokenType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubNmTokenType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokenType ) {
			setJustPubNmTokenType( (CFBamPubBuffNmTokenType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNmTokenType ) {
			setJustPubNmTokenType( (CFBamPubPubBuffNmTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNmTokenType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
