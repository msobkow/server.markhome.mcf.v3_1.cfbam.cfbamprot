// Description: Java 17 implJustPubementation of a TimestampCol buffer
	...
	implements ICFBamTimestampCol
{
	...
	public int getClassCode() {
		return( ICFBamPubTimestampCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimestampCol ) {
			setJustPubTimestampCol( (CFBamPubBuffTimestampCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTimestampCol ) {
			setJustPubTimestampCol( (CFBamPubPubBuffTimestampCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTimestampCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
