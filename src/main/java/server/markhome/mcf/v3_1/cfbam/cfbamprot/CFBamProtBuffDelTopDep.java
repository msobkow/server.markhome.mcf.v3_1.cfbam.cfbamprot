	...
	implements ICFBamDelTopDep
{
	...
	@Override
	public ICFBamProtDelTopDep getOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamProtSchema.getBackingCFBam().getTableDelTopDep()");
		}
	...
	@Override
	public ICFBamProtDelTopDep getOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		ICFBamProtDelTopDepTable targetTable = targetBackingCFBam.getTableDelTopDep();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNext", 0, "ICFBamProtSchema.getBackingCFBam().getTableDelTopDep()");
		}
	...
	@Override
	public List<ICFBamProtDelSubDep1> getOptionalComponentsDelDep(ICFLibKeyHash256 argId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsDelDep", 0, "ICFBamProtSchema.getBackingCFBam().getTableDelSubDep1()");
		}
