// Description: Java 17 implJustPubementation of a DbKeyHash128Def buffer
	...
	implements ICFBamDbKeyHash128Def
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash128Def.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash128Def ) {
			setJustPubDbKeyHash128Def( (CFBamPubBuffDbKeyHash128Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash128Def ) {
			setJustPubDbKeyHash128Def( (CFBamPubPubBuffDbKeyHash128Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash128Def" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash128Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
