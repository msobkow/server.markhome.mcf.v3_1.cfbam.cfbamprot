// Description: Java 17 implJustPubementation of a NmTokenCol buffer
	...
	implements ICFBamNmTokenCol
{
	...
	public int getClassCode() {
		return( ICFBamPubNmTokenCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokenCol ) {
			setJustPubNmTokenCol( (CFBamPubBuffNmTokenCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNmTokenCol ) {
			setJustPubNmTokenCol( (CFBamPubPubBuffNmTokenCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNmTokenCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
