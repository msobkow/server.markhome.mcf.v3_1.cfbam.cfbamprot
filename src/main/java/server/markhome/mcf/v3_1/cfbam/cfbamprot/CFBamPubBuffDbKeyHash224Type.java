// Description: Java 17 implJustPubementation of a DbKeyHash224Type buffer
	...
	implements ICFBamDbKeyHash224Type
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash224Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash224Type ) {
			setJustPubDbKeyHash224Type( (CFBamPubBuffDbKeyHash224Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash224Type ) {
			setJustPubDbKeyHash224Type( (CFBamPubPubBuffDbKeyHash224Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash224Type" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash224Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
