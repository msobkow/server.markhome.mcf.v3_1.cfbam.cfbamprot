// Description: Java 17 implJustPubementation of a UuidType buffer
...
public class CFBamPubBuffUuidType
	extends CFBamPubBuffUuidDef
	implements ICFBamUuidType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffUuidType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubUuidType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuidType ) {
			setJustPubUuidType( (CFBamPubBuffUuidType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuidType ) {
			setJustPubUuidType( (CFBamPubPubBuffUuidType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuidType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
