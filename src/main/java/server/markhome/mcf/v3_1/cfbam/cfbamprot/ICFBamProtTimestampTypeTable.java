...
// Description: Java 25 protected DbIO interface for TimestampType.
...
/*
 *	CFBamProtTimestampTypeTable protected database interface for TimestampType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
