// Description: Java 17 implJustPubementation of a TimestampDef buffer
	...
	implements ICFBamTimestampDef
{
	...
	public int getClassCode() {
		return( ICFBamPubTimestampDef.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimestampDef ) {
			setJustPubTimestampDef( (CFBamPubBuffTimestampDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTimestampDef ) {
			setJustPubTimestampDef( (CFBamPubPubBuffTimestampDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTimestampDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
