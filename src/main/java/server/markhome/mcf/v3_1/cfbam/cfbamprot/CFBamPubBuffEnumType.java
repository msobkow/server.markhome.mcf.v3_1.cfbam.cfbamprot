// Description: Java 17 implJustPubementation of a EnumType buffer
...
public class CFBamPubBuffEnumType
	extends CFBamPubBuffEnumDef
	implements ICFBamEnumType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffEnumType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubEnumType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffEnumType ) {
			setJustPubEnumType( (CFBamPubBuffEnumType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffEnumType ) {
			setJustPubEnumType( (CFBamPubPubBuffEnumType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffEnumType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
