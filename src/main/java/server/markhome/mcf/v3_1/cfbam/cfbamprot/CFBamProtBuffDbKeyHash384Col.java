	...
	implements ICFBamDbKeyHash384Col
{
	...
	public int getClassCode() {
		return( ICFBamDbKeyHash384Col.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash384Col rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash384ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash384ColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash384Col rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash384ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash384ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash384ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash384Col ) {
			setJustProtDbKeyHash384Col( (CFBamProtBuffDbKeyHash384Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash384Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash384Col( ICFBamDbKeyHash384Col src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash384ColH ) {
			setDbKeyHash384Col( (ICFBamProtDbKeyHash384ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
					"src",
					src,
					"ICFBamDbKeyHash384ColH" );
		}
	}

	@Override
	public void setJustProtDbKeyHash384Col( ICFBamDbKeyHash384ColH src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash384Col( ICFBamProtDbKeyHash384Col src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash384Col( ICFBamProtDbKeyHash384ColH src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash384Col ) {
			setJustProtDbKeyHash384Col( (CFBamPubProtBuffDbKeyHash384Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash384Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash384Col( ICFBamPubDbKeyHash384Col src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash384ColH ) {
			setDbKeyHash384Col( (ICFBamPubDbKeyHash384ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash384Col( ICFBamPubDbKeyHash384ColH src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash384Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
