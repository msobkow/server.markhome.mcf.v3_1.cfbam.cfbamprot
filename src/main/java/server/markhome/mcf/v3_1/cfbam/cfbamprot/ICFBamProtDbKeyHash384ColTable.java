...
// Description: Java 25 protected DbIO interface for DbKeyHash384Col.
...
/*
 *	CFBamProtDbKeyHash384ColTable protected database interface for DbKeyHash384Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash384ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDbKeyHash384Col protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
