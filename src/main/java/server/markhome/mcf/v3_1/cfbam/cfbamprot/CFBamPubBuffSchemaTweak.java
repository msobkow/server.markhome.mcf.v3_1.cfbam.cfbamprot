// Description: Java 17 implJustPubementation of a SchemaTweak buffer
	...
	implements ICFBamSchemaTweak
{
	...
	public int getClassCode() {
		return( ICFBamPubSchemaTweak.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubTweak src ) {
		if( src instanceof CFBamPubBuffSchemaTweak ) {
			setJustPubSchemaTweak( (CFBamPubBuffSchemaTweak)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubTweak src ) {
		if( src instanceof CFBamPubPubBuffSchemaTweak ) {
			setJustPubSchemaTweak( (CFBamPubPubBuffSchemaTweak)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffSchemaTweak" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
