// Description: Java 17 implJustPubementation of a BlobCol buffer
	...
	implements ICFBamBlobCol
{
	...
	public int getClassCode() {
		return( ICFBamPubBlobCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBlobCol ) {
			setJustPubBlobCol( (CFBamPubBuffBlobCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffBlobCol ) {
			setJustPubBlobCol( (CFBamPubPubBuffBlobCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffBlobCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
