...
// Description: Java 25 protected DbIO interface for UInt32Def.
...
/*
 *	CFBamProtUInt32DefTable protected database interface for UInt32Def has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtUInt32DefTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamUInt32Def protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
