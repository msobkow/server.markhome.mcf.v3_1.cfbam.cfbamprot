// Description: Java 17 implJustProtementation of a ClearSubDep2 buffer
	...
	implements ICFBamClearSubDep2
{
	...
	public int getClassCode() {
		return( ICFBamProtClearSubDep2.CLASS_CODE );
	}

	@Override
	public ICFBamProtClearSubDep1 getRequiredContainerClearSubDep1(ICFLibKeyHash256 argClearSubDep1Id) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerClearSubDep1", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtClearSubDep1Table targetTable = targetBackingCFBam.getTableClearSubDep1();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerClearSubDep1", 0, "ICFBamProtSchema.getBackingCFBam().getTableClearSubDep1()");
		}
	...
	public void setRequiredContainerClearSubDep1(ICFLibKeyHash256 argClearSubDep1Id) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerClearSubDep1-args", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtClearSubDep1Table targetTable = targetBackingCFBam.getTableClearSubDep1();
		if (targetTable == null) {
		...
		else if (found instanceof ICFBamProtClearSubDep1) || (found instanceof ICFBamProtClearSubDep1) || (found instanceof ICFBamPubClearSubDep1)) {
			super.setRequiredContainerClearSubDep1(argClearSubDep1Id);
		requiredClearSubDep1Id = argClearSubDep1Id;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerClearSubDep1-args", "found", found, "ICFBamProtClearSubDep1ICFBamProtClearSubDep1ICFBamPubClearSubDep1");
		}
	}
	...
	@Override
	public List<ICFBamProtClearSubDep3> getOptionalComponentsClearDep(ICFLibKeyHash256 argId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsClearDep", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtClearSubDep3Table targetTable = targetBackingCFBam.getTableClearSubDep3();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsClearDep", 0, "ICFBamProtSchema.getBackingCFBam().getTableClearSubDep3()");
		}
		ICFBamProtClearSubDep3[] targetArr = targetTable.readDerivedByClearSubDep2Idx(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredId());
		if( targetArr != null ) {
			List<ICFBamProtClearSubDep3> results = new ArrayList<>(targetArr.length);
			...
			List<ICFBamProtClearSubDep3> results = new ArrayList<>();
			return(results);
		}
	}
