// Description: Java 17 implJustPubementation of a DbKeyHash256Type buffer
...
public class CFBamPubBuffDbKeyHash256Type
	extends CFBamPubBuffDbKeyHash256Def
	implements ICFBamDbKeyHash256Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffDbKeyHash256Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash256Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash256Type ) {
			setJustPubDbKeyHash256Type( (CFBamPubBuffDbKeyHash256Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash256Type ) {
			setJustPubDbKeyHash256Type( (CFBamPubPubBuffDbKeyHash256Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash256Type" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash256Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
