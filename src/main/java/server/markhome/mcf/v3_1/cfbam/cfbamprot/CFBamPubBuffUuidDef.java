// Description: Java 17 implJustPubementation of a UuidDef buffer
	...
	implements ICFBamUuidDef
{
	...
	public int getClassCode() {
		return( ICFBamPubUuidDef.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuidDef ) {
			setJustPubUuidDef( (CFBamPubBuffUuidDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuidDef ) {
			setJustPubUuidDef( (CFBamPubPubBuffUuidDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuidDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
