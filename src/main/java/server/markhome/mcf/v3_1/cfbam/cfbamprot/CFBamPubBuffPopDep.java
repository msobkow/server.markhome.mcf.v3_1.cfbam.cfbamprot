// Description: Java 17 implJustPubementation of a PopDep buffer
...
public class CFBamPubBuffPopDep
	...
	implements ICFBamPopDep
{
	...
	public int getClassCode() {
		return( ICFBamPubPopDep.CLASS_CODE );
	}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffPopDep ) {
			setJustPubPopDep( (CFBamPubBuffPopDep)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffPopDep ) {
			setJustPubPopDep( (CFBamPubPubBuffPopDep)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffPopDep" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
