// Description: Java 25 implJustProtementation of a Id32Gen buffer
...
public class CFBamProtBuffId32Gen
	extends CFBamProtBuffInt32Type
	implements ICFBamId32Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamProtBuffId32Gen() {
		super();
	...
	public String toString() {
		String ret = "<CFBamProtBuffId32Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
