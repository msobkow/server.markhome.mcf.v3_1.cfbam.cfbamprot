// Description: Java 25 Object interface for CFBamProt SchemaDef.
...
{
	/**
	 *	Get the current edition of this SchemaDef instance as a ICFBamProtSchemaDefEditObj.
	 *
	 *	@return	The ICFBamProtSchemaDefEditObj edition of this instance.
	 */
	ICFBamProtSchemaDefEditObj getEditAsSchemaDef();

	/**
	 *	Get the ICFBamProtSchemaDefTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtSchemaDefTableObj table cache which manages this instance.
	 */
	ICFBamProtSchemaDefTableObj getSchemaDefTable();

	/**
	 *	Get the ICFBamProtSchemaDef instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtSchemaDef instance which currently backs this object.
	 */
