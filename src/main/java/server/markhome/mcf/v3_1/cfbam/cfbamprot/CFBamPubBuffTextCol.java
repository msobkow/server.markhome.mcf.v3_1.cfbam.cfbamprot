// Description: Java 17 implJustPubementation of a TextCol buffer
...
public class CFBamPubBuffTextCol
	extends CFBamPubBuffTextDef
	implements ICFBamTextCol
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamPubBuffTextCol() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubTextCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTextCol ) {
			setJustPubTextCol( (CFBamPubBuffTextCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTextCol ) {
			setJustPubTextCol( (CFBamPubPubBuffTextCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTextCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
