	...
	implements ICFBamDbKeyHash160Type
{
	...
	public int getClassCode() {
		return( ICFBamProtDbKeyHash160Type.CLASS_CODE );
	}
	...
	@Override
	public void setDbKeyHash160Type( ICFBamProtDbKeyHash160Type src ) {
	...
	public void set( ICFBamProtValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash160TypeH ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
					...
					"src",
					src,
					"ICFBamProtDbKeyHash160TypeH" );
		}
	}

	@Override
	public void setDbKeyHash160Type( ICFBamProtDbKeyHash160TypeH src ) {
		super.setDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setDbKeyHash160Type( ICFBamPubDbKeyHash160Type src ) {
		super.setDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setDbKeyHash160Type( ICFBamPubDbKeyHash160TypeH src ) {
		super.setDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
