// Description: Java 25 implJustProtementation of a DbKeyHash160Type buffer
...
public class CFBamProtBuffDbKeyHash160Type
	extends CFBamProtBuffDbKeyHash160Def
	implements ICFBamDbKeyHash160Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamProtBuffDbKeyHash160Type() {
		super();
		requiredSchemaDefId = CFLibDbKeyHash256.fromHex( ICFBamPubDbKeyHash160Type.SCHEMADEFID_INIT_VALUE.toString() );
	}

	@Override
	public int getClassCode() {
		return( ICFBamDbKeyHash160Type.CLASS_CODE );
	}

	@Override
	public void setJustProtRequiredContainerScope(ICFLibKeyHash256 argSchemaDefId) {
		...
		if (found == null) {
			...
			super.setJustProtRequiredContainerScope(argSchemaDefId);
		requiredSchemaDefId = argSchemaDefId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setJustProtRequiredContainerScope-args", "found", found, "ICFBamSchemaDefICFBamProtSchemaDefICFBamPubSchemaDef");
		}
	}

	@Override
	public void setJustProtRequiredContainerScope(ICFBamSchemaDef argObj) {
	...
	@Override
	public void setJustProtRequiredContainerScope(ICFBamProtSchemaDef argObj) {
	...
	@Override
	public void setJustProtRequiredContainerScope(ICFBamPubSchemaDef argObj) {
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash160Type rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash160TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash160TypeBySchemaIdxKey rhs ) {
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash160Type rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash160TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash160TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash160TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash160Type ) {
			setJustProtDbKeyHash160Type( (CFBamProtBuffDbKeyHash160Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash160Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash160Type( ICFBamDbKeyHash160Type src ) {
		super.setJustProtDbKeyHash160Def( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash160TypeH ) {
			setDbKeyHash160Type( (ICFBamProtDbKeyHash160TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
					"src",
					src,
					"ICFBamDbKeyHash160TypeH" );
		}
	}

	@Override
	public void setJustProtDbKeyHash160Type( ICFBamDbKeyHash160TypeH src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash160Type( ICFBamProtDbKeyHash160Type src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash160Type( ICFBamProtDbKeyHash160TypeH src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash160Type ) {
			setJustProtDbKeyHash160Type( (CFBamPubProtBuffDbKeyHash160Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash160Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash160Type( ICFBamPubDbKeyHash160Type src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash160TypeH ) {
			setDbKeyHash160Type( (ICFBamPubDbKeyHash160TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash160Type( ICFBamPubDbKeyHash160TypeH src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash160Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
