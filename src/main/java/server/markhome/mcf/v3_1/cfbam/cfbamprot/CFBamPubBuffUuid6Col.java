// Description: Java 17 implJustPubementation of a Uuid6Col buffer
	...
	implements ICFBamUuid6Col
{
	...
	public int getClassCode() {
		return( ICFBamPubUuid6Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Col ) {
			setJustPubUuid6Col( (CFBamPubBuffUuid6Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuid6Col ) {
			setJustPubUuid6Col( (CFBamPubPubBuffUuid6Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuid6Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
