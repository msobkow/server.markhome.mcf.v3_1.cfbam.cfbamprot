// Description: Java 17 implJustPubementation of a EnumTag buffer
...
public class CFBamPubBuffEnumTag
	implements ICFBamPubEnumTag, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFBamPubEnumTag.CLASS_CODE );
	}

	@Override
	public ICFBamPubEnumDef getRequiredContainerEnumDef(ICFLibKeyHash256 argEnumId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerEnumDef", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubEnumDefTable targetTable = targetBackingCFBam.getTableEnumDef();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerEnumDef", 0, "ICFBamPubSchema.getBackingCFBam().getTableEnumDef()");
		}
	...
	public void setRequiredContainerEnumDef(ICFLibKeyHash256 argEnumId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerEnumDef-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubEnumDefTable targetTable = targetBackingCFBam.getTableEnumDef();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerEnumDef", 0, "ICFBamSchema.getBackingCFBam().getTableEnumDef()");
		}
		ICFBamPubEnumDef found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argEnumId);
		if (found == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerEnumDef-args", 0, "found");
		}
		else if (found instanceof ICFBamPubEnumDef) || (found instanceof ICFBamPubEnumDef)) {
			super.setRequiredContainerEnumDef(argEnumId);
		requiredEnumId = argEnumId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerEnumDef-args", "found", found, "ICFBamPubEnumDefICFBamPubEnumDef");
		}
	}
	...
	@Override
	public ICFBamPubEnumTag getOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubEnumTagTable targetTable = targetBackingCFBam.getTableEnumTag();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamPubSchema.getBackingCFBam().getTableEnumTag()");
		}
	...
	public void setOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		...
		ICFBamPubEnumTag found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPrevId);
		if (found == null || (found != null && ((found instanceof ICFBamPubEnumTag) || (found instanceof ICFBamPubEnumTag)))) {
			super.setOptionalLookupPrev(argPrevId);
		optionalPrevId = argPrevId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupPrev-args", "found", found, "ICFBamPubEnumTagICFBamPubEnumTag");
		}
	}
	...
	@Override
	public ICFBamPubEnumTag getOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		ICFBamPubEnumTagTable targetTable = targetBackingCFBam.getTableEnumTag();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNext", 0, "ICFBamPubSchema.getBackingCFBam().getTableEnumTag()");
		}
	...
	public void setOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		...
		ICFBamPubEnumTag found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNextId);
		if (found == null || (found != null && ((found instanceof ICFBamPubEnumTag) || (found instanceof ICFBamPubEnumTag)))) {
			super.setOptionalLookupNext(argNextId);
		optionalNextId = argNextId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupNext-args", "found", found, "ICFBamPubEnumTagICFBamPubEnumTag");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubEnumTagHPKey ) {
			ICFBamPubEnumTagHPKey rhs = (ICFBamPubEnumTagHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setEnumTag( ICFBamPubEnumTag src ) {
		...
		setJustPubRequiredContainerEnumDef(src.getRequiredContainerEnumDef());
		...
		setJustPubRequiredEnumId(src.getRequiredEnumId());
		setJustPubOptionalEnumCode(src.getOptionalEnumCode());
	...
	public String toString() {
		String ret = "<CFBamPubBuffEnumTag" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
