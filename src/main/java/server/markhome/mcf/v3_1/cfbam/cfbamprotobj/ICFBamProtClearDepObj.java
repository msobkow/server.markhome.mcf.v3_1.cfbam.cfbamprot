// Description: Java 25 Object interface for CFBamProt ClearDep.
...
public interface ICFBamProtClearDepObj
	extends ICFBamProtScopeObj
{
	/**
	 *	Get the current edition of this ClearDep instance as a ICFBamProtClearDepEditObj.
	 *
	 *	@return	The ICFBamProtClearDepEditObj edition of this instance.
	 */
	ICFBamProtClearDepEditObj getEditAsClearDep();

	/**
	 *	Get the ICFBamProtClearDepTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtClearDepTableObj table cache which manages this instance.
	 */
	ICFBamProtClearDepTableObj getClearDepTable();

	/**
	 *	Get the ICFBamProtClearDep instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtClearDep instance which currently backs this object.
	 */
	ICFBamProtClearDep getClearDepRec();
