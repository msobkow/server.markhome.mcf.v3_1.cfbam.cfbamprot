// Description: Java 25 Object interface for CFBamProt Param.
...
public interface ICFBamProtParamObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamProtParam.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamProtParamObj instance which should be subsequently referenced.
	 */
	ICFBamProtParamObj realise();
	 ...
	 *
	 *	@return	ICFBamProtParamObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtParamObj read();
	 ...
	 *	@return	ICFBamProtParamObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtParamObj read( boolean forceRead );

	/**
	 *	Move this object up in the chain and refresh the cache.
	 *
	 *	@return	ICFBamProtParamObj the reference to the moved and refreshed instance.
	 */
	ICFBamProtParamObj moveUp();
	 ...
	 *	@return	ICFBamProtParamObj the reference to the moved and refreshed instance.
	 */
	ICFBamProtParamObj moveDown();

	/**
	 *	Initialize and return a locked edition of this Param instance.
	 *
	 *	@return	The newly locked ICFBamProtParamEditObj edition of this instance.
	 */
	ICFBamProtParamEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamProtParamEditObj edition of this instance.
	 */
	ICFBamProtParamEditObj getEdit();

	/**
	 *	Get the current edition of this Param instance as a ICFBamProtParamEditObj.
	 *
	 *	@return	The ICFBamProtParamEditObj edition of this instance.
	 */
	ICFBamProtParamEditObj getEditAsParam();

	/**
	 *	Get the ICFBamProtParamTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtParamTableObj table cache which manages this instance.
	 */
	ICFBamProtParamTableObj getParamTable();
	...
	/**
	 *	Get the ICFBamProtParam instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtParam instance which currently backs this object.
	 */
	ICFBamProtParam getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamProtParam value );
