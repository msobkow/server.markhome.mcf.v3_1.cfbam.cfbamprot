// Description: Java 17 implJustPubementation of a TZTimestampCol buffer
	...
	implements ICFBamTZTimestampCol
{
	...
	public int getClassCode() {
		return( ICFBamPubTZTimestampCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimestampCol ) {
			setJustPubTZTimestampCol( (CFBamPubBuffTZTimestampCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZTimestampCol ) {
			setJustPubTZTimestampCol( (CFBamPubPubBuffTZTimestampCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZTimestampCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
