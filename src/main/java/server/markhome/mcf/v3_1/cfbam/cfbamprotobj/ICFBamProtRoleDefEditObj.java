// Description: Java 25 Protected Instance Edit Object interface for CFBam RoleDef.
...
public interface ICFBamProtRoleDefEditObj
	extends ICFBamProtRoleDefObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFBamProtRoleDefObj.
	 */
	ICFBamProtRoleDefObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamProtRoleDefObj.
	 */
	ICFBamProtRoleDefObj getOrigAsRoleDef();
	 ...
	 */
	ICFBamProtRoleDefObj create();

	/*
	 *	Update the instance.
	 */
	ICFBamProtRoleDefEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFBamProtRoleDefEditObj deleteInstance();
