// Description: Java 17 implJustPubementation of a NmTokensType buffer
...
public class CFBamPubBuffNmTokensType
	extends CFBamPubBuffNmTokensDef
	implements ICFBamNmTokensType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffNmTokensType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubNmTokensType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokensType ) {
			setJustPubNmTokensType( (CFBamPubBuffNmTokensType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffNmTokensType ) {
			setJustPubNmTokensType( (CFBamPubPubBuffNmTokensType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffNmTokensType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
