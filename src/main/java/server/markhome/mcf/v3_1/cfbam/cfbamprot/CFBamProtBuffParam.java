// Description: Java 25 implJustProtementation of a Param buffer
...
public class CFBamProtBuffParam
	implements ICFBamProtParam, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFBamProtParam.CLASS_CODE );
	}

	@Override
	public ICFBamProtServerMethod getRequiredContainerServerMeth(ICFLibKeyHash256 argServerMethodId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerServerMeth", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtServerMethodTable targetTable = targetBackingCFBam.getTableServerMethod();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerServerMeth", 0, "ICFBamProtSchema.getBackingCFBam().getTableServerMethod()");
		}
	...
	public void setRequiredContainerServerMeth(ICFLibKeyHash256 argServerMethodId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerServerMeth-args", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtServerMethodTable targetTable = targetBackingCFBam.getTableServerMethod();
		if (targetTable == null) {
		...
		ICFBamProtServerMethod found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argServerMethodId);
		if (found == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerServerMeth-args", 0, "found");
		}
		else if (found instanceof ICFBamProtServerMethod) || (found instanceof ICFBamProtServerMethod) || (found instanceof ICFBamPubServerMethod)) {
			super.setRequiredContainerServerMeth(argServerMethodId);
		requiredServerMethodId = argServerMethodId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerServerMeth-args", "found", found, "ICFBamProtServerMethodICFBamProtServerMethodICFBamPubServerMethod");
		}
	}
	...
	public void setRequiredContainerServerMeth(ICFBamProtServerMethod argObj) {
		...
		if(argObj == null) {
			...
			setJustProtRequiredServerMethodId(argObj.getRequiredId());
		}
	}
	...
	@Override
	public ICFBamProtParam getOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtParamTable targetTable = targetBackingCFBam.getTableParam();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamProtSchema.getBackingCFBam().getTableParam()");
		}
	...
	public void setOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		...
		ICFBamProtParam found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPrevId);
		if (found == null || (found != null && ((found instanceof ICFBamProtParam) || (found instanceof ICFBamProtParam) || (found instanceof ICFBamPubParam)))) {
			super.setOptionalLookupPrev(argPrevId);
		optionalPrevId = argPrevId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupPrev-args", "found", found, "ICFBamProtParamICFBamProtParamICFBamPubParam");
		}
	}
	...
	@Override
	public ICFBamProtParam getOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		ICFBamProtParamTable targetTable = targetBackingCFBam.getTableParam();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNext", 0, "ICFBamProtSchema.getBackingCFBam().getTableParam()");
		}
	...
	public void setOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		...
		ICFBamProtParam found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNextId);
		if (found == null || (found != null && ((found instanceof ICFBamProtParam) || (found instanceof ICFBamProtParam) || (found instanceof ICFBamPubParam)))) {
			super.setOptionalLookupNext(argNextId);
		optionalNextId = argNextId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupNext-args", "found", found, "ICFBamProtParamICFBamProtParamICFBamPubParam");
		}
	}
	...
	@Override
	public ICFBamProtValue getRequiredLookupType(ICFLibKeyHash256 argTypeId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupType", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtValueTable targetTable = targetBackingCFBam.getTableValue();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupType", 0, "ICFBamProtSchema.getBackingCFBam().getTableValue()");
		}
	...
	public void setRequiredLookupType(ICFLibKeyHash256 argTypeId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupType-args", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtValueTable targetTable = targetBackingCFBam.getTableValue();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupType", 0, "ICFBamSchema.getBackingCFBam().getTableValue()");
		}
		ICFBamProtValue found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argTypeId);
		if (found == null) {
		...
		optionalTypeId = argTypeId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredLookupType-args", "found", found, "ICFBamProtValueICFBamProtValueICFBamPubValue");
		}
	}
	...
	public void setRequiredLookupType(ICFBamProtValue argObj) {
		...
		if(argObj == null) {
			...
			setJustProtOptionalTypeId(argObj.getRequiredId());
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtParamHPKey ) {
			ICFBamProtParamHPKey rhs = (ICFBamProtParamHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setParam( ICFBamProtParam src ) {
		...
		setJustProtRequiredContainerServerMeth(src.getRequiredContainerServerMeth());
		...
		setJustProtRequiredLookupType(src.getRequiredLookupType());
		setJustProtRequiredServerMethodId(src.getRequiredServerMethodId());
		...
		setJustProtOptionalTypeId(src.getOptionalTypeId());
	...
	public String toString() {
		String ret = "<CFBamProtBuffParam" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
