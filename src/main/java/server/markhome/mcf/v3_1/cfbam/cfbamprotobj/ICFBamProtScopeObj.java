// Description: Java 25 Object interface for CFBamProt Scope.
...
public interface ICFBamProtScopeObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamProtScope.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamProtScopeObj instance which should be subsequently referenced.
	 */
	ICFBamProtScopeObj realise();
	 ...
	 *
	 *	@return	ICFBamProtScopeObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtScopeObj read();
	 ...
	 *	@return	ICFBamProtScopeObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtScopeObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Scope instance.
	 *
	 *	@return	The newly locked ICFBamProtScopeEditObj edition of this instance.
	 */
	ICFBamProtScopeEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamProtScopeEditObj edition of this instance.
	 */
	ICFBamProtScopeEditObj getEdit();

	/**
	 *	Get the current edition of this Scope instance as a ICFBamProtScopeEditObj.
	 *
	 *	@return	The ICFBamProtScopeEditObj edition of this instance.
	 */
	ICFBamProtScopeEditObj getEditAsScope();

	/**
	 *	Get the ICFBamProtScopeTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtScopeTableObj table cache which manages this instance.
	 */
	ICFBamProtScopeTableObj getScopeTable();
	...
	/**
	 *	Get the ICFBamProtScope instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtScope instance which currently backs this object.
	 */
	ICFBamProtScope getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamProtScope value );
