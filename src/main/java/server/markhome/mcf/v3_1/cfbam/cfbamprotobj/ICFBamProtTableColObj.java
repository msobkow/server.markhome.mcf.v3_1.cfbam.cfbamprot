// Description: Java 25 Object interface for CFBamProt TableCol.
...
public interface ICFBamProtTableColObj
	extends ICFBamProtValueObj
{
	/**
	 *	Get the current edition of this TableCol instance as a ICFBamProtTableColEditObj.
	 *
	 *	@return	The ICFBamProtTableColEditObj edition of this instance.
	 */
	ICFBamProtTableColEditObj getEditAsTableCol();

	/**
	 *	Get the ICFBamProtTableColTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtTableColTableObj table cache which manages this instance.
	 */
	ICFBamProtTableColTableObj getTableColTable();

	/**
	 *	Get the ICFBamProtTableCol instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtTableCol instance which currently backs this object.
	 */
