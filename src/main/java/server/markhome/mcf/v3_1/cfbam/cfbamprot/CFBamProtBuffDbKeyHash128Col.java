// Description: Java 25 implJustProtementation of a DbKeyHash128Col buffer
...
public class CFBamProtBuffDbKeyHash128Col
	extends CFBamProtBuffDbKeyHash128Def
	implements ICFBamDbKeyHash128Col
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamProtBuffDbKeyHash128Col() {
		super();
		requiredTableId = CFLibDbKeyHash256.fromHex( ICFBamPubDbKeyHash128Col.TABLEID_INIT_VALUE.toString() );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash128Col rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash128ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash128ColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash128Col rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash128ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash128ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash128ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash128Col ) {
			setJustProtDbKeyHash128Col( (CFBamProtBuffDbKeyHash128Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash128Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash128Col( ICFBamDbKeyHash128Col src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash128ColH ) {
			setDbKeyHash128Col( (ICFBamProtDbKeyHash128ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash128Col( ICFBamDbKeyHash128ColH src ) {
		super.setJustProtDbKeyHash128Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash128Col( ICFBamProtDbKeyHash128Col src ) {
		super.setJustProtDbKeyHash128Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash128Col( ICFBamProtDbKeyHash128ColH src ) {
		super.setJustProtDbKeyHash128Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash128Col ) {
			setJustProtDbKeyHash128Col( (CFBamPubProtBuffDbKeyHash128Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash128Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash128Col( ICFBamPubDbKeyHash128Col src ) {
		super.setJustProtDbKeyHash128Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash128ColH ) {
			setDbKeyHash128Col( (ICFBamPubDbKeyHash128ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash128Col( ICFBamPubDbKeyHash128ColH src ) {
		super.setJustProtDbKeyHash128Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash128Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
