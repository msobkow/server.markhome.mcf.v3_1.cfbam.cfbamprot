// Description: Java 25 implJustProtementation of a NmTokensCol buffer
...
public class CFBamProtBuffNmTokensCol
	extends CFBamProtBuffNmTokensDef
	implements ICFBamNmTokensCol
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamProtBuffNmTokensCol() {
		super();
		requiredTableId = CFLibDbKeyHash256.fromHex( ICFBamPubNmTokensCol.TABLEID_INIT_VALUE.toString() );
	}

	@Override
	public int getClassCode() {
		return( ICFBamNmTokensCol.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtNmTokensCol rhs ) {
		...
		else if( obj instanceof ICFBamProtNmTokensColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtNmTokensColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubNmTokensCol rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubNmTokensColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokensColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubNmTokensColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffNmTokensCol ) {
			setJustProtNmTokensCol( (CFBamProtBuffNmTokensCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffNmTokensCol" );
		}
	}

	@Override
	public void setJustProtNmTokensCol( ICFBamNmTokensCol src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtNmTokensColH ) {
			setNmTokensCol( (ICFBamProtNmTokensColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtNmTokensCol( ICFBamNmTokensColH src ) {
		super.setJustProtNmTokensDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtNmTokensCol( ICFBamProtNmTokensCol src ) {
		super.setJustProtNmTokensDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtNmTokensCol( ICFBamProtNmTokensColH src ) {
		super.setJustProtNmTokensDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffNmTokensCol ) {
			setJustProtNmTokensCol( (CFBamPubProtBuffNmTokensCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffNmTokensCol" );
		}
	}

	@Override
	public void setJustProtNmTokensCol( ICFBamPubNmTokensCol src ) {
		super.setJustProtNmTokensDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubNmTokensColH ) {
			setNmTokensCol( (ICFBamPubNmTokensColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtNmTokensCol( ICFBamPubNmTokensColH src ) {
		super.setJustProtNmTokensDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffNmTokensCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
