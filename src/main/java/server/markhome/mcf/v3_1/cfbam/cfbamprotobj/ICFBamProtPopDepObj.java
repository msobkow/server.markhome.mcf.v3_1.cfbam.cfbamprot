// Description: Java 25 Object interface for CFBamProt PopDep.
...
public interface ICFBamProtPopDepObj
	extends ICFBamProtScopeObj
{
	/**
	 *	Get the current edition of this PopDep instance as a ICFBamProtPopDepEditObj.
	 *
	 *	@return	The ICFBamProtPopDepEditObj edition of this instance.
	 */
	ICFBamProtPopDepEditObj getEditAsPopDep();

	/**
	 *	Get the ICFBamProtPopDepTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtPopDepTableObj table cache which manages this instance.
	 */
	ICFBamProtPopDepTableObj getPopDepTable();

	/**
	 *	Get the ICFBamProtPopDep instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtPopDep instance which currently backs this object.
	 */
	ICFBamProtPopDep getPopDepRec();
