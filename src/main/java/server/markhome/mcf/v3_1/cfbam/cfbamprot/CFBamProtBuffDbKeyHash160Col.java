// Description: Java 25 implJustProtementation of a DbKeyHash160Col buffer
	...
	implements ICFBamDbKeyHash160Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash160Col rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash160ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash160ColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash160Col rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash160ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash160ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash160ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash160Col ) {
			setJustProtDbKeyHash160Col( (CFBamProtBuffDbKeyHash160Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash160Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash160Col( ICFBamDbKeyHash160Col src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash160ColH ) {
			setDbKeyHash160Col( (ICFBamProtDbKeyHash160ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash160Col( ICFBamDbKeyHash160ColH src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash160Col( ICFBamProtDbKeyHash160Col src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtDbKeyHash160Col( ICFBamProtDbKeyHash160ColH src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash160Col ) {
			setJustProtDbKeyHash160Col( (CFBamPubProtBuffDbKeyHash160Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash160Col" );
		}
	}

	@Override
	public void setJustProtDbKeyHash160Col( ICFBamPubDbKeyHash160Col src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash160ColH ) {
			setDbKeyHash160Col( (ICFBamPubDbKeyHash160ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash160Col( ICFBamPubDbKeyHash160ColH src ) {
		super.setJustProtDbKeyHash160Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash160Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
