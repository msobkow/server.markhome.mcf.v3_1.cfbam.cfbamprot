// Description: Java 25 implJustProtementation of a NmTokenType buffer
...
public class CFBamProtBuffNmTokenType
	extends CFBamProtBuffNmTokenDef
	implements ICFBamNmTokenType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamProtBuffNmTokenType() {
		super();
		requiredSchemaDefId = CFLibDbKeyHash256.fromHex( ICFBamPubNmTokenType.SCHEMADEFID_INIT_VALUE.toString() );
	}

	@Override
	public int getClassCode() {
		return( ICFBamNmTokenType.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtNmTokenType rhs ) {
		...
		else if( obj instanceof ICFBamProtNmTokenTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtNmTokenTypeBySchemaIdxKey rhs ) {
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubNmTokenType rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubNmTokenTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokenTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubNmTokenTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffNmTokenType ) {
			setJustProtNmTokenType( (CFBamProtBuffNmTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffNmTokenType" );
		}
	}

	@Override
	public void setJustProtNmTokenType( ICFBamNmTokenType src ) {
		super.setJustProtNmTokenDef( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtNmTokenTypeH ) {
			setNmTokenType( (ICFBamProtNmTokenTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtNmTokenType( ICFBamNmTokenTypeH src ) {
		super.setJustProtNmTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtNmTokenType( ICFBamProtNmTokenType src ) {
		super.setJustProtNmTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtNmTokenType( ICFBamProtNmTokenTypeH src ) {
		super.setJustProtNmTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffNmTokenType ) {
			setJustProtNmTokenType( (CFBamPubProtBuffNmTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffNmTokenType" );
		}
	}

	@Override
	public void setJustProtNmTokenType( ICFBamPubNmTokenType src ) {
		super.setJustProtNmTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubNmTokenTypeH ) {
			setNmTokenType( (ICFBamPubNmTokenTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtNmTokenType( ICFBamPubNmTokenTypeH src ) {
		super.setJustProtNmTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffNmTokenType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
