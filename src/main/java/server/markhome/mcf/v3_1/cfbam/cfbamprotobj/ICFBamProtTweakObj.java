// Description: Java 25 Object interface for CFBamProt Tweak.
...
public interface ICFBamProtTweakObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFBamProtTweak.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFBamProtTweakObj instance which should be subsequently referenced.
	 */
	ICFBamProtTweakObj realise();
	 ...
	 *
	 *	@return	ICFBamProtTweakObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtTweakObj read();
	 ...
	 *	@return	ICFBamProtTweakObj the reference to the cached or read (realised) instance.
	 */
	ICFBamProtTweakObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Tweak instance.
	 *
	 *	@return	The newly locked ICFBamProtTweakEditObj edition of this instance.
	 */
	ICFBamProtTweakEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamProtTweakEditObj edition of this instance.
	 */
	ICFBamProtTweakEditObj getEdit();

	/**
	 *	Get the current edition of this Tweak instance as a ICFBamProtTweakEditObj.
	 *
	 *	@return	The ICFBamProtTweakEditObj edition of this instance.
	 */
	ICFBamProtTweakEditObj getEditAsTweak();

	/**
	 *	Get the ICFBamProtTweakTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtTweakTableObj table cache which manages this instance.
	 */
	ICFBamProtTweakTableObj getTweakTable();
	...
	/**
	 *	Get the ICFBamProtTweak instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtTweak instance which currently backs this object.
	 */
	ICFBamProtTweak getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamProtTweak value );
