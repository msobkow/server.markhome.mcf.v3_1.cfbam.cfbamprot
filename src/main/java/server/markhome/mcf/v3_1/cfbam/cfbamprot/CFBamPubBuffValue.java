// Description: Java 17 implJustPubementation of a Value buffer
...
public class CFBamPubBuffValue
	implements ICFBamPubValue, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFBamPubTableCol> getOptionalChildrenRefTableCol(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalChildrenRefTableCol", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubTableColTable targetTable = targetBackingCFBam.getTableTableCol();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalChildrenRefTableCol", 0, "ICFBamPubSchema.getBackingCFBam().getTableTableCol()");
		}
	...
	@Override
	public List<ICFBamPubIndexCol> getOptionalChildrenRefIndexCol(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalChildrenRefIndexCol", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubIndexColTable targetTable = targetBackingCFBam.getTableIndexCol();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalChildrenRefIndexCol", 0, "ICFBamPubSchema.getBackingCFBam().getTableIndexCol()");
		}
	...
	public int getClassCode() {
		return( ICFBamPubValue.CLASS_CODE );
	}

	@Override
	public ICFBamPubScope getRequiredContainerScope(ICFLibKeyHash256 argScopeId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerScope", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubScopeTable targetTable = targetBackingCFBam.getTableScope();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerScope", 0, "ICFBamPubSchema.getBackingCFBam().getTableScope()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredScopeId()));
	}
	...
	public void setRequiredContainerScope(ICFLibKeyHash256 argScopeId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerScope-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubScopeTable targetTable = targetBackingCFBam.getTableScope();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerScope", 0, "ICFBamSchema.getBackingCFBam().getTableScope()");
		}
		ICFBamPubScope found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argScopeId);
		if (found == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerScope-args", 0, "found");
		}
		else if (found instanceof ICFBamPubScope) || (found instanceof ICFBamPubScope)) {
			super.setRequiredContainerScope(argScopeId);
		requiredScopeId = argScopeId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerScope-args", "found", found, "ICFBamPubScopeICFBamPubScope");
		}
	}
	...
	@Override
	public ICFBamPubValue getOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamPubSchema.getBackingCFBam().getTableValue()");
		}
	...
	public void setOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		...
		ICFBamPubValue found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPrevId);
		if (found == null || (found != null && ((found instanceof ICFBamPubValue) || (found instanceof ICFBamPubValue)))) {
			super.setOptionalLookupPrev(argPrevId);
		optionalPrevId = argPrevId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupPrev-args", "found", found, "ICFBamPubValueICFBamPubValue");
		}
	}
	...
	@Override
	public ICFBamPubValue getOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		ICFBamPubValueTable targetTable = targetBackingCFBam.getTableValue();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNext", 0, "ICFBamPubSchema.getBackingCFBam().getTableValue()");
		}
	...
	public void setOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		...
		ICFBamPubValue found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNextId);
		if (found == null || (found != null && ((found instanceof ICFBamPubValue) || (found instanceof ICFBamPubValue)))) {
			super.setOptionalLookupNext(argNextId);
		optionalNextId = argNextId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupNext-args", "found", found, "ICFBamPubValueICFBamPubValue");
		}
	}
	...
	public void setValue( ICFBamPubValue src ) {
		...
		setJustPubRequiredContainerScope(src.getRequiredContainerScope());
		...
		setJustPubRequiredScopeId(src.getRequiredScopeId());
		...
		setJustPubOptionalDefaultXmlValue(src.getOptionalDefaultXmlValue());
		setJustPubRequiredIsNullable(src.getRequiredIsNullable());
		setJustPubOptionalGenerateId(src.getOptionalGenerateId());
		setJustPubRequiredImplementsPolymorph(src.getRequiredImplementsPolymorph());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			...
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredScopeId().toString() + "\"" + "\"" + getRequiredId().toString() + "\"" + ( ( getOptionalDefSchemaId() == null ) ? "null" : "\"" + getOptionalDefSchemaId().toString() + "\"" ) + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalShortName() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalShortName() ) + "\"" ) + ( ( getOptionalLabel() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalLabel() ) + "\"" ) + ( ( getOptionalShortDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalShortDescription() ) + "\"" ) + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" ) + ( ( getOptionalDefaultXmlValue() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDefaultXmlValue() ) + "\"" ) + (( getRequiredIsNullable() ) ? "\"true\"" : "\"false\"" ) + ( ( getOptionalGenerateId() == null ) ? "null" : ( ( getOptionalGenerateId() ) ? "\"true\"" : "\"false\"" ) ) + (( getRequiredImplementsPolymorph() ) ? "\"true\"" : "\"false\"" ) + ( ( getOptionalPrevId() == null ) ? "null" : "\"" + getOptionalPrevId().toString() + "\"" ) + ( ( getOptionalNextId() == null ) ? "null" : "\"" + getOptionalNextId().toString() + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFBamPubBuffValue" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
