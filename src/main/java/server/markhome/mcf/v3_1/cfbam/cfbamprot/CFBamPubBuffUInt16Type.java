// Description: Java 17 implJustPubementation of a UInt16Type buffer
...
public class CFBamPubBuffUInt16Type
	extends CFBamPubBuffUInt16Def
	implements ICFBamUInt16Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffUInt16Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubUInt16Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt16Type ) {
			setJustPubUInt16Type( (CFBamPubBuffUInt16Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt16Type ) {
			setJustPubUInt16Type( (CFBamPubPubBuffUInt16Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt16Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
