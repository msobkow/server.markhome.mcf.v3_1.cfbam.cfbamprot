	...
	implements ICFBamInt32Type
{
	...
	public int getClassCode() {
		return( ICFBamProtInt32Type.CLASS_CODE );
	}
	...
	@Override
	public void setInt32Type( ICFBamProtInt32Type src ) {
	...
	public void set( ICFBamProtValueH src ) {
		if( src instanceof ICFBamProtInt32TypeH ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
					...
					"src",
					src,
					"ICFBamProtInt32TypeH" );
		}
	}

	@Override
	public void setInt32Type( ICFBamProtInt32TypeH src ) {
		super.setInt32Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setInt32Type( ICFBamPubInt32Type src ) {
		super.setInt32Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setInt32Type( ICFBamPubInt32TypeH src ) {
		super.setInt32Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
