// Description: Java 17 implJustPubementation of a FloatCol buffer
	...
	implements ICFBamFloatCol
{
	...
	public int getClassCode() {
		return( ICFBamPubFloatCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffFloatCol ) {
			setJustPubFloatCol( (CFBamPubBuffFloatCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffFloatCol ) {
			setJustPubFloatCol( (CFBamPubPubBuffFloatCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffFloatCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
