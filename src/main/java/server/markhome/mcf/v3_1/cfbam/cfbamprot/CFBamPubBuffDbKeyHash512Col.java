// Description: Java 17 implJustPubementation of a DbKeyHash512Col buffer
	...
	implements ICFBamDbKeyHash512Col
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash512Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash512Col ) {
			setJustPubDbKeyHash512Col( (CFBamPubBuffDbKeyHash512Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash512Col ) {
			setJustPubDbKeyHash512Col( (CFBamPubPubBuffDbKeyHash512Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash512Col" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash512Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
