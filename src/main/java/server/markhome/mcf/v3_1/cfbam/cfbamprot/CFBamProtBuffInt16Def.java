// Description: Java 25 implJustProtementation of a Int16Def buffer
...
public class CFBamProtBuffInt16Def
	...
	implements ICFBamInt16Def
{
	...
	public void setOptionalInitValue( Short value ) {
		if( value < ICFBamPubInt16Def.INITVALUE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalInitValue",
				1,
				"value",
				value,
				ICFBamPubInt16Def.INITVALUE_MIN_VALUE );
		}
		if( value > ICFBamPubInt16Def.INITVALUE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setOptionalInitValue",
				1,
				"value",
				value,
				ICFBamPubInt16Def.INITVALUE_MAX_VALUE );
		}
	...
	public void setOptionalMinValue( Short value ) {
		if( value < ICFBamPubInt16Def.MINVALUE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalMinValue",
				1,
				"value",
				value,
				ICFBamPubInt16Def.MINVALUE_MIN_VALUE );
		}
		if( value > ICFBamPubInt16Def.MINVALUE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setOptionalMinValue",
				1,
				"value",
				value,
				ICFBamPubInt16Def.MINVALUE_MAX_VALUE );
		}
	...
	public void setOptionalMaxValue( Short value ) {
		if( value < ICFBamPubInt16Def.MAXVALUE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalMaxValue",
				1,
				"value",
				value,
				ICFBamPubInt16Def.MAXVALUE_MIN_VALUE );
		}
		if( value > ICFBamPubInt16Def.MAXVALUE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setOptionalMaxValue",
				1,
				"value",
				value,
				ICFBamPubInt16Def.MAXVALUE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtInt16Def rhs ) {
		...
		else if( obj instanceof ICFBamProtInt16DefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubInt16Def rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubInt16DefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffInt16Def ) {
			setJustProtInt16Def( (CFBamProtBuffInt16Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffInt16Def" );
		}
	}

	@Override
	public void setJustProtInt16Def( ICFBamInt16Def src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtInt16DefH ) {
			setInt16Def( (ICFBamProtInt16DefH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtInt16Def( ICFBamInt16DefH src ) {
		super.setJustProtAtom( src );
		setJustProtOptionalInitValue(src.getOptionalInitValue());
		setJustProtOptionalMinValue(src.getOptionalMinValue());
		setJustProtOptionalMaxValue(src.getOptionalMaxValue());
	...
	@Override
	public void setJustProtInt16Def( ICFBamProtInt16Def src ) {
		super.setJustProtAtom( src );
		setJustProtOptionalInitValue(src.getOptionalInitValue());
		setJustProtOptionalMinValue(src.getOptionalMinValue());
		setJustProtOptionalMaxValue(src.getOptionalMaxValue());
	...
	@Override
	public void setJustProtInt16Def( ICFBamProtInt16DefH src ) {
		super.setJustProtAtom( src );
		setJustProtOptionalInitValue(src.getOptionalInitValue());
		setJustProtOptionalMinValue(src.getOptionalMinValue());
		setJustProtOptionalMaxValue(src.getOptionalMaxValue());
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffInt16Def ) {
			setJustProtInt16Def( (CFBamPubProtBuffInt16Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffInt16Def" );
		}
	}

	@Override
	public void setJustProtInt16Def( ICFBamPubInt16Def src ) {
		super.setJustProtAtom( src );
		setJustProtOptionalInitValue(src.getOptionalInitValue());
		setJustProtOptionalMinValue(src.getOptionalMinValue());
		setJustProtOptionalMaxValue(src.getOptionalMaxValue());
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubInt16DefH ) {
			setInt16Def( (ICFBamPubInt16DefH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtInt16Def( ICFBamPubInt16DefH src ) {
		super.setJustProtAtom( src );
		setJustProtOptionalInitValue(src.getOptionalInitValue());
		setJustProtOptionalMinValue(src.getOptionalMinValue());
		setJustProtOptionalMaxValue(src.getOptionalMaxValue());
	...
	public String toString() {
		String ret = "<CFBamProtBuffInt16Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
