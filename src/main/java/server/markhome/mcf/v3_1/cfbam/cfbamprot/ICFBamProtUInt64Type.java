// Description: Java 25 protected interface for a UInt64Type record implementation
...
/**
 *	ICFBamProtUInt64Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtUInt64Type extends ICFBamProtUInt64Def
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubUInt64Type.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubUInt64Type.SCHEMADEFID_INIT_VALUE;
