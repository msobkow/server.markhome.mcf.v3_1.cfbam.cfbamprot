...
// Description: Java 25 protected DbIO interface for UuidType.
...
/*
 *	CFBamProtUuidTypeTable protected database interface for UuidType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
