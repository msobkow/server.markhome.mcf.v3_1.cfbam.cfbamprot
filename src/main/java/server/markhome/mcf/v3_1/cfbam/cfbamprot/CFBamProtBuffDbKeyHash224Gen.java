// Description: Java 17 implJustProtementation of a DbKeyHash224Gen buffer
...
public class CFBamProtBuffDbKeyHash224Gen
	extends CFBamProtBuffDbKeyHash224Type
	implements ICFBamDbKeyHash224Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamProtBuffDbKeyHash224Gen() {
		super();
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash224Gen ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash224Gen" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash224Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
