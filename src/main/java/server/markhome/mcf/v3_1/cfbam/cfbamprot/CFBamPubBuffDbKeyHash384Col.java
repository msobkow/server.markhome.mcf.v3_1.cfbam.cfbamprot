// Description: Java 17 implJustPubementation of a DbKeyHash384Col buffer
	...
	implements ICFBamDbKeyHash384Col
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash384Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash384Col ) {
			setJustPubDbKeyHash384Col( (CFBamPubBuffDbKeyHash384Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash384Col ) {
			setJustPubDbKeyHash384Col( (CFBamPubPubBuffDbKeyHash384Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash384Col" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash384Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
