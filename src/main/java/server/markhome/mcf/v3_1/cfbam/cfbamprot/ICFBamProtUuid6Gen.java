// Description: Java 25 protected interface for a Uuid6Gen record implementation
...
/**
 *	ICFBamProtUuid6Gen persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtUuid6Gen extends ICFBamProtUuid6Type
{
	...
	public static final short SLICE_INIT_VALUE = ICFBamPubUuid6Gen.SLICE_INIT_VALUE;
	public static final int BLOCKSIZE_INIT_VALUE = ICFBamPubUuid6Gen.BLOCKSIZE_INIT_VALUE;
