// Description: Java 25 Object interface for CFBamProt SchemaRole.
...
{
	/**
	 *	Get the current edition of this SchemaRole instance as a ICFBamProtSchemaRoleEditObj.
	 *
	 *	@return	The ICFBamProtSchemaRoleEditObj edition of this instance.
	 */
	ICFBamProtSchemaRoleEditObj getEditAsSchemaRole();

	/**
	 *	Get the ICFBamProtSchemaRoleTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtSchemaRoleTableObj table cache which manages this instance.
	 */
	ICFBamProtSchemaRoleTableObj getSchemaRoleTable();

	/**
	 *	Get the ICFBamProtSchemaRole instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtSchemaRole instance which currently backs this object.
	 */
	ICFBamProtSchemaRole getSchemaRoleRec();
