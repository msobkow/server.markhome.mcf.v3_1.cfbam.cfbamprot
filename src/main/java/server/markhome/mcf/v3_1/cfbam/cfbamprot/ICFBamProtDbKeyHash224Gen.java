// Description: Java 25 protected interface for a DbKeyHash224Gen record implementation
...
/**
 *	ICFBamProtDbKeyHash224Gen persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash224Gen extends ICFBamProtDbKeyHash224Type
{
	...
	public static final short SLICE_INIT_VALUE = ICFBamPubDbKeyHash224Gen.SLICE_INIT_VALUE;
	public static final int BLOCKSIZE_INIT_VALUE = ICFBamPubDbKeyHash224Gen.BLOCKSIZE_INIT_VALUE;
