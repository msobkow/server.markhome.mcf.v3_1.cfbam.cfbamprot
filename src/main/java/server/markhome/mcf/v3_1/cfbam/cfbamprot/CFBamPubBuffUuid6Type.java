// Description: Java 17 implJustPubementation of a Uuid6Type buffer
...
public class CFBamPubBuffUuid6Type
	extends CFBamPubBuffUuid6Def
	implements ICFBamUuid6Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffUuid6Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubUuid6Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Type ) {
			setJustPubUuid6Type( (CFBamPubBuffUuid6Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuid6Type ) {
			setJustPubUuid6Type( (CFBamPubPubBuffUuid6Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuid6Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
