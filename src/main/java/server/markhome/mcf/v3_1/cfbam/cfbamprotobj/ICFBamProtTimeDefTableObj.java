...
public interface ICFBamProtTimeDefTableObj
{
	 ...
	 *	@param	ScopeId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimeDefObj> readTimeDefByScopeIdx( CFLibDbKeyHash256 ScopeId );

	/**
	 *	Get the map of CFBamProtTimeDefObj instances sorted by their primary keys for the duplicate ScopeIdx key.
	 *
	 *	@param	ScopeId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimeDefObj> readTimeDefByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	/**
	 *	Get the map of CFBamProtTimeDefObj instances sorted by their primary keys for the duplicate DefSchemaIdx key.
	 *
	 *	@param	DefSchemaId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimeDefObj> readTimeDefByPrevIdx( CFLibDbKeyHash256 PrevId );

	/**
	 *	Get the map of CFBamProtTimeDefObj instances sorted by their primary keys for the duplicate PrevIdx key.
	 *
	 *	@param	PrevId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimeDefObj> readTimeDefByNextIdx( CFLibDbKeyHash256 NextId );

	/**
	 *	Get the map of CFBamProtTimeDefObj instances sorted by their primary keys for the duplicate NextIdx key.
	 *
	 *	@param	NextId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 ...
	 *	@param	PrevId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate ContPrevIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtTimeDefObj instances sorted by their primary keys for the duplicate ContPrevIdx key.
	 *
	 *	@param	ScopeId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@param	PrevId	The TimeDef key attribute of the instance generating the id.
	 ...
	 *	@param	NextId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimeDefObj cached instances sorted by their primary keys for the duplicate ContNextIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtTimeDefObj instances sorted by their primary keys for the duplicate ContNextIdx key.
	 *
	 *	@param	ScopeId	The TimeDef key attribute of the instance generating the id.
	 *
	 *	@param	NextId	The TimeDef key attribute of the instance generating the id.
	...
	ICFBamProtTimeDefObj readCachedTimeDefByIdIdx( CFLibDbKeyHash256 Id );

	ICFBamProtTimeDefObj readCachedTimeDefByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );

	List<ICFBamProtTimeDefObj> readCachedTimeDefByScopeIdx( CFLibDbKeyHash256 ScopeId );

	List<ICFBamProtTimeDefObj> readCachedTimeDefByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamProtTimeDefObj> readCachedTimeDefByPrevIdx( CFLibDbKeyHash256 PrevId );

	List<ICFBamProtTimeDefObj> readCachedTimeDefByNextIdx( CFLibDbKeyHash256 NextId );

	List<ICFBamProtTimeDefObj> readCachedTimeDefByContPrevIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );

	List<ICFBamProtTimeDefObj> readCachedTimeDefByContNextIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );
	...
	/**
	 *	Move the CFBamProtTimeDefObj instance up in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtTimeDefObj refreshed cache instance.
	 */
	ICFBamProtTimeDefObj moveUpTimeDef( ICFBamProtTimeDefObj Obj );

	/**
	 *	Move the CFBamProtTimeDefObj instance down in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtTimeDefObj refreshed cache instance.
	 */
