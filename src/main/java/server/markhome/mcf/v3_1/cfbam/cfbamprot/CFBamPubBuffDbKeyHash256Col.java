// Description: Java 17 implJustPubementation of a DbKeyHash256Col buffer
	...
	implements ICFBamDbKeyHash256Col
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash256Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash256Col ) {
			setJustPubDbKeyHash256Col( (CFBamPubBuffDbKeyHash256Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash256Col ) {
			setJustPubDbKeyHash256Col( (CFBamPubPubBuffDbKeyHash256Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash256Col" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash256Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
