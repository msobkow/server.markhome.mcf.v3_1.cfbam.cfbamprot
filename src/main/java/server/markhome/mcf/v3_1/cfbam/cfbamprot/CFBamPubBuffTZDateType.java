// Description: Java 17 implJustPubementation of a TZDateType buffer
	...
	implements ICFBamTZDateType
{
	...
	public int getClassCode() {
		return( ICFBamPubTZDateType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZDateType ) {
			setJustPubTZDateType( (CFBamPubBuffTZDateType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZDateType ) {
			setJustPubTZDateType( (CFBamPubPubBuffTZDateType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZDateType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
