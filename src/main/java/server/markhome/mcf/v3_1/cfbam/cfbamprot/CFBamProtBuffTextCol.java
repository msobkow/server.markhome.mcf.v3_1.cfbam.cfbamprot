// Description: Java 25 implJustProtementation of a TextCol buffer
...
public class CFBamProtBuffTextCol
	extends CFBamProtBuffTextDef
	implements ICFBamTextCol
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamProtBuffTextCol() {
		super();
	...
	public int getClassCode() {
		return( ICFBamTextCol.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtTextCol rhs ) {
		...
		else if( obj instanceof ICFBamProtTextColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTextColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTextCol rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTextColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTextColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTextColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffTextCol ) {
			setJustProtTextCol( (CFBamProtBuffTextCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffTextCol" );
		}
	}

	@Override
	public void setJustProtTextCol( ICFBamTextCol src ) {
		super.setJustProtTextDef( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtTextColH ) {
			setTextCol( (ICFBamProtTextColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTextCol( ICFBamTextColH src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtTextCol( ICFBamProtTextCol src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtTextCol( ICFBamProtTextColH src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffTextCol ) {
			setJustProtTextCol( (CFBamPubProtBuffTextCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffTextCol" );
		}
	}

	@Override
	public void setJustProtTextCol( ICFBamPubTextCol src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubTextColH ) {
			setTextCol( (ICFBamPubTextColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTextCol( ICFBamPubTextColH src ) {
		super.setJustProtTextDef( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffTextCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
