// Description: Java 17 implJustPubementation of a UInt32Type buffer
...
public class CFBamPubBuffUInt32Type
	extends CFBamPubBuffUInt32Def
	implements ICFBamUInt32Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffUInt32Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubUInt32Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt32Type ) {
			setJustPubUInt32Type( (CFBamPubBuffUInt32Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt32Type ) {
			setJustPubUInt32Type( (CFBamPubPubBuffUInt32Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt32Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
