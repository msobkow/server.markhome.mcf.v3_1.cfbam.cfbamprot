// Description: Java 17 implJustPubementation of a UInt16Def buffer
...
public class CFBamPubBuffUInt16Def
	...
	implements ICFBamUInt16Def
{
	...
	public int getClassCode() {
		return( ICFBamPubUInt16Def.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt16Def ) {
			setJustPubUInt16Def( (CFBamPubBuffUInt16Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt16Def ) {
			setJustPubUInt16Def( (CFBamPubPubBuffUInt16Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt16Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
