...
// Description: Java 25 protected DbIO interface for DbKeyHash256Col.
...
/*
 *	CFBamProtDbKeyHash256ColTable protected database interface for DbKeyHash256Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash256ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDbKeyHash256Col protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
