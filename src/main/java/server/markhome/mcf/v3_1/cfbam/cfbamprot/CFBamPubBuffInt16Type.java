// Description: Java 17 implJustPubementation of a Int16Type buffer
...
public class CFBamPubBuffInt16Type
	extends CFBamPubBuffInt16Def
	implements ICFBamInt16Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffInt16Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubInt16Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt16Type ) {
			setJustPubInt16Type( (CFBamPubBuffInt16Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt16Type ) {
			setJustPubInt16Type( (CFBamPubPubBuffInt16Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt16Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
