// Description: Java 17 implJustPubementation of a DbKeyHash128Type buffer
...
public class CFBamPubBuffDbKeyHash128Type
	extends CFBamPubBuffDbKeyHash128Def
	implements ICFBamDbKeyHash128Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffDbKeyHash128Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash128Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash128Type ) {
			setJustPubDbKeyHash128Type( (CFBamPubBuffDbKeyHash128Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash128Type ) {
			setJustPubDbKeyHash128Type( (CFBamPubPubBuffDbKeyHash128Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash128Type" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash128Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
