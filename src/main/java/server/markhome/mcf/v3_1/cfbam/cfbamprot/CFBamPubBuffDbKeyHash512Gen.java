// Description: Java 17 implJustPubementation of a DbKeyHash512Gen buffer
...
public class CFBamPubBuffDbKeyHash512Gen
	extends CFBamPubBuffDbKeyHash512Type
	implements ICFBamDbKeyHash512Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffDbKeyHash512Gen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash512Gen.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash512Gen ) {
			setJustPubDbKeyHash512Gen( (CFBamPubBuffDbKeyHash512Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash512Gen ) {
			setJustPubDbKeyHash512Gen( (CFBamPubPubBuffDbKeyHash512Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash512Gen" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash512Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
