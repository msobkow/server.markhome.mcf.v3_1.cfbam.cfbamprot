// Description: Java 17 implJustPubementation of a DbKeyHash160Col buffer
	...
	implements ICFBamDbKeyHash160Col
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash160Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash160Col ) {
			setJustPubDbKeyHash160Col( (CFBamPubBuffDbKeyHash160Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash160Col ) {
			setJustPubDbKeyHash160Col( (CFBamPubPubBuffDbKeyHash160Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash160Col" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash160Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
