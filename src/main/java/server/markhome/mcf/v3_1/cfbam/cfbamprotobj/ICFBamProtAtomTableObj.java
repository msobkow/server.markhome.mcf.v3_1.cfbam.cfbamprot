...
public interface ICFBamProtAtomTableObj
{
	 ...
	 */
	ICFBamProtAtomEditObj newEditInstance( ICFBamProtAtomObj orig );

	/**
	 *	Internal use only.
	 */
	ICFBamProtAtomObj realiseAtom( ICFBamProtAtomObj Obj );

	/**
	 *	Internal use only.
	 */
	ICFBamProtAtomObj createAtom( ICFBamProtAtomObj Obj );
	 ...
	 */
	ICFBamProtAtomObj readAtom( CFLibDbKeyHash256 pkey );
	...
	ICFBamProtAtomObj readCachedAtom( CFLibDbKeyHash256 pkey );

	public void reallyDeepDisposeAtom( ICFBamProtAtomObj obj );
	 ...
	 *	Internal use only.
	 */
	ICFBamProtAtomObj lockAtom( CFLibDbKeyHash256 pkey );

	/**
	 *	Return a sorted list of all the Atom-derived instances in the database.
	 *
	 *	@return	List of ICFBamProtAtomObj instance, sorted by their primary keys, which
	 *		may include an empty set.
	 */
	List<ICFBamProtAtomObj> readAllAtom();
	 ...
	 *		may include an empty set.
	 */
	List<ICFBamProtAtomObj> readAllAtom( boolean forceRead );

	List<ICFBamProtAtomObj> readCachedAllAtom();
	 ...
	 *	@param	ScopeId	The Atom key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtAtomObj> readAtomByScopeIdx( CFLibDbKeyHash256 ScopeId );

	/**
	 *	Get the map of CFBamProtAtomObj instances sorted by their primary keys for the duplicate ScopeIdx key.
	 *
	 *	@param	ScopeId	The Atom key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtAtomObj> readAtomByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	/**
	 *	Get the map of CFBamProtAtomObj instances sorted by their primary keys for the duplicate DefSchemaIdx key.
	 *
	 *	@param	DefSchemaId	The Atom key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtAtomObj> readAtomByPrevIdx( CFLibDbKeyHash256 PrevId );

	/**
	 *	Get the map of CFBamProtAtomObj instances sorted by their primary keys for the duplicate PrevIdx key.
	 *
	 *	@param	PrevId	The Atom key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtAtomObj> readAtomByNextIdx( CFLibDbKeyHash256 NextId );

	/**
	 *	Get the map of CFBamProtAtomObj instances sorted by their primary keys for the duplicate NextIdx key.
	 *
	 *	@param	NextId	The Atom key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 ...
	 *	@param	PrevId	The Atom key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate ContPrevIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtAtomObj instances sorted by their primary keys for the duplicate ContPrevIdx key.
	 *
	 *	@param	ScopeId	The Atom key attribute of the instance generating the id.
	 *
	 *	@param	PrevId	The Atom key attribute of the instance generating the id.
	 ...
	 *	@param	NextId	The Atom key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtAtomObj cached instances sorted by their primary keys for the duplicate ContNextIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtAtomObj instances sorted by their primary keys for the duplicate ContNextIdx key.
	 *
	 *	@param	ScopeId	The Atom key attribute of the instance generating the id.
	 *
	 *	@param	NextId	The Atom key attribute of the instance generating the id.
	...
	ICFBamProtAtomObj readCachedAtomByIdIdx( CFLibDbKeyHash256 Id );

	ICFBamProtAtomObj readCachedAtomByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );

	List<ICFBamProtAtomObj> readCachedAtomByScopeIdx( CFLibDbKeyHash256 ScopeId );

	List<ICFBamProtAtomObj> readCachedAtomByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamProtAtomObj> readCachedAtomByPrevIdx( CFLibDbKeyHash256 PrevId );

	List<ICFBamProtAtomObj> readCachedAtomByNextIdx( CFLibDbKeyHash256 NextId );

	List<ICFBamProtAtomObj> readCachedAtomByContPrevIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );

	List<ICFBamProtAtomObj> readCachedAtomByContNextIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );
	 ...
	 *	Internal use only.
	 */
	ICFBamProtAtomObj updateAtom( ICFBamProtAtomObj Obj );

	/**
	 *	Internal use only.
	 */
	void deleteAtom( ICFBamProtAtomObj Obj );
	...
	/**
	 *	Move the CFBamProtAtomObj instance up in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtAtomObj refreshed cache instance.
	 */
	ICFBamProtAtomObj moveUpAtom( ICFBamProtAtomObj Obj );

	/**
	 *	Move the CFBamProtAtomObj instance down in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtAtomObj refreshed cache instance.
	 */
	ICFBamProtAtomObj moveDownAtom( ICFBamProtAtomObj Obj );
}
