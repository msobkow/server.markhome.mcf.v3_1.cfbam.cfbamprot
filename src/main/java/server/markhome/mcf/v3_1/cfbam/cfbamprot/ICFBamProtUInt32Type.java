// Description: Java 25 protected interface for a UInt32Type record implementation
...
/**
 *	ICFBamProtUInt32Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtUInt32Type extends ICFBamProtUInt32Def
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubUInt32Type.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubUInt32Type.SCHEMADEFID_INIT_VALUE;
