...
// Description: Java 25 protected DbIO interface for Int64Col.
...
/*
 *	CFBamProtInt64ColTable protected database interface for Int64Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtInt64ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamInt64Col protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
