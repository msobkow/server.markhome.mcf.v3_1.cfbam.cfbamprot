// Description: Java 17 implJustPubementation of a UuidGen buffer
...
public class CFBamPubBuffUuidGen
	extends CFBamPubBuffUuidType
	implements ICFBamUuidGen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffUuidGen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubUuidGen.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuidGen ) {
			setJustPubUuidGen( (CFBamPubBuffUuidGen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuidGen ) {
			setJustPubUuidGen( (CFBamPubPubBuffUuidGen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuidGen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
