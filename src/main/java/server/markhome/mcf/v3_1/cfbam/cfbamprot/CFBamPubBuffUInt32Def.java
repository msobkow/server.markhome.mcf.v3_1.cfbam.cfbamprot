// Description: Java 17 implJustPubementation of a UInt32Def buffer
...
public class CFBamPubBuffUInt32Def
	...
	implements ICFBamUInt32Def
{
	...
	public int getClassCode() {
		return( ICFBamPubUInt32Def.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt32Def ) {
			setJustPubUInt32Def( (CFBamPubBuffUInt32Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt32Def ) {
			setJustPubUInt32Def( (CFBamPubPubBuffUInt32Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt32Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
