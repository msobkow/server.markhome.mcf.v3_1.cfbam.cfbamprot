...
// Description: Java 25 protlic DbIO interface for BlobType.
...
/*
 *	CFBamProtBlobTypeTable protlic database interface for BlobType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtBlobTypeTable
extends ICFBamProtBlobDefTable,
	ICFBamPubBlobTypeTable
{
