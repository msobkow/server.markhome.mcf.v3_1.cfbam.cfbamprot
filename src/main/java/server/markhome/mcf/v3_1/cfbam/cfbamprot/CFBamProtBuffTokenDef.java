// Description: Java 17 implJustProtementation of a TokenDef buffer
...
public class CFBamProtBuffTokenDef
	...
	implements ICFBamTokenDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtTokenDef rhs ) {
		...
		else if( obj instanceof ICFBamProtTokenDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFBamProtBuffTokenDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
