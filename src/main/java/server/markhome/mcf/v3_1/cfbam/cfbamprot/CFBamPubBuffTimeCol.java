// Description: Java 17 implJustPubementation of a TimeCol buffer
	...
	implements ICFBamTimeCol
{
	...
	public int getClassCode() {
		return( ICFBamPubTimeCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimeCol ) {
			setJustPubTimeCol( (CFBamPubBuffTimeCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTimeCol ) {
			setJustPubTimeCol( (CFBamPubPubBuffTimeCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTimeCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
