// Description: Java 17 implJustPubementation of a DateDef buffer
...
public class CFBamPubBuffDateDef
	extends CFBamPubBuffAtom
	implements ICFBamDateDef
{
	protected String optionalDummy;

	public CFBamPubBuffDateDef() {
		super();
		optionalDummy = null;
	}
	...
	public int getClassCode() {
		return( ICFBamPubDateDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubDateDef rhs ) {
		...
		else if( obj instanceof ICFBamPubDateDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDateDef ) {
			setJustPubDateDef( (CFBamPubBuffDateDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDateDef ) {
			setJustPubDateDef( (CFBamPubPubBuffDateDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffDateDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
