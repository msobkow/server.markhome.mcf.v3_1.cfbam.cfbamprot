// Description: Java 25 Protected Instance Edit Object interface for CFBam ServerListFunc.
...
public interface ICFBamProtServerListFuncEditObj
	extends ICFBamProtServerListFuncObj, ICFBamProtServerMethodEditObj
{
	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamProtServerListFuncObj.
	 */
	ICFBamProtServerListFuncObj getOrigAsServerListFunc();

	/**
	 *	Get the ICFBamProtTableObj instance referenced by the RetTable key.
	 *
