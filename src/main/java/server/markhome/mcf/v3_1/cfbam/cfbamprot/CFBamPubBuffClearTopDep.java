// Description: Java 17 implJustPubementation of a ClearTopDep buffer
...
public class CFBamPubBuffClearTopDep
	...
	implements ICFBamClearTopDep
{
	...
	public CFBamPubBuffClearTopDep() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubClearTopDep.CLASS_CODE );
	}
	...
	@Override
	public ICFBamPubClearTopDep getOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamPubSchema.getBackingCFBam().getTableClearTopDep()");
		}
	...
	public void setOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		...
		ICFBamPubClearTopDep found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPrevId);
		if (found == null || (found != null && ((found instanceof ICFBamPubClearTopDep) || (found instanceof ICFBamPubClearTopDep)))) {
			super.setOptionalLookupPrev(argPrevId);
		optionalPrevId = argPrevId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupPrev-args", "found", found, "ICFBamPubClearTopDepICFBamPubClearTopDep");
		}
	}
	...
	@Override
	public ICFBamPubClearTopDep getOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		ICFBamPubClearTopDepTable targetTable = targetBackingCFBam.getTableClearTopDep();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNext", 0, "ICFBamPubSchema.getBackingCFBam().getTableClearTopDep()");
		}
	...
	public void setOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		...
		ICFBamPubClearTopDep found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNextId);
		if (found == null || (found != null && ((found instanceof ICFBamPubClearTopDep) || (found instanceof ICFBamPubClearTopDep)))) {
			super.setOptionalLookupNext(argNextId);
		optionalNextId = argNextId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupNext-args", "found", found, "ICFBamPubClearTopDepICFBamPubClearTopDep");
		}
	}
	...
	@Override
	public List<ICFBamPubClearSubDep1> getOptionalComponentsClearDep(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalComponentsClearDep", 0, "ICFBamPubSchema.getBackingCFBam().getTableClearSubDep1()");
		}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffClearTopDep ) {
			setJustPubClearTopDep( (CFBamPubBuffClearTopDep)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffClearTopDep ) {
			setJustPubClearTopDep( (CFBamPubPubBuffClearTopDep)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffClearTopDep" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
