// Description: Java 25 Protected Instance Edit Object interface for CFBam Tweak.
...
public interface ICFBamProtTweakEditObj
	extends ICFBamProtTweakObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFBamProtTweakObj.
	 */
	ICFBamProtTweakObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamProtTweakObj.
	 */
	ICFBamProtTweakObj getOrigAsTweak();
	 ...
	 */
	ICFBamProtTweakObj create();

	/*
	 *	Update the instance.
	 */
	ICFBamProtTweakEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFBamProtTweakEditObj deleteInstance();
	...
	/**
	 *	Get the ICFBamProtScopeObj instance referenced by the ScopeDef key.
	 *
