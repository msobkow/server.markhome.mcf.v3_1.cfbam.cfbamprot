// Description: Java 25 implJustProtementation of a Uuid6Col buffer
	...
	implements ICFBamUuid6Col
{
	...
	public int getClassCode() {
		return( ICFBamUuid6Col.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtUuid6Col rhs ) {
		...
		else if( obj instanceof ICFBamProtUuid6ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtUuid6ColByTableIdxKey rhs ) {
			if( getRequiredTableId() != null ) {
				if( rhs.getRequiredTableId() != null ) {
					if( ! getRequiredTableId().equals( rhs.getRequiredTableId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubUuid6Col rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubUuid6ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamUuid6ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubUuid6ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffUuid6Col ) {
			setJustProtUuid6Col( (CFBamProtBuffUuid6Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffUuid6Col" );
		}
	}

	@Override
	public void setJustProtUuid6Col( ICFBamUuid6Col src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtUuid6ColH ) {
			setUuid6Col( (ICFBamProtUuid6ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtUuid6Col( ICFBamUuid6ColH src ) {
		super.setJustProtUuid6Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtUuid6Col( ICFBamProtUuid6Col src ) {
		super.setJustProtUuid6Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtUuid6Col( ICFBamProtUuid6ColH src ) {
		super.setJustProtUuid6Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffUuid6Col ) {
			setJustProtUuid6Col( (CFBamPubProtBuffUuid6Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffUuid6Col" );
		}
	}

	@Override
	public void setJustProtUuid6Col( ICFBamPubUuid6Col src ) {
		super.setJustProtUuid6Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubUuid6ColH ) {
			setUuid6Col( (ICFBamPubUuid6ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtUuid6Col( ICFBamPubUuid6ColH src ) {
		super.setJustProtUuid6Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffUuid6Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
