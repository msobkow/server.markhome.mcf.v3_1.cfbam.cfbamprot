// Description: Java 17 implJustProtementation of a IndexTweak buffer
	...
	implements ICFBamIndexTweak
{
	...
	@Override
	public ICFBamProtIndex getRequiredContainerIndexDef(ICFLibKeyHash256 argIndexId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerIndexDef", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtIndexTable targetTable = targetBackingCFBam.getTableIndex();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerIndexDef", 0, "ICFBamProtSchema.getBackingCFBam().getTableIndex()");
		}
