...
// Description: Java 25 protected DbIO interface for TextType.
...
/*
 *	CFBamProtTextTypeTable protected database interface for TextType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtTextTypeTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamTextType protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
