// Description: Java 17 implJustPubementation of a StringDef buffer
...
public class CFBamPubBuffStringDef
	...
	implements ICFBamStringDef
{
	...
	public int getClassCode() {
		return( ICFBamPubStringDef.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffStringDef ) {
			setJustPubStringDef( (CFBamPubBuffStringDef)src );
		}
		else {
	...
	public void setStringDef( ICFBamPubStringDef src ) {
		...
		setJustPubRequiredIsPolymorph(src.getRequiredIsPolymorph());
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffStringDef ) {
			setJustPubStringDef( (CFBamPubPubBuffStringDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffStringDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
