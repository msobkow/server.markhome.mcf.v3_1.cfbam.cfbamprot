...
// Description: Java 25 protected DbIO interface for UInt32Col.
...
/*
 *	CFBamProtUInt32ColTable protected database interface for UInt32Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtUInt32ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamUInt32Col protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
