// Description: Java 17 implJustPubementation of a BlobDef buffer
...
public class CFBamPubBuffBlobDef
	...
	implements ICFBamBlobDef
{
	...
	public int getClassCode() {
		return( ICFBamPubBlobDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubBlobDef rhs ) {
		...
		else if( obj instanceof ICFBamPubBlobDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBlobDef ) {
			setJustPubBlobDef( (CFBamPubBuffBlobDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffBlobDef ) {
			setJustPubBlobDef( (CFBamPubPubBuffBlobDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffBlobDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
