// Description: Java 25 implJustProtementation of a TokenType buffer
...
public class CFBamProtBuffTokenType
	extends CFBamProtBuffTokenDef
	implements ICFBamTokenType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamProtBuffTokenType() {
		super();
		requiredSchemaDefId = CFLibDbKeyHash256.fromHex( ICFBamPubTokenType.SCHEMADEFID_INIT_VALUE.toString() );
	}

	@Override
	public int getClassCode() {
		return( ICFBamTokenType.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtTokenType rhs ) {
		...
		else if( obj instanceof ICFBamProtTokenTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTokenTypeBySchemaIdxKey rhs ) {
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTokenType rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTokenTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTokenTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTokenTypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffTokenType ) {
			setJustProtTokenType( (CFBamProtBuffTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffTokenType" );
		}
	}

	@Override
	public void setJustProtTokenType( ICFBamTokenType src ) {
		super.setJustProtTokenDef( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtTokenTypeH ) {
			setTokenType( (ICFBamProtTokenTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTokenType( ICFBamTokenTypeH src ) {
		super.setJustProtTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTokenType( ICFBamProtTokenType src ) {
		super.setJustProtTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtTokenType( ICFBamProtTokenTypeH src ) {
		super.setJustProtTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffTokenType ) {
			setJustProtTokenType( (CFBamPubProtBuffTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffTokenType" );
		}
	}

	@Override
	public void setJustProtTokenType( ICFBamPubTokenType src ) {
		super.setJustProtTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubTokenTypeH ) {
			setTokenType( (ICFBamPubTokenTypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtTokenType( ICFBamPubTokenTypeH src ) {
		super.setJustProtTokenDef( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffTokenType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
