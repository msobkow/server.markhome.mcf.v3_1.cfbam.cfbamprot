// Description: Java 25 implJustProtementation of a DbKeyHash384Type buffer
...
public class CFBamProtBuffDbKeyHash384Type
	extends CFBamProtBuffDbKeyHash384Def
	implements ICFBamDbKeyHash384Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamProtBuffDbKeyHash384Type() {
		super();
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash384Type rhs ) {
		...
		else if( obj instanceof ICFBamProtDbKeyHash384TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtDbKeyHash384TypeBySchemaIdxKey rhs ) {
			if( getRequiredSchemaDefId() != null ) {
				if( rhs.getRequiredSchemaDefId() != null ) {
					if( ! getRequiredSchemaDefId().equals( rhs.getRequiredSchemaDefId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash384Type rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubDbKeyHash384TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash384TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash384TypeBySchemaIdxKey rhs ) {
			if (getRequiredSchemaDefId() != null) {
				if (rhs.getRequiredSchemaDefId() != null) {
					cmp = getRequiredSchemaDefId().compareTo( rhs.getRequiredSchemaDefId() );
					if( cmp != 0 ) {
	...
	public void setJustProt( ICFBamValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash384Type ) {
			setJustProtDbKeyHash384Type( (CFBamProtBuffDbKeyHash384Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamProtBuffDbKeyHash384Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash384Type( ICFBamDbKeyHash384Type src ) {
		super.setJustProtDbKeyHash384Def( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash384TypeH ) {
			setDbKeyHash384Type( (ICFBamProtDbKeyHash384TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash384Type( ICFBamDbKeyHash384TypeH src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash384Type( ICFBamProtDbKeyHash384Type src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	@Override
	public void setJustProtDbKeyHash384Type( ICFBamProtDbKeyHash384TypeH src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash384Type ) {
			setJustProtDbKeyHash384Type( (CFBamPubProtBuffDbKeyHash384Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash384Type" );
		}
	}

	@Override
	public void setJustProtDbKeyHash384Type( ICFBamPubDbKeyHash384Type src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public void setJustProt( ICFBamPubValueH src ) {
		if( src instanceof ICFBamPubDbKeyHash384TypeH ) {
			setDbKeyHash384Type( (ICFBamPubDbKeyHash384TypeH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtDbKeyHash384Type( ICFBamPubDbKeyHash384TypeH src ) {
		super.setJustProtDbKeyHash384Def( src );
		setJustProtRequiredContainerSchemaDef(src.getRequiredContainerSchemaDef());
		setJustProtRequiredSchemaDefId(src.getRequiredSchemaDefId());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash384Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
