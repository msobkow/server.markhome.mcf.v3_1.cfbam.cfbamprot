// Description: Java 17 implJustPubementation of a DbKeyHash512Type buffer
...
public class CFBamPubBuffDbKeyHash512Type
	extends CFBamPubBuffDbKeyHash512Def
	implements ICFBamDbKeyHash512Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffDbKeyHash512Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash512Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash512Type ) {
			setJustPubDbKeyHash512Type( (CFBamPubBuffDbKeyHash512Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash512Type ) {
			setJustPubDbKeyHash512Type( (CFBamPubPubBuffDbKeyHash512Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash512Type" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash512Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
