...
// Description: Java 25 protected DbIO interface for DbKeyHash384Gen.
...
/*
 *	CFBamProtDbKeyHash384GenTable protected database interface for DbKeyHash384Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash384GenTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDbKeyHash384Gen protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
