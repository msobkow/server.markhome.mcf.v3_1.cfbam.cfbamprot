// Description: Java 25 Protected Instance Edit Object interface for CFBam ClearSubDep2.
...
public interface ICFBamProtClearSubDep2EditObj
	extends ICFBamProtClearSubDep2Obj, ICFBamProtClearDepEditObj
{
	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamProtClearSubDep2Obj.
	 */
	ICFBamProtClearSubDep2Obj getOrigAsClearSubDep2();

	/**
	 *	Get the ICFBamProtClearSubDep1Obj instance referenced by the ClearSubDep1 key.
	 *
