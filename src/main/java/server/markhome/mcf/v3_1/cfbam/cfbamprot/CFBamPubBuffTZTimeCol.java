// Description: Java 17 implJustPubementation of a TZTimeCol buffer
	...
	implements ICFBamTZTimeCol
{
	...
	public int getClassCode() {
		return( ICFBamPubTZTimeCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimeCol ) {
			setJustPubTZTimeCol( (CFBamPubBuffTZTimeCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZTimeCol ) {
			setJustPubTZTimeCol( (CFBamPubPubBuffTZTimeCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZTimeCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
