...
public interface ICFBamProtDelDepTableObj
{
	 ...
	 *
	 *	@return	List of CFBamProtDelDepObj cached instances sorted by their primary keys for the duplicate TenantIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtDelDepObj> readDelDepByTenantIdx( CFLibDbKeyHash256 TenantId );

	/**
	 *	Get the map of CFBamProtDelDepObj instances sorted by their primary keys for the duplicate TenantIdx key.
	 *
	 *	@param	TenantId	The DelDep key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDelDepObj cached instances sorted by their primary keys for the duplicate TenantIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtDelDepObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 *		which may be an empty set.
	 */
	 ...
	 *
	 *	@return	List of CFBamProtDelDepObj cached instances sorted by their primary keys for the duplicate DelDepIdx key,
	 *		which may be an empty set.
	 */
	...
	ICFBamProtDelDepObj readCachedDelDepByIdIdx( CFLibDbKeyHash256 Id );

	List<ICFBamProtDelDepObj> readCachedDelDepByTenantIdx( CFLibDbKeyHash256 TenantId );

	List<ICFBamProtDelDepObj> readCachedDelDepByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamProtDelDepObj> readCachedDelDepByDelDepIdx( CFLibDbKeyHash256 RelationId );
