...
// Description: Java 25 protected DbIO interface for Int64Def.
...
/*
 *	CFBamProtInt64DefTable protected database interface for Int64Def has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtInt64DefTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamInt64Def protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
