// Description: Java 25 implJustProtementation of a DoubleDef buffer
...
public class CFBamProtBuffDoubleDef
	...
	implements ICFBamDoubleDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtDoubleDef rhs ) {
		...
		else if( obj instanceof ICFBamProtDoubleDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFBamProtBuffDoubleDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
