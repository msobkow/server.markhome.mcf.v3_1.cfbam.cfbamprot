// Description: Java 17 implJustPubementation of a ClearDep buffer
...
public class CFBamPubBuffClearDep
	...
	implements ICFBamClearDep
{
	...
	public int getClassCode() {
		return( ICFBamPubClearDep.CLASS_CODE );
	}

	@Override
	public ICFBamPubRelation getRequiredLookupRelation(ICFLibKeyHash256 argRelationId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupRelation", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubRelationTable targetTable = targetBackingCFBam.getTableRelation();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupRelation", 0, "ICFBamPubSchema.getBackingCFBam().getTableRelation()");
		}
	...
	public void setRequiredLookupRelation(ICFLibKeyHash256 argRelationId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupRelation-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubRelationTable targetTable = targetBackingCFBam.getTableRelation();
		if (targetTable == null) {
		...
		requiredRelationId = argRelationId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredLookupRelation-args", "found", found, "ICFBamPubRelationICFBamPubRelation");
		}
	}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffClearDep ) {
			setJustPubClearDep( (CFBamPubBuffClearDep)src );
		}
		else {
	...
	public void setClearDep( ICFBamPubClearDep src ) {
		super.setScope( src );
		setJustPubRequiredLookupRelation(src.getRequiredLookupRelation());
		setJustPubOptionalLookupDefSchema(src.getOptionalLookupDefSchema());
		setJustPubRequiredRelationId(src.getRequiredRelationId());
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffClearDep ) {
			setJustPubClearDep( (CFBamPubPubBuffClearDep)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffClearDep" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
