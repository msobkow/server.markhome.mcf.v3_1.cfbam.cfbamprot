...
// Description: Java 25 protected DbIO interface for TZTimestampCol.
...
/*
 *	CFBamProtTZTimestampColTable protected database interface for TZTimestampCol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtTZTimestampColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamTZTimestampCol protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
