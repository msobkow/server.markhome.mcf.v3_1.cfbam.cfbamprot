...
// Description: Java 25 protected DbIO interface for DbKeyHash128Col.
...
/*
 *	CFBamProtDbKeyHash128ColTable protected database interface for DbKeyHash128Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash128ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDbKeyHash128Col protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
