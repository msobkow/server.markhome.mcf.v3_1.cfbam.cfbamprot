// Description: Java 17 implJustPubementation of a TextDef buffer
...
public class CFBamPubBuffTextDef
	...
	implements ICFBamTextDef
{
	...
	public int getClassCode() {
		return( ICFBamPubTextDef.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTextDef ) {
			setJustPubTextDef( (CFBamPubBuffTextDef)src );
		}
		else {
	...
	public void setTextDef( ICFBamPubTextDef src ) {
		super.setAtom( src );
		setJustPubRequiredMaxLen(src.getRequiredMaxLen());
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTextDef ) {
			setJustPubTextDef( (CFBamPubPubBuffTextDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String getXmlAttrFragment() {
		String ret = super.getXmlAttrFragment()  + "\"" + getRequiredId().toString() + "\"" + "\"" + Integer.toString( getRequiredMaxLen() ) + "\"" + ( ( getOptionalInitValue() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalInitValue() ) + "\"" ) + ( ( getOptionalXmlElementName() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalXmlElementName() ) + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFBamPubBuffTextDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
