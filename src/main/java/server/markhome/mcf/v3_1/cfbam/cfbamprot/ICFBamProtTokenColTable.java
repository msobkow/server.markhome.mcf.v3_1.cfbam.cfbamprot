...
// Description: Java 25 protected DbIO interface for TokenCol.
...
/*
 *	CFBamProtTokenColTable protected database interface for TokenCol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtTokenColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamTokenCol protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
