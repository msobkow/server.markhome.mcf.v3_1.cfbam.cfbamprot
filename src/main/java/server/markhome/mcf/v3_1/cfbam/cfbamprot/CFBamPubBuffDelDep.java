// Description: Java 17 implJustPubementation of a DelDep buffer
...
public class CFBamPubBuffDelDep
	...
	implements ICFBamDelDep
{
	...
	public int getClassCode() {
		return( ICFBamPubDelDep.CLASS_CODE );
	}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffDelDep ) {
			setJustPubDelDep( (CFBamPubBuffDelDep)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffDelDep ) {
			setJustPubDelDep( (CFBamPubPubBuffDelDep)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffDelDep" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
