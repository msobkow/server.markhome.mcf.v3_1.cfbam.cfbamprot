// Description: Java 17 implJustPubementation of a BlobType buffer
...
public class CFBamPubBuffBlobType
	extends CFBamPubBuffBlobDef
	implements ICFBamBlobType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffBlobType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubBlobType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBlobType ) {
			setJustPubBlobType( (CFBamPubBuffBlobType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffBlobType ) {
			setJustPubBlobType( (CFBamPubPubBuffBlobType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffBlobType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
