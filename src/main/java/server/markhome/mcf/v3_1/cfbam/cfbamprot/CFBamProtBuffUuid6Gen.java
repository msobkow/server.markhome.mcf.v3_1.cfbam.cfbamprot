...
public class CFBamProtBuffUuid6Gen
	extends CFBamProtBuffUuid6Type
	implements ICFBamUuid6Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamProtBuffUuid6Gen() {
		super();
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtUuid6Gen rhs ) {
		...
		else if( obj instanceof ICFBamProtUuid6GenH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public String toString() {
		String ret = "<CFBamProtBuffUuid6Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
