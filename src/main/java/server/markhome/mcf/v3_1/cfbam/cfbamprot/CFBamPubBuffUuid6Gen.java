// Description: Java 17 implJustPubementation of a Uuid6Gen buffer
...
public class CFBamPubBuffUuid6Gen
	extends CFBamPubBuffUuid6Type
	implements ICFBamUuid6Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffUuid6Gen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubUuid6Gen.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubUuid6Gen rhs ) {
		...
		else if( obj instanceof ICFBamPubUuid6GenH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Gen ) {
			setJustPubUuid6Gen( (CFBamPubBuffUuid6Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUuid6Gen ) {
			setJustPubUuid6Gen( (CFBamPubPubBuffUuid6Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUuid6Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
