// Description: Java 17 implJustPubementation of a Param buffer
...
public class CFBamPubBuffParam
	implements ICFBamPubParam, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFBamPubParam.CLASS_CODE );
	}

	@Override
	public ICFBamPubServerMethod getRequiredContainerServerMeth(ICFLibKeyHash256 argServerMethodId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerServerMeth", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubServerMethodTable targetTable = targetBackingCFBam.getTableServerMethod();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerServerMeth", 0, "ICFBamPubSchema.getBackingCFBam().getTableServerMethod()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getRequiredServerMethodId()));
	}
	...
	public void setRequiredContainerServerMeth(ICFLibKeyHash256 argServerMethodId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerServerMeth-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubServerMethodTable targetTable = targetBackingCFBam.getTableServerMethod();
		if (targetTable == null) {
		...
		ICFBamPubServerMethod found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argServerMethodId);
		if (found == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerServerMeth-args", 0, "found");
		}
		else if (found instanceof ICFBamPubServerMethod) || (found instanceof ICFBamPubServerMethod)) {
			super.setRequiredContainerServerMeth(argServerMethodId);
		requiredServerMethodId = argServerMethodId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerServerMeth-args", "found", found, "ICFBamPubServerMethodICFBamPubServerMethod");
		}
	}
	...
	@Override
	public ICFBamPubParam getOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubParamTable targetTable = targetBackingCFBam.getTableParam();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupPrev", 0, "ICFBamPubSchema.getBackingCFBam().getTableParam()");
		}
	...
	public void setOptionalLookupPrev(ICFLibKeyHash256 argPrevId) {
		...
		ICFBamPubParam found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argPrevId);
		if (found == null || (found != null && ((found instanceof ICFBamPubParam) || (found instanceof ICFBamPubParam)))) {
			super.setOptionalLookupPrev(argPrevId);
		optionalPrevId = argPrevId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupPrev-args", "found", found, "ICFBamPubParamICFBamPubParam");
		}
	}
	...
	@Override
	public ICFBamPubParam getOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
		...
		ICFBamPubParamTable targetTable = targetBackingCFBam.getTableParam();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupNext", 0, "ICFBamPubSchema.getBackingCFBam().getTableParam()");
		}
	...
	public void setOptionalLookupNext(ICFLibKeyHash256 argNextId) {
		...
		ICFBamPubParam found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argNextId);
		if (found == null || (found != null && ((found instanceof ICFBamPubParam) || (found instanceof ICFBamPubParam)))) {
			super.setOptionalLookupNext(argNextId);
		optionalNextId = argNextId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupNext-args", "found", found, "ICFBamPubParamICFBamPubParam");
		}
	}
	...
	@Override
	public ICFBamPubValue getRequiredLookupType(ICFLibKeyHash256 argTypeId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupType", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubValueTable targetTable = targetBackingCFBam.getTableValue();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredLookupType", 0, "ICFBamPubSchema.getBackingCFBam().getTableValue()");
		}
		return(targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), getOptionalTypeId()));
	}
	...
	public void setRequiredLookupType(ICFLibKeyHash256 argTypeId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupType-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubValueTable targetTable = targetBackingCFBam.getTableValue();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupType", 0, "ICFBamSchema.getBackingCFBam().getTableValue()");
		}
		ICFBamPubValue found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argTypeId);
		if (found == null) {
			...
			super.setRequiredLookupType(argTypeId);
		optionalTypeId = argTypeId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredLookupType-args", "found", found, "ICFBamPubValueICFBamPubValue");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubParamHPKey ) {
			ICFBamPubParamHPKey rhs = (ICFBamPubParamHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setParam( ICFBamPubParam src ) {
		...
		setJustPubRequiredContainerServerMeth(src.getRequiredContainerServerMeth());
		...
		setJustPubRequiredLookupType(src.getRequiredLookupType());
		setJustPubRequiredServerMethodId(src.getRequiredServerMethodId());
		...
		setJustPubRequiredIsNullable(src.getRequiredIsNullable());
		setJustPubOptionalTypeId(src.getOptionalTypeId());
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredServerMethodId().toString() + "\"" + "\"" + getRequiredId().toString() + "\"" + ( ( getOptionalDefSchemaId() == null ) ? "null" : "\"" + getOptionalDefSchemaId().toString() + "\"" ) + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + ( ( getOptionalShortDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalShortDescription() ) + "\"" ) + ( ( getOptionalDescription() == null ) ? "null" : "\"" + StringEscapeUtils.escapeXml11( getOptionalDescription() ) + "\"" ) + (( getRequiredIsNullable() ) ? "\"true\"" : "\"false\"" ) + ( ( getOptionalTypeId() == null ) ? "null" : "\"" + getOptionalTypeId().toString() + "\"" ) + ( ( getOptionalPrevId() == null ) ? "null" : "\"" + getOptionalPrevId().toString() + "\"" ) + ( ( getOptionalNextId() == null ) ? "null" : "\"" + getOptionalNextId().toString() + "\"" );
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFBamPubBuffParam" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
