// Description: Java 17 implJustPubementation of a TZDateDef buffer
	...
	implements ICFBamTZDateDef
{
	...
	public int getClassCode() {
		return( ICFBamPubTZDateDef.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZDateDef ) {
			setJustPubTZDateDef( (CFBamPubBuffTZDateDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZDateDef ) {
			setJustPubTZDateDef( (CFBamPubPubBuffTZDateDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZDateDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
