// Description: Java 25 Protected Instance Edit Object interface for CFBam Scope.
...
public interface ICFBamProtScopeEditObj
	extends ICFBamProtScopeObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFBamProtScopeObj.
	 */
	ICFBamProtScopeObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamProtScopeObj.
	 */
	ICFBamProtScopeObj getOrigAsScope();
	 ...
	 */
	ICFBamProtScopeObj create();

	/*
	 *	Update the instance.
	 */
	ICFBamProtScopeEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFBamProtScopeEditObj deleteInstance();
