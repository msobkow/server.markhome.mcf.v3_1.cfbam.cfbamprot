// Description: Java 17 implJustPubementation of a ServerObjFunc buffer
...
public class CFBamPubBuffServerObjFunc
	extends CFBamPubBuffServerMethod
	implements ICFBamServerObjFunc
{
	protected ICFLibKeyHash256 optionalRetTableId;

	public CFBamPubBuffServerObjFunc() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubServerObjFunc.CLASS_CODE );
	}

	@Override
	public ICFBamPubTable getOptionalLookupRetTable(ICFLibKeyHash256 argRetTableId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupRetTable", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubTableTable targetTable = targetBackingCFBam.getTableTable();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalLookupRetTable", 0, "ICFBamPubSchema.getBackingCFBam().getTableTable()");
		}
	...
	public void setOptionalLookupRetTable(ICFLibKeyHash256 argRetTableId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalLookupRetTable-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubTableTable targetTable = targetBackingCFBam.getTableTable();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setOptionalLookupRetTable", 0, "ICFBamSchema.getBackingCFBam().getTableTable()");
		}
		ICFBamPubTable found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argRetTableId);
		...
		optionalRetTableId = argRetTableId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setOptionalLookupRetTable-args", "found", found, "ICFBamPubTableICFBamPubTable");
		}
	}
	...
	public void setOptionalLookupRetTable(ICFBamPubTable argObj) {
		...
		if(argObj == null) {
			setJustPubOptionalRetTableId(null);
		}
		else {
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubServerObjFunc rhs ) {
		...
		else if( obj instanceof ICFBamPubServerObjFuncH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubServerObjFuncByRetTblIdxKey rhs ) {
			if( getOptionalRetTableId() != null ) {
				if( rhs.getOptionalRetTableId() != null ) {
					if( ! getOptionalRetTableId().equals( rhs.getOptionalRetTableId() ) ) {
						return( false );
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffServerObjFunc ) {
			setJustPubServerObjFunc( (CFBamPubBuffServerObjFunc)src );
		}
		else {
	...
	public void setServerObjFunc( ICFBamPubServerObjFunc src ) {
		...
		setJustPubOptionalLookupRetTable(src.getOptionalLookupRetTable());
		setJustPubOptionalRetTableId(src.getOptionalRetTableId());
	}
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffServerObjFunc ) {
			setJustPubServerObjFunc( (CFBamPubPubBuffServerObjFunc)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffServerObjFunc" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
