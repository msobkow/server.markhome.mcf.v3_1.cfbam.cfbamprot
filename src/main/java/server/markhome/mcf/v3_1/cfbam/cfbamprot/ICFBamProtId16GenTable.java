...
// Description: Java 25 protected DbIO interface for Id16Gen.
...
/*
 *	CFBamProtId16GenTable protected database interface for Id16Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtId16GenTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamId16Gen protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
