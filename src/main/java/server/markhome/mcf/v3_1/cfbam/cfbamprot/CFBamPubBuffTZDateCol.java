// Description: Java 17 implJustPubementation of a TZDateCol buffer
...
public class CFBamPubBuffTZDateCol
	extends CFBamPubBuffTZDateDef
	implements ICFBamTZDateCol
{
	protected ICFLibKeyHash256 requiredTableId;

	public CFBamPubBuffTZDateCol() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubTZDateCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZDateCol ) {
			setJustPubTZDateCol( (CFBamPubBuffTZDateCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZDateCol ) {
			setJustPubTZDateCol( (CFBamPubPubBuffTZDateCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZDateCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
