// Description: Java 17 implJustPubementation of a DbKeyHash384Type buffer
...
public class CFBamPubBuffDbKeyHash384Type
	extends CFBamPubBuffDbKeyHash384Def
	implements ICFBamDbKeyHash384Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffDbKeyHash384Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash384Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash384Type ) {
			setJustPubDbKeyHash384Type( (CFBamPubBuffDbKeyHash384Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash384Type ) {
			setJustPubDbKeyHash384Type( (CFBamPubPubBuffDbKeyHash384Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash384Type" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash384Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
