// Description: Java 25 protected interface for a SchemaDef by AuthEMailIdx index key object
...
/**
 *	ICFBamProtSchemaDefByAuthEMailIdxKeys has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
