// Description: Java 17 implJustPubementation of a DoubleCol buffer
	...
	implements ICFBamDoubleCol
{
	...
	public int getClassCode() {
		return( ICFBamPubDoubleCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDoubleCol ) {
			setJustPubDoubleCol( (CFBamPubBuffDoubleCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDoubleCol ) {
			setJustPubDoubleCol( (CFBamPubPubBuffDoubleCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffDoubleCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
