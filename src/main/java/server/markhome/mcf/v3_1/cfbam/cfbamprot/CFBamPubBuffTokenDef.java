// Description: Java 17 implJustPubementation of a TokenDef buffer
...
public class CFBamPubBuffTokenDef
	...
	implements ICFBamTokenDef
{
	...
	public int getClassCode() {
		return( ICFBamPubTokenDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubTokenDef rhs ) {
		...
		else if( obj instanceof ICFBamPubTokenDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTokenDef ) {
			setJustPubTokenDef( (CFBamPubBuffTokenDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTokenDef ) {
			setJustPubTokenDef( (CFBamPubPubBuffTokenDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTokenDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
