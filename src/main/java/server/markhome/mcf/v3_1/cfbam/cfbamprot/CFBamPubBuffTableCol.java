// Description: Java 17 implJustPubementation of a TableCol buffer
...
public class CFBamPubBuffTableCol
	extends CFBamPubBuffValue
	implements ICFBamTableCol
{
	...
	public int getClassCode() {
		return( ICFBamPubTableCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	@Override
	public ICFBamPubValue getRequiredParentDataType(ICFLibKeyHash256 argDataId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredParentDataType", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubValueTable targetTable = targetBackingCFBam.getTableValue();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredParentDataType", 0, "ICFBamPubSchema.getBackingCFBam().getTableValue()");
		}
	...
	public void setRequiredParentDataType(ICFLibKeyHash256 argDataId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredParentDataType-args", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubValueTable targetTable = targetBackingCFBam.getTableValue();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredParentDataType", 0, "ICFBamSchema.getBackingCFBam().getTableValue()");
		}
		ICFBamPubValue found = targetTable.readDerived(ICFSecSchema.getAuthorizationCallback().getEffectiveAuthorization(), argDataId);
		if (found == null) {
		...
		optionalDataId = argDataId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredParentDataType-args", "found", found, "ICFBamPubValueICFBamPubValue");
		}
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTableCol ) {
			setJustPubTableCol( (CFBamPubBuffTableCol)src );
		}
		else {
	...
	public void setTableCol( ICFBamPubTableCol src ) {
		...
		setJustPubRequiredParentDataType(src.getRequiredParentDataType());
		setJustPubRequiredTableId(src.getRequiredTableId());
		setJustPubOptionalDbName(src.getOptionalDbName());
		setJustPubOptionalDataId(src.getOptionalDataId());
		setJustPubOptionalXmlElementName(src.getOptionalXmlElementName());
	}
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTableCol ) {
			setJustPubTableCol( (CFBamPubPubBuffTableCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTableCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
