// Description: Java 17 implJustPubementation of a Id16Gen buffer
...
public class CFBamPubBuffId16Gen
	extends CFBamPubBuffInt16Type
	implements ICFBamId16Gen
{
	protected short requiredSlice;
	protected short requiredBlockSize;

	public CFBamPubBuffId16Gen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubId16Gen.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffId16Gen ) {
			setJustPubId16Gen( (CFBamPubBuffId16Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffId16Gen ) {
			setJustPubId16Gen( (CFBamPubPubBuffId16Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String getXmlAttrFragment() {
		String ret = super.getXmlAttrFragment()  + "\"" + getRequiredId().toString() + "\"" + "\"" + Short.toString( getRequiredSlice() ) + "\"" + "\"" + Short.toString( getRequiredBlockSize() ) + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFBamPubBuffId16Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
