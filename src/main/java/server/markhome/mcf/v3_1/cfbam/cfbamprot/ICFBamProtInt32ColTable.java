...
// Description: Java 25 protected DbIO interface for Int32Col.
...
/*
 *	CFBamProtInt32ColTable protected database interface for Int32Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtInt32ColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamInt32Col protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
