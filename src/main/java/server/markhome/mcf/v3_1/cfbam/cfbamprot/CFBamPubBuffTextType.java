// Description: Java 17 implJustPubementation of a TextType buffer
	...
	implements ICFBamTextType
{
	...
	public int getClassCode() {
		return( ICFBamPubTextType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTextType ) {
			setJustPubTextType( (CFBamPubBuffTextType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTextType ) {
			setJustPubTextType( (CFBamPubPubBuffTextType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTextType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
