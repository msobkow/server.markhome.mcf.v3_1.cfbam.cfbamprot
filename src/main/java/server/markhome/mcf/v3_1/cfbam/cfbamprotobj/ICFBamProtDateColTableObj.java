...
public interface ICFBamProtDateColTableObj
{
	 ...
	 *	@param	ScopeId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtDateColObj> readDateColByScopeIdx( CFLibDbKeyHash256 ScopeId );

	/**
	 *	Get the map of CFBamProtDateColObj instances sorted by their primary keys for the duplicate ScopeIdx key.
	 *
	 *	@param	ScopeId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtDateColObj> readDateColByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	/**
	 *	Get the map of CFBamProtDateColObj instances sorted by their primary keys for the duplicate DefSchemaIdx key.
	 *
	 *	@param	DefSchemaId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtDateColObj> readDateColByPrevIdx( CFLibDbKeyHash256 PrevId );

	/**
	 *	Get the map of CFBamProtDateColObj instances sorted by their primary keys for the duplicate PrevIdx key.
	 *
	 *	@param	PrevId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtDateColObj> readDateColByNextIdx( CFLibDbKeyHash256 NextId );

	/**
	 *	Get the map of CFBamProtDateColObj instances sorted by their primary keys for the duplicate NextIdx key.
	 *
	 *	@param	NextId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 ...
	 *	@param	PrevId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate ContPrevIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtDateColObj instances sorted by their primary keys for the duplicate ContPrevIdx key.
	 *
	 *	@param	ScopeId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@param	PrevId	The DateCol key attribute of the instance generating the id.
	 ...
	 *	@param	NextId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate ContNextIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtDateColObj instances sorted by their primary keys for the duplicate ContNextIdx key.
	 *
	 *	@param	ScopeId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@param	NextId	The DateCol key attribute of the instance generating the id.
	...
	/**
	 *	Get the map of CFBamProtDateColObj instances sorted by their primary keys for the duplicate TableIdx key.
	 *
	 *	@param	TableId	The DateCol key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtDateColObj cached instances sorted by their primary keys for the duplicate TableIdx key,
	 *		which may be an empty set.
	 */
	...
	ICFBamProtDateColObj readCachedDateColByIdIdx( CFLibDbKeyHash256 Id );

	ICFBamProtDateColObj readCachedDateColByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );

	List<ICFBamProtDateColObj> readCachedDateColByScopeIdx( CFLibDbKeyHash256 ScopeId );

	List<ICFBamProtDateColObj> readCachedDateColByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamProtDateColObj> readCachedDateColByPrevIdx( CFLibDbKeyHash256 PrevId );

	List<ICFBamProtDateColObj> readCachedDateColByNextIdx( CFLibDbKeyHash256 NextId );

	List<ICFBamProtDateColObj> readCachedDateColByContPrevIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );

	List<ICFBamProtDateColObj> readCachedDateColByContNextIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );

	List<ICFBamProtDateColObj> readCachedDateColByTableIdx( CFLibDbKeyHash256 TableId );
	...
	/**
	 *	Move the CFBamProtDateColObj instance up in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtDateColObj refreshed cache instance.
	 */
	ICFBamProtDateColObj moveUpDateCol( ICFBamProtDateColObj Obj );

	/**
	 *	Move the CFBamProtDateColObj instance down in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtDateColObj refreshed cache instance.
	 */
