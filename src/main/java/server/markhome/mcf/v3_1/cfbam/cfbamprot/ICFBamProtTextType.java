// Description: Java 25 protected interface for a TextType record implementation
...
/**
 *	ICFBamProtTextType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtTextType extends ICFBamProtTextDef
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubTextType.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubTextType.SCHEMADEFID_INIT_VALUE;
