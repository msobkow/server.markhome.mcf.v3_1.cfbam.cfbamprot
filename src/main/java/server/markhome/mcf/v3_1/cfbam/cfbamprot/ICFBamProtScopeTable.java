...
// Description: Java 25 protlic DbIO interface for Scope.
...
/*
 *	CFBamProtScopeTable protlic database interface for Scope has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtScopeTable
extends ICFBamPubScopeTable
{
