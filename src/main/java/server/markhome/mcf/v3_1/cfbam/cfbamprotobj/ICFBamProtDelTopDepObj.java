// Description: Java 25 Object interface for CFBamProt DelTopDep.
...
public interface ICFBamProtDelTopDepObj
	extends ICFBamProtDelDepObj
{
	 ...
	 *
	 *	@return	The ICFBamProtDelTopDepEditObj edition of this instance.
	 */
	ICFBamProtDelTopDepEditObj getEditAsDelTopDep();

	/**
	 *	Get the ICFBamProtDelTopDepTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtDelTopDepTableObj table cache which manages this instance.
	 */
	ICFBamProtDelTopDepTableObj getDelTopDepTable();

	/**
	 *	Get the ICFBamProtDelTopDep instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtDelTopDep instance which currently backs this object.
	 */
