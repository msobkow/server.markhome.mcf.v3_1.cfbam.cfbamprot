...
public interface ICFBamProtTimestampTypeTableObj
{
	 ...
	 *	@param	ScopeId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimestampTypeObj> readTimestampTypeByScopeIdx( CFLibDbKeyHash256 ScopeId );

	/**
	 *	Get the map of CFBamProtTimestampTypeObj instances sorted by their primary keys for the duplicate ScopeIdx key.
	 *
	 *	@param	ScopeId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate ScopeIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimestampTypeObj> readTimestampTypeByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	/**
	 *	Get the map of CFBamProtTimestampTypeObj instances sorted by their primary keys for the duplicate DefSchemaIdx key.
	 *
	 *	@param	DefSchemaId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate DefSchemaIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimestampTypeObj> readTimestampTypeByPrevIdx( CFLibDbKeyHash256 PrevId );

	/**
	 *	Get the map of CFBamProtTimestampTypeObj instances sorted by their primary keys for the duplicate PrevIdx key.
	 *
	 *	@param	PrevId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate PrevIdx key,
	 ...
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 *		which may be an empty set.
	 */
	List<ICFBamProtTimestampTypeObj> readTimestampTypeByNextIdx( CFLibDbKeyHash256 NextId );

	/**
	 *	Get the map of CFBamProtTimestampTypeObj instances sorted by their primary keys for the duplicate NextIdx key.
	 *
	 *	@param	NextId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate NextIdx key,
	 ...
	 *	@param	PrevId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate ContPrevIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtTimestampTypeObj instances sorted by their primary keys for the duplicate ContPrevIdx key.
	 *
	 *	@param	ScopeId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@param	PrevId	The TimestampType key attribute of the instance generating the id.
	 ...
	 *	@param	NextId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate ContNextIdx key,
	 *		which may be an empty set.
	 */
	...
	/**
	 *	Get the map of CFBamProtTimestampTypeObj instances sorted by their primary keys for the duplicate ContNextIdx key.
	 *
	 *	@param	ScopeId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@param	NextId	The TimestampType key attribute of the instance generating the id.
	...
	/**
	 *	Get the map of CFBamProtTimestampTypeObj instances sorted by their primary keys for the duplicate SchemaIdx key.
	 *
	 *	@param	SchemaDefId	The TimestampType key attribute of the instance generating the id.
	 *
	 *	@return	List of CFBamProtTimestampTypeObj cached instances sorted by their primary keys for the duplicate SchemaIdx key,
	 *		which may be an empty set.
	 */
	...
	ICFBamProtTimestampTypeObj readCachedTimestampTypeByIdIdx( CFLibDbKeyHash256 Id );

	ICFBamProtTimestampTypeObj readCachedTimestampTypeByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );

	List<ICFBamProtTimestampTypeObj> readCachedTimestampTypeByScopeIdx( CFLibDbKeyHash256 ScopeId );

	List<ICFBamProtTimestampTypeObj> readCachedTimestampTypeByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamProtTimestampTypeObj> readCachedTimestampTypeByPrevIdx( CFLibDbKeyHash256 PrevId );

	List<ICFBamProtTimestampTypeObj> readCachedTimestampTypeByNextIdx( CFLibDbKeyHash256 NextId );

	List<ICFBamProtTimestampTypeObj> readCachedTimestampTypeByContPrevIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );

	List<ICFBamProtTimestampTypeObj> readCachedTimestampTypeByContNextIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );

	List<ICFBamProtTimestampTypeObj> readCachedTimestampTypeBySchemaIdx( CFLibDbKeyHash256 SchemaDefId );
	...
	/**
	 *	Move the CFBamProtTimestampTypeObj instance up in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtTimestampTypeObj refreshed cache instance.
	 */
	ICFBamProtTimestampTypeObj moveUpTimestampType( ICFBamProtTimestampTypeObj Obj );

	/**
	 *	Move the CFBamProtTimestampTypeObj instance down in the chain.  The instance is always refreshed.
	 *
	 *	@return	CFBamProtTimestampTypeObj refreshed cache instance.
	 */
