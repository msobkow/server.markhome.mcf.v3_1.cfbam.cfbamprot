...
// Description: Java 25 protected DbIO interface for DbKeyHash160Gen.
...
/*
 *	CFBamProtDbKeyHash160GenTable protected database interface for DbKeyHash160Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash160GenTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDbKeyHash160Gen protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
