// Description: Java 17 implJustPubementation of a TimeType buffer
...
public class CFBamPubBuffTimeType
	extends CFBamPubBuffTimeDef
	implements ICFBamTimeType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffTimeType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubTimeType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimeType ) {
			setJustPubTimeType( (CFBamPubBuffTimeType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTimeType ) {
			setJustPubTimeType( (CFBamPubPubBuffTimeType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTimeType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
