// Description: Java 25 implJustProtementation of a DbKeyHash160Gen buffer
...
public class CFBamProtBuffDbKeyHash160Gen
	extends CFBamProtBuffDbKeyHash160Type
	implements ICFBamDbKeyHash160Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamProtBuffDbKeyHash160Gen() {
		super();
	...
	public int getClassCode() {
		return( ICFBamDbKeyHash160Gen.CLASS_CODE );
	}
	...
	public void setRequiredSlice( short value ) {
		if( value < ICFBamPubDbKeyHash160Gen.SLICE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				ICFBamPubDbKeyHash160Gen.SLICE_MIN_VALUE );
		}
		if( value > ICFBamPubDbKeyHash160Gen.SLICE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				ICFBamPubDbKeyHash160Gen.SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( value < ICFBamPubDbKeyHash160Gen.BLOCKSIZE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				ICFBamPubDbKeyHash160Gen.BLOCKSIZE_MIN_VALUE );
		}
		if( value > ICFBamPubDbKeyHash160Gen.BLOCKSIZE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				ICFBamPubDbKeyHash160Gen.BLOCKSIZE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash160GenH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	@Override
	public void setJustProtDbKeyHash160Gen( ICFBamDbKeyHash160Gen src ) {
		super.setJustProtDbKeyHash160Type( src );
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtDbKeyHash160GenH ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
					...
					"src",
					src,
					"ICFBamDbKeyHash160GenH" );
		}
	}

	@Override
	public void setJustProtDbKeyHash160Gen( ICFBamDbKeyHash160GenH src ) {
		super.setJustProtDbKeyHash160Type( src );
		setJustProtRequiredSlice(src.getRequiredSlice());
		setJustProtRequiredBlockSize(src.getRequiredBlockSize());
	}
	...
	@Override
	public void setJustProtDbKeyHash160Gen( ICFBamProtDbKeyHash160Gen src ) {
		super.setJustProtDbKeyHash160Type( src );
		setJustProtRequiredSlice(src.getRequiredSlice());
		setJustProtRequiredBlockSize(src.getRequiredBlockSize());
	}
	...
	@Override
	public void setJustProtDbKeyHash160Gen( ICFBamProtDbKeyHash160GenH src ) {
		super.setJustProtDbKeyHash160Type( src );
		setJustProtRequiredSlice(src.getRequiredSlice());
		setJustProtRequiredBlockSize(src.getRequiredBlockSize());
	}
	...
	public void setJustProt( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffDbKeyHash160Gen ) {
			setJustProtDbKeyHash160Gen( (CFBamPubProtBuffDbKeyHash160Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubProtBuffDbKeyHash160Gen" );
		}
	}

	@Override
	public void setJustProtDbKeyHash160Gen( ICFBamPubDbKeyHash160Gen src ) {
		super.setJustProtDbKeyHash160Type( src );
		setJustProtRequiredSlice(src.getRequiredSlice());
		setJustProtRequiredBlockSize(src.getRequiredBlockSize());
	}
	...
	@Override
	public void setJustProtDbKeyHash160Gen( ICFBamPubDbKeyHash160GenH src ) {
		super.setJustProtDbKeyHash160Type( src );
		setJustProtRequiredSlice(src.getRequiredSlice());
		setJustProtRequiredBlockSize(src.getRequiredBlockSize());
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffDbKeyHash160Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
