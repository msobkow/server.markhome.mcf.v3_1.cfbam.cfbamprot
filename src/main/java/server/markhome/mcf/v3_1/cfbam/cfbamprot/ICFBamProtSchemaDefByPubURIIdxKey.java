// Description: Java 25 protected interface for a SchemaDef by PubURIIdx index key object
...
/**
 *	ICFBamProtSchemaDefByPubURIIdxKeys has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
