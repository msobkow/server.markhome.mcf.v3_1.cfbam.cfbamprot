// Description: Java 17 implJustPubementation of a Int16Col buffer
	...
	implements ICFBamInt16Col
{
	...
	public int getClassCode() {
		return( ICFBamPubInt16Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt16Col ) {
			setJustPubInt16Col( (CFBamPubBuffInt16Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt16Col ) {
			setJustPubInt16Col( (CFBamPubPubBuffInt16Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt16Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
