// Description: Java 17 implJustPubementation of a ServerProc buffer
	...
	implements ICFBamServerProc
{
	...
	public int getClassCode() {
		return( ICFBamPubServerProc.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubServerProc rhs ) {
		...
		else if( obj instanceof ICFBamPubServerProcH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffServerProc ) {
			setJustPubServerProc( (CFBamPubBuffServerProc)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffServerProc ) {
			setJustPubServerProc( (CFBamPubPubBuffServerProc)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffServerProc" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
