// Description: Java 17 implJustPubementation of a Int16Def buffer
...
public class CFBamPubBuffInt16Def
	...
	implements ICFBamInt16Def
{
	...
	public int getClassCode() {
		return( ICFBamPubInt16Def.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt16Def ) {
			setJustPubInt16Def( (CFBamPubBuffInt16Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt16Def ) {
			setJustPubInt16Def( (CFBamPubPubBuffInt16Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt16Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
