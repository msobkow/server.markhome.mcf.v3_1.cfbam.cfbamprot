// Description: Java 17 implJustPubementation of a Int64Col buffer
	...
	implements ICFBamInt64Col
{
	...
	public int getClassCode() {
		return( ICFBamPubInt64Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt64Col ) {
			setJustPubInt64Col( (CFBamPubBuffInt64Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt64Col ) {
			setJustPubInt64Col( (CFBamPubPubBuffInt64Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt64Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
