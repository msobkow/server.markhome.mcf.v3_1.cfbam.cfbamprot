// Description: Java 17 implJustPubementation of a EnumDef buffer
...
public class CFBamPubBuffEnumDef
	extends CFBamPubBuffInt16Def
	implements ICFBamEnumDef
{

	public CFBamPubBuffEnumDef() {
		super();
	}

	@Override
	public int getClassCode() {
		return( ICFBamPubEnumDef.CLASS_CODE );
	}

	@Override
	public List<ICFBamPubEnumTag> getRequiredComponentsTag(ICFLibKeyHash256 argId) {
		ICFBamPubSchema targetBackingCFBam = ICFBamPubSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredComponentsTag", 0, "ICFBamPubSchema.getBackingCFBam()");
		}
		ICFBamPubEnumTagTable targetTable = targetBackingCFBam.getTableEnumTag();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredComponentsTag", 0, "ICFBamPubSchema.getBackingCFBam().getTableEnumTag()");
		}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffEnumDef ) {
			setJustPubEnumDef( (CFBamPubBuffEnumDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffEnumDef ) {
			setJustPubEnumDef( (CFBamPubPubBuffEnumDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffEnumDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
