// Description: Java 17 implJustPubementation of a FloatDef buffer
...
public class CFBamPubBuffFloatDef
	...
	implements ICFBamFloatDef
{
	...
	public int getClassCode() {
		return( ICFBamPubFloatDef.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffFloatDef ) {
			setJustPubFloatDef( (CFBamPubBuffFloatDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffFloatDef ) {
			setJustPubFloatDef( (CFBamPubPubBuffFloatDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffFloatDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
