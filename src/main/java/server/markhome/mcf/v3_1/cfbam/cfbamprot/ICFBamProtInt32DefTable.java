...
// Description: Java 25 protected DbIO interface for Int32Def.
...
/*
 *	CFBamProtInt32DefTable protected database interface for Int32Def has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtInt32DefTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamInt32Def protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
