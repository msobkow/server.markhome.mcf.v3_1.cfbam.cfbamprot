// Description: Java 17 implJustProtementation of a Tweak buffer
...
public class CFBamProtBuffTweak
	implements ICFBamProtTweak, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFBamProtTweak.CLASS_CODE );
	}

	@Override
	public ICFBamProtScope getRequiredContainerScopeDef(ICFLibKeyHash256 argScopeId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerScopeDef", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtScopeTable targetTable = targetBackingCFBam.getTableScope();
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerScopeDef", 0, "ICFBamProtSchema.getBackingCFBam().getTableScope()");
		}
	...
	public void setRequiredContainerScopeDef(ICFLibKeyHash256 argScopeId) {
		ICFBamProtSchema targetBackingCFBam = ICFBamProtSchema.getBackingCFBam();
		if (targetBackingCFBam == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredContainerScopeDef-args", 0, "ICFBamProtSchema.getBackingCFBam()");
		}
		ICFBamProtScopeTable targetTable = targetBackingCFBam.getTableScope();
		if (targetTable == null) {
		...
		if (found == null) {
			...
			super.setRequiredContainerScopeDef(argScopeId);
		requiredScopeId = argScopeId;
		}
		else {
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerScopeDef-args", "found", found, "ICFBamProtScopeICFBamProtScopeICFBamPubScope");
		}
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamProtTweak rhs ) {
		...
		else if( obj instanceof ICFBamProtTweakH rhs ) {
			if( getRequiredTenantId() != null ) {
				if( rhs.getRequiredTenantId() != null ) {
					if( ! getRequiredTenantId().equals( rhs.getRequiredTenantId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTweakByUNameIdxKey rhs ) {
			if( getRequiredScopeId() != null ) {
				if( rhs.getRequiredScopeId() != null ) {
					if( ! getRequiredScopeId().equals( rhs.getRequiredScopeId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTweakByValTentIdxKey rhs ) {
			if( getRequiredTenantId() != null ) {
				if( rhs.getRequiredTenantId() != null ) {
					if( ! getRequiredTenantId().equals( rhs.getRequiredTenantId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTweakByScopeIdxKey rhs ) {
			if( getRequiredScopeId() != null ) {
				if( rhs.getRequiredScopeId() != null ) {
					if( ! getRequiredScopeId().equals( rhs.getRequiredScopeId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTweakByDefSchemaIdxKey rhs ) {
			if( getOptionalDefSchemaId() != null ) {
				if( rhs.getOptionalDefSchemaId() != null ) {
					if( ! getOptionalDefSchemaId().equals( rhs.getOptionalDefSchemaId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamProtTweakByUDefIdxKey rhs ) {
			if( getRequiredTenantId() != null ) {
				if( rhs.getRequiredTenantId() != null ) {
					if( ! getRequiredTenantId().equals( rhs.getRequiredTenantId() ) ) {
						return( false );
		...
		else if( obj instanceof ICFBamPubTweak rhs ) {
			if( ! getCreatedByUserId().equals( rhs.getCreatedByUserId() ) ) {
				return( false );
			}
			if( ! getCreatedAt().equals( rhs.getCreatedAt() ) ) {
		...
		else if( obj instanceof ICFBamPubTweakH rhs ) {
			if( getRequiredTenantId() != null ) {
				if( rhs.getRequiredTenantId() != null ) {
					if( ! getRequiredTenantId().equals( rhs.getRequiredTenantId() ) ) {
						return( false );
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamPubTweakByUNameIdxKey rhs ) {
			if (getRequiredScopeId() != null) {
				if (rhs.getRequiredScopeId() != null) {
					cmp = getRequiredScopeId().compareTo( rhs.getRequiredScopeId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTweakByValTentIdxKey rhs ) {
			if (getRequiredTenantId() != null) {
				if (rhs.getRequiredTenantId() != null) {
					cmp = getRequiredTenantId().compareTo( rhs.getRequiredTenantId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTweakByScopeIdxKey rhs ) {
			if (getRequiredScopeId() != null) {
				if (rhs.getRequiredScopeId() != null) {
					cmp = getRequiredScopeId().compareTo( rhs.getRequiredScopeId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTweakByDefSchemaIdxKey rhs ) {
			if( getOptionalDefSchemaId() != null ) {
				if( rhs.getOptionalDefSchemaId() != null ) {
					cmp = getOptionalDefSchemaId().compareTo( rhs.getOptionalDefSchemaId() );
					if( cmp != 0 ) {
		...
		else if( obj instanceof ICFBamPubTweakByUDefIdxKey rhs ) {
			if (getRequiredTenantId() != null) {
				if (rhs.getRequiredTenantId() != null) {
					cmp = getRequiredTenantId().compareTo( rhs.getRequiredTenantId() );
					if( cmp != 0 ) {
	...
	public void setTweak( ICFBamProtTweak src ) {
		...
		setJustProtRequiredContainerScopeDef(src.getRequiredContainerScopeDef());
		...
		setJustProtOptionalDefSchemaTenantId(src.getOptionalDefSchemaTenantId());
		setJustProtOptionalDefSchemaId(src.getOptionalDefSchemaId());
		setJustProtRequiredName(src.getRequiredName());
		setJustProtRequiredReplacesInherited(src.getRequiredReplacesInherited());
		setJustProtRequiredTweakGelText(src.getRequiredTweakGelText());
	}
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			...
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredTenantId().toString() + "\"" + "\"" + getRequiredScopeId().toString() + "\"" + "\"" + getRequiredId().toString() + "\"" + ( ( getOptionalDefSchemaTenantId() == null ) ? "null" : "\"" + getOptionalDefSchemaTenantId().toString() + "\"" ) + ( ( getOptionalDefSchemaId() == null ) ? "null" : "\"" + getOptionalDefSchemaId().toString() + "\"" ) + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"" + (( getRequiredReplacesInherited() ) ? "\"true\"" : "\"false\"" ) + "\"" + StringEscapeUtils.escapeXml11( getRequiredTweakGelText() ) + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFBamProtBuffTweak" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
