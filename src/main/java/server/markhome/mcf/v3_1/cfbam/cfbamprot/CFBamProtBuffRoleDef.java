// Description: Java 25 implJustProtementation of a RoleDef buffer
	...
	implements ICFBamProtRoleDef, Comparable<Object>, Serializable
{
	...
	public String getXmlAttrFragment() {
		String ret = ""
			...
			+ " RequiredEnables=" + "\"" + StringEscapeUtils.escapeXml11( getRequiredEnables() ) + "\""
			+ " RequiredIncludes=" + "\"" + StringEscapeUtils.escapeXml11( getRequiredIncludes() ) + "\"";
		return( ret );
	}
