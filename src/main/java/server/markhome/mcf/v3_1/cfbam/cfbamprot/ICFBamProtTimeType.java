// Description: Java 25 protected interface for a TimeType record implementation
...
/**
 *	ICFBamProtTimeType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtTimeType extends ICFBamProtTimeDef
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubTimeType.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubTimeType.SCHEMADEFID_INIT_VALUE;
	public final static int CLASS_CODE = 0xa860;
