...
// Description: Java 25 protected DbIO interface for NmTokenType.
...
/*
 *	CFBamProtNmTokenTypeTable protected database interface for NmTokenType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtNmTokenTypeTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamNmTokenType protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
