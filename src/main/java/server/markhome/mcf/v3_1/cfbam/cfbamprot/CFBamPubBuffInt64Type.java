// Description: Java 17 implJustPubementation of a Int64Type buffer
...
public class CFBamPubBuffInt64Type
	extends CFBamPubBuffInt64Def
	implements ICFBamInt64Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffInt64Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubInt64Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt64Type ) {
			setJustPubInt64Type( (CFBamPubBuffInt64Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffInt64Type ) {
			setJustPubInt64Type( (CFBamPubPubBuffInt64Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffInt64Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
