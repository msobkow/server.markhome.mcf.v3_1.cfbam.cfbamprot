// Description: Java 17 implJustPubementation of a BoolCol buffer
	...
	implements ICFBamBoolCol
{
	...
	public int getClassCode() {
		return( ICFBamPubBoolCol.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBoolCol ) {
			setJustPubBoolCol( (CFBamPubBuffBoolCol)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffBoolCol ) {
			setJustPubBoolCol( (CFBamPubPubBuffBoolCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffBoolCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
