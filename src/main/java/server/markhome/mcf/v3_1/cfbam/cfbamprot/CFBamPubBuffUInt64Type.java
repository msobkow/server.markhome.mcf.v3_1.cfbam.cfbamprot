// Description: Java 17 implJustPubementation of a UInt64Type buffer
...
public class CFBamPubBuffUInt64Type
	extends CFBamPubBuffUInt64Def
	implements ICFBamUInt64Type
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffUInt64Type() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubUInt64Type.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt64Type ) {
			setJustPubUInt64Type( (CFBamPubBuffUInt64Type)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt64Type ) {
			setJustPubUInt64Type( (CFBamPubPubBuffUInt64Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt64Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
