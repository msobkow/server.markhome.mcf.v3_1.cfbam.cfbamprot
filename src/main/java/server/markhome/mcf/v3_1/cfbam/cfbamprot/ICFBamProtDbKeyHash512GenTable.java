...
// Description: Java 25 protected DbIO interface for DbKeyHash512Gen.
...
/*
 *	CFBamProtDbKeyHash512GenTable protected database interface for DbKeyHash512Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDbKeyHash512GenTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDbKeyHash512Gen protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
