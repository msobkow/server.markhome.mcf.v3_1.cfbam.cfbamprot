// Description: Java 17 implJustPubementation of a UInt64Def buffer
...
public class CFBamPubBuffUInt64Def
	...
	implements ICFBamUInt64Def
{
	...
	public int getClassCode() {
		return( ICFBamPubUInt64Def.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt64Def ) {
			setJustPubUInt64Def( (CFBamPubBuffUInt64Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffUInt64Def ) {
			setJustPubUInt64Def( (CFBamPubPubBuffUInt64Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffUInt64Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
