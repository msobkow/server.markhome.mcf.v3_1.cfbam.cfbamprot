// Description: Java 17 implJustPubementation of a ServerListFunc buffer
	...
	implements ICFBamServerListFunc
{
	...
	public int getClassCode() {
		return( ICFBamPubServerListFunc.CLASS_CODE );
	}
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffServerListFunc ) {
			setJustPubServerListFunc( (CFBamPubBuffServerListFunc)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubPubBuffServerListFunc ) {
			setJustPubServerListFunc( (CFBamPubPubBuffServerListFunc)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffServerListFunc" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
