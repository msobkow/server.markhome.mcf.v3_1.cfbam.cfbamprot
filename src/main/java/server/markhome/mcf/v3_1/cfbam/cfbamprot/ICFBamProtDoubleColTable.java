...
// Description: Java 25 protected DbIO interface for DoubleCol.
...
/*
 *	CFBamProtDoubleColTable protected database interface for DoubleCol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtDoubleColTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamDoubleCol protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
