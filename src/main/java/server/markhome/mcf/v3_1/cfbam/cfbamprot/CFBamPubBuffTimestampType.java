// Description: Java 17 implJustPubementation of a TimestampType buffer
...
public class CFBamPubBuffTimestampType
	extends CFBamPubBuffTimestampDef
	implements ICFBamTimestampType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffTimestampType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubTimestampType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimestampType ) {
			setJustPubTimestampType( (CFBamPubBuffTimestampType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTimestampType ) {
			setJustPubTimestampType( (CFBamPubPubBuffTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTimestampType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
