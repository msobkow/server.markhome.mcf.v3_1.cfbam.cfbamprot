// Description: Java 17 implJustPubementation of a TZTimestampDef buffer
	...
	implements ICFBamTZTimestampDef
{
	...
	public int getClassCode() {
		return( ICFBamPubTZTimestampDef.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubTZTimestampDefH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimestampDef ) {
			setJustPubTZTimestampDef( (CFBamPubBuffTZTimestampDef)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZTimestampDef ) {
			setJustPubTZTimestampDef( (CFBamPubPubBuffTZTimestampDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZTimestampDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
