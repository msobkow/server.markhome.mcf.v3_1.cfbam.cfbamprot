// Description: Java 17 implJustPubementation of a TZTimeType buffer
...
public class CFBamPubBuffTZTimeType
	extends CFBamPubBuffTZTimeDef
	implements ICFBamTZTimeType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffTZTimeType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubTZTimeType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimeType ) {
			setJustPubTZTimeType( (CFBamPubBuffTZTimeType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTZTimeType ) {
			setJustPubTZTimeType( (CFBamPubPubBuffTZTimeType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTZTimeType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
