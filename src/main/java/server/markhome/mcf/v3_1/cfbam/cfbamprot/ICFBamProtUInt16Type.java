// Description: Java 25 protected interface for a UInt16Type record implementation
...
/**
 *	ICFBamProtUInt16Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtUInt16Type extends ICFBamProtUInt16Def
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubUInt16Type.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubUInt16Type.SCHEMADEFID_INIT_VALUE;
