// Description: Java 25 implJustProtementation of a Int64Col buffer
	...
	implements ICFBamInt64Col
{
	...
	public int getClassCode() {
		return( ICFBamInt64Col.CLASS_CODE );
	}
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamInt64ColByTableIdxKey rhs ) {
			if (getRequiredTableId() != null) {
				if (rhs.getRequiredTableId() != null) {
					cmp = getRequiredTableId().compareTo( rhs.getRequiredTableId() );
					if( cmp != 0 ) {
	...
	@Override
	public void setJustProtInt64Col( ICFBamInt64Col src ) {
	...
	public void setJustProt( ICFBamValueH src ) {
		if( src instanceof ICFBamProtInt64ColH ) {
			setInt64Col( (ICFBamProtInt64ColH)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
					"set",
	...
	@Override
	public void setJustProtInt64Col( ICFBamInt64ColH src ) {
		super.setJustProtInt64Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtInt64Col( ICFBamProtInt64Col src ) {
		super.setJustProtInt64Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtInt64Col( ICFBamProtInt64ColH src ) {
		super.setJustProtInt64Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtInt64Col( ICFBamPubInt64Col src ) {
		super.setJustProtInt64Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
	...
	@Override
	public void setJustProtInt64Col( ICFBamPubInt64ColH src ) {
		super.setJustProtInt64Def( src );
		setJustProtRequiredContainerTable(src.getRequiredContainerTable());
		setJustProtRequiredTableId(src.getRequiredTableId());
	}
