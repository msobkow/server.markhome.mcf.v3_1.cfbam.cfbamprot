// Description: Java 17 implJustProtementation of a TZTimestampDef buffer
	...
	implements ICFBamTZTimestampDef
{
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubProtBuffTZTimestampDef ) {
			...
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamPubProtBuffTZTimestampDef" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamProtBuffTZTimestampDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
