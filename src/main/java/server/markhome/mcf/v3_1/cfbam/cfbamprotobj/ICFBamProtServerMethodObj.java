// Description: Java 25 Object interface for CFBamProt ServerMethod.
...
public interface ICFBamProtServerMethodObj
	extends ICFBamProtScopeObj
{
	/**
	 *	Get the current edition of this ServerMethod instance as a ICFBamProtServerMethodEditObj.
	 *
	 *	@return	The ICFBamProtServerMethodEditObj edition of this instance.
	 */
	ICFBamProtServerMethodEditObj getEditAsServerMethod();

	/**
	 *	Get the ICFBamProtServerMethodTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamProtServerMethodTableObj table cache which manages this instance.
	 */
	ICFBamProtServerMethodTableObj getServerMethodTable();

	/**
	 *	Get the ICFBamProtServerMethod instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamProtServerMethod instance which currently backs this object.
	 */
