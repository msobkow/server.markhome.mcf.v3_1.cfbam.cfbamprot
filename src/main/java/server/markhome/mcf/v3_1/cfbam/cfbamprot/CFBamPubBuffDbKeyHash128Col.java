// Description: Java 17 implJustPubementation of a DbKeyHash128Col buffer
	...
	implements ICFBamDbKeyHash128Col
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash128Col.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash128Col ) {
			setJustPubDbKeyHash128Col( (CFBamPubBuffDbKeyHash128Col)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash128Col ) {
			setJustPubDbKeyHash128Col( (CFBamPubPubBuffDbKeyHash128Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash128Col" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash128Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
