// Description: Java 17 implJustPubementation of a TokenType buffer
...
public class CFBamPubBuffTokenType
	extends CFBamPubBuffTokenDef
	implements ICFBamTokenType
{
	protected ICFLibKeyHash256 requiredSchemaDefId;

	public CFBamPubBuffTokenType() {
		super();
	...
	public int getClassCode() {
		return( ICFBamPubTokenType.CLASS_CODE );
	}
...
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTokenType ) {
			setJustPubTokenType( (CFBamPubBuffTokenType)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffTokenType ) {
			setJustPubTokenType( (CFBamPubPubBuffTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String toString() {
		String ret = "<CFBamPubBuffTokenType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
