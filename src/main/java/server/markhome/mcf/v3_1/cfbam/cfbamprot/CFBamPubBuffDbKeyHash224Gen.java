// Description: Java 17 implJustPubementation of a DbKeyHash224Gen buffer
...
public class CFBamPubBuffDbKeyHash224Gen
	extends CFBamPubBuffDbKeyHash224Type
	implements ICFBamDbKeyHash224Gen
{
	protected short requiredSlice;
	protected int requiredBlockSize;

	public CFBamPubBuffDbKeyHash224Gen() {
		super();
		requiredSlice = ICFBamPubDbKeyHash224Gen.SLICE_INIT_VALUE;
		requiredBlockSize = ICFBamPubDbKeyHash224Gen.BLOCKSIZE_INIT_VALUE;
	}

	@Override
	public int getClassCode() {
		return( ICFBamPubDbKeyHash224Gen.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamPubDbKeyHash224GenH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash224Gen ) {
			setJustPubDbKeyHash224Gen( (CFBamPubBuffDbKeyHash224Gen)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash224Gen ) {
			setJustPubDbKeyHash224Gen( (CFBamPubPubBuffDbKeyHash224Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash224Gen" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash224Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
