// Description: Java 25 protected interface for a TZTimestampType record implementation
...
/**
 *	ICFBamProtTZTimestampType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtTZTimestampType extends ICFBamProtTZTimestampDef
{
	public static final String S_SCHEMADEFID_INIT_VALUE = ICFBamPubTZTimestampType.S_SCHEMADEFID_INIT_VALUE;
	public static final CFLibDbKeyHash256 SCHEMADEFID_INIT_VALUE = ICFBamPubTZTimestampType.SCHEMADEFID_INIT_VALUE;
	public final static int CLASS_CODE = 0xa85b;
