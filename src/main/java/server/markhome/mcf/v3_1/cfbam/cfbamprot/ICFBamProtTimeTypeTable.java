...
// Description: Java 25 protected DbIO interface for TimeType.
...
/*
 *	CFBamProtTimeTypeTable protected database interface for TimeType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamProtTimeTypeTable
{
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	public ICFBamTimeType protmoveRecDown( ICFSecProtAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
