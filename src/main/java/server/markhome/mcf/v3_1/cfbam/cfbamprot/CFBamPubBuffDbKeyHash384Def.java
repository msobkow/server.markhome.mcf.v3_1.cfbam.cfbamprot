// Description: Java 17 implJustPubementation of a DbKeyHash384Def buffer
	...
	implements ICFBamDbKeyHash384Def
{
	...
	public int getClassCode() {
		return( ICFBamPubDbKeyHash384Def.CLASS_CODE );
	}
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash384Def ) {
			setJustPubDbKeyHash384Def( (CFBamPubBuffDbKeyHash384Def)src );
		}
		else {
	...
	@Override
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubPubBuffDbKeyHash384Def ) {
			setJustPubDbKeyHash384Def( (CFBamPubPubBuffDbKeyHash384Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamPubPubBuffDbKeyHash384Def" );
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPubBuffDbKeyHash384Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
