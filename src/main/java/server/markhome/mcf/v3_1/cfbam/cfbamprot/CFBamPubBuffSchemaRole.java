// Description: Java 17 implJustPubementation of a SchemaRole buffer
...
public class CFBamPubBuffSchemaRole
	extends CFBamPubBuffRoleDef
	implements ICFBamSchemaRole
{
	...
	public int getClassCode() {
		return( ICFBamPubSchemaRole.CLASS_CODE );
	}
	...
	public void setRequiredContainerScopeDef(ICFLibKeyHash256 argSchemaDefId) {
		...
		requiredSchemaDefId = argSchemaDefId;
			...
			throw new CFLibUnsupportedClassException(getClass(), "setRequiredContainerScopeDef-args", "found", found, "ICFBamPubSchemaDefICFBamPubSchemaDef");
		}
	}
$reimplJustPubSchemaPubBuffTableNarrowedPubRelationSetter$
	...
	public void set( ICFBamPubRoleDef src ) {
		if( src instanceof CFBamPubBuffSchemaRole ) {
			setJustPubSchemaRole( (CFBamPubBuffSchemaRole)src );
		}
		else {
	...
	public void setSchemaRole( ICFBamPubSchemaRole src ) {
		...
		setJustPubRequiredRoleScope(src.getRequiredRoleScope());
	}
	...
	@Override
	public void set( ICFBamPubRoleDef src ) {
		if( src instanceof CFBamPubPubBuffSchemaRole ) {
			setJustPubSchemaRole( (CFBamPubPubBuffSchemaRole)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public String getXmlAttrFragment() {
		String ret = super.getXmlAttrFragment()  + "\"" + getRequiredId().toString() + "\"" + "\"" + getRequiredSchemaDefId().toString() + "\"" + "\"" + getRequiredRoleScope().toString() + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFBamPubBuffSchemaRole" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
